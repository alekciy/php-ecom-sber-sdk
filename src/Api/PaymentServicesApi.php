...
class PaymentServicesApi
{
     ...
     *
     * @param  \SberPay\Model\PaymentOrderRequest $payment_order_request Запрос проведения оплаты по карте (required)
     ...
     * @return \SberPay\Model\PaymentOrderResponse
     */
    public function paymentOrder(
        \SberPay\Model\PaymentOrderRequest $payment_order_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['paymentOrder'][0]
    ): \SberPay\Model\PaymentOrderResponse
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SberPay\Model\PaymentOrderResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function paymentOrderWithHttpInfo(
        \SberPay\Model\PaymentOrderRequest $payment_order_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['paymentOrder'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SberPay\Model\PaymentOrderResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SberPay\Model\PaymentOrderResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SberPay\Model\PaymentOrderResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\SberPay\Model\PaymentOrderResponse';
     ...
     */
    public function paymentOrderAsync(
        \SberPay\Model\PaymentOrderRequest $payment_order_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['paymentOrder'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function paymentOrderAsyncWithHttpInfo(
     ...
     */
    public function paymentOrderRequest(
        $payment_order_request,
        $x_idempotency_key = null,
        string $contentType = self::contentTypes['paymentOrder'][0]
    ): Request
     ...
     *
     * @param  \SberPay\Model\PaymentOrderBySubscriptionRequest $payment_order_by_subscription_request Запрос проведения оплаты по подписке СБП (required)
     * @param  string|null $x_idempotency_key &lt;span style&#x3D;\&quot;color:red;\&quot;&gt;__Функционал обработки ключа идемпотентности находится в разработке__&lt;/span&gt;  Ключ идемпотентности запроса. Повторный вызов с тем же ключом вернет результат выполнения предыдущего запроса и не приведет к выполнению нового. Срок хранения ключей - 24 часа. (optional)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \SberPay\Model\PaymentOrderBySubscriptionResponse
     */
    public function paymentOrderBySubscription(
        \SberPay\Model\PaymentOrderBySubscriptionRequest $payment_order_by_subscription_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['paymentOrderBySubscription'][0]
    ): \SberPay\Model\PaymentOrderBySubscriptionResponse
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SberPay\Model\PaymentOrderBySubscriptionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function paymentOrderBySubscriptionWithHttpInfo(
        \SberPay\Model\PaymentOrderBySubscriptionRequest $payment_order_by_subscription_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['paymentOrderBySubscription'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SberPay\Model\PaymentOrderBySubscriptionResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SberPay\Model\PaymentOrderBySubscriptionResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SberPay\Model\PaymentOrderBySubscriptionResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\SberPay\Model\PaymentOrderBySubscriptionResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function paymentOrderBySubscriptionAsync(
        \SberPay\Model\PaymentOrderBySubscriptionRequest $payment_order_by_subscription_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['paymentOrderBySubscription'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function paymentOrderBySubscriptionAsyncWithHttpInfo(
        $payment_order_by_subscription_request,
        $x_idempotency_key = null,
        string $contentType = self::contentTypes['paymentOrderBySubscription'][0]
    ): PromiseInterface
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function paymentOrderBySubscriptionRequest(
        $payment_order_by_subscription_request,
        $x_idempotency_key = null,
        string $contentType = self::contentTypes['paymentOrderBySubscription'][0]
    ): Request
     ...
     *
     * @param  \SberPay\Model\PaymentSberPayRequest $payment_sber_pay_request Запрос проведения оплаты через мобильное приложение \&quot;Сбербанк-Онлайн\&quot; (required)
     * @param  string|null $x_idempotency_key &lt;span style&#x3D;\&quot;color:red;\&quot;&gt;__Функционал обработки ключа идемпотентности находится в разработке__&lt;/span&gt;  Ключ идемпотентности запроса. Повторный вызов с тем же ключом вернет результат выполнения предыдущего запроса и не приведет к выполнению нового. Срок хранения ключей - 24 часа. (optional)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \SberPay\Model\PaymentSberPayResponse
     */
    public function paymentSberPay(
        \SberPay\Model\PaymentSberPayRequest $payment_sber_pay_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['paymentSberPay'][0]
    ): \SberPay\Model\PaymentSberPayResponse
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SberPay\Model\PaymentSberPayResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function paymentSberPayWithHttpInfo(
        \SberPay\Model\PaymentSberPayRequest $payment_sber_pay_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['paymentSberPay'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SberPay\Model\PaymentSberPayResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SberPay\Model\PaymentSberPayResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SberPay\Model\PaymentSberPayResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\SberPay\Model\PaymentSberPayResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function paymentSberPayAsync(
        \SberPay\Model\PaymentSberPayRequest $payment_sber_pay_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['paymentSberPay'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function paymentSberPayAsyncWithHttpInfo(
        $payment_sber_pay_request,
        $x_idempotency_key = null,
        string $contentType = self::contentTypes['paymentSberPay'][0]
    ): PromiseInterface
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function paymentSberPayRequest(
        $payment_sber_pay_request,
        $x_idempotency_key = null,
        string $contentType = self::contentTypes['paymentSberPay'][0]
    ): Request
