...
class BindingServicesApi
{
     ...
     *
     * @param  \SberPay\Model\BindCardRequest $bind_card_request Запрос активации связки Плательщика (required)
     ...
     * @return \SberPay\Model\BindCardResponse
     */
    public function bindCard(
        \SberPay\Model\BindCardRequest $bind_card_request,
        string $contentType = self::contentTypes['bindCard'][0]
    ): \SberPay\Model\BindCardResponse
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SberPay\Model\BindCardResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function bindCardWithHttpInfo(
        \SberPay\Model\BindCardRequest $bind_card_request,
        string $contentType = self::contentTypes['bindCard'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SberPay\Model\BindCardResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SberPay\Model\BindCardResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SberPay\Model\BindCardResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\SberPay\Model\BindCardResponse';
     ...
     * @return PromiseInterface
     */
    public function bindCardAsyncWithHttpInfo(
        $bind_card_request,
        string $contentType = self::contentTypes['bindCard'][0]
    ): PromiseInterface
    {
     ...
     *
     * @param  \SberPay\Model\GetBindingsRequest $get_bindings_request Запрос получения связок по идентификатору Плательщика (required)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \SberPay\Model\GetBindingsResponse
     */
    public function getBindings(
        \SberPay\Model\GetBindingsRequest $get_bindings_request,
        string $contentType = self::contentTypes['getBindings'][0]
    ): \SberPay\Model\GetBindingsResponse
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SberPay\Model\GetBindingsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBindingsWithHttpInfo(
        \SberPay\Model\GetBindingsRequest $get_bindings_request,
        string $contentType = self::contentTypes['getBindings'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SberPay\Model\GetBindingsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SberPay\Model\GetBindingsResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SberPay\Model\GetBindingsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\SberPay\Model\GetBindingsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function getBindingsAsync(
        \SberPay\Model\GetBindingsRequest $get_bindings_request,
        string $contentType = self::contentTypes['getBindings'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function getBindingsAsyncWithHttpInfo(
        $get_bindings_request,
        string $contentType = self::contentTypes['getBindings'][0]
    ): PromiseInterface
    {
        $returnType = '\SberPay\Model\GetBindingsResponse';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getBindingsRequest(
        $get_bindings_request,
        string $contentType = self::contentTypes['getBindings'][0]
    ): Request
    {
     ...
     *
     * @param  \SberPay\Model\GetBindingsByCardOrIdRequest $get_bindings_by_card_or_id_request Запрос получения связок по номеру карты или идентификатору связки Плательщика (required)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \SberPay\Model\GetBindingsByCardOrIdResponse
     */
    public function getBindingsByCardOrId(
        \SberPay\Model\GetBindingsByCardOrIdRequest $get_bindings_by_card_or_id_request,
        string $contentType = self::contentTypes['getBindingsByCardOrId'][0]
    ): \SberPay\Model\GetBindingsByCardOrIdResponse
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SberPay\Model\GetBindingsByCardOrIdResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBindingsByCardOrIdWithHttpInfo(
        \SberPay\Model\GetBindingsByCardOrIdRequest $get_bindings_by_card_or_id_request,
        string $contentType = self::contentTypes['getBindingsByCardOrId'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SberPay\Model\GetBindingsByCardOrIdResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SberPay\Model\GetBindingsByCardOrIdResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SberPay\Model\GetBindingsByCardOrIdResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\SberPay\Model\GetBindingsByCardOrIdResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function getBindingsByCardOrIdAsync(
        \SberPay\Model\GetBindingsByCardOrIdRequest $get_bindings_by_card_or_id_request,
        string $contentType = self::contentTypes['getBindingsByCardOrId'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function getBindingsByCardOrIdAsyncWithHttpInfo(
        $get_bindings_by_card_or_id_request,
        string $contentType = self::contentTypes['getBindingsByCardOrId'][0]
    ): PromiseInterface
    {
        $returnType = '\SberPay\Model\GetBindingsByCardOrIdResponse';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getBindingsByCardOrIdRequest(
        $get_bindings_by_card_or_id_request,
        string $contentType = self::contentTypes['getBindingsByCardOrId'][0]
    ): Request
    {
     ...
     *
     * @param  \SberPay\Model\PaymentOrderBindingRequest $payment_order_binding_request Запрос проведения оплаты по связке (required)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \SberPay\Model\PaymentOrderBindingResponse
     */
    public function paymentOrderBinding(
        \SberPay\Model\PaymentOrderBindingRequest $payment_order_binding_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['paymentOrderBinding'][0]
    ): \SberPay\Model\PaymentOrderBindingResponse
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SberPay\Model\PaymentOrderBindingResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function paymentOrderBindingWithHttpInfo(
        \SberPay\Model\PaymentOrderBindingRequest $payment_order_binding_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['paymentOrderBinding'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SberPay\Model\PaymentOrderBindingResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SberPay\Model\PaymentOrderBindingResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SberPay\Model\PaymentOrderBindingResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\SberPay\Model\PaymentOrderBindingResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function paymentOrderBindingAsync(
        \SberPay\Model\PaymentOrderBindingRequest $payment_order_binding_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['paymentOrderBinding'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function paymentOrderBindingAsyncWithHttpInfo(
        $payment_order_binding_request,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function paymentOrderBindingRequest(
        $payment_order_binding_request,
        $x_idempotency_key = null,
        string $contentType = self::contentTypes['paymentOrderBinding'][0]
    ): Request
     ...
     *
     * @param  \SberPay\Model\RecurrentPaymentRequest $recurrent_payment_request Запрос проведения периодического платежа (required)
     * @param  string|null $x_idempotency_key &lt;span style&#x3D;\&quot;color:red;\&quot;&gt;__Функционал обработки ключа идемпотентности находится в разработке__&lt;/span&gt;  Ключ идемпотентности запроса. Повторный вызов с тем же ключом вернет результат выполнения предыдущего запроса и не приведет к выполнению нового. Срок хранения ключей - 24 часа. (optional)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \SberPay\Model\RecurrentPaymentResponse
     */
    public function recurrentPayment(
        \SberPay\Model\RecurrentPaymentRequest $recurrent_payment_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['recurrentPayment'][0]
    ): \SberPay\Model\RecurrentPaymentResponse
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SberPay\Model\RecurrentPaymentResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function recurrentPaymentWithHttpInfo(
        \SberPay\Model\RecurrentPaymentRequest $recurrent_payment_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['recurrentPayment'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SberPay\Model\RecurrentPaymentResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SberPay\Model\RecurrentPaymentResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SberPay\Model\RecurrentPaymentResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\SberPay\Model\RecurrentPaymentResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function recurrentPaymentAsync(
        \SberPay\Model\RecurrentPaymentRequest $recurrent_payment_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['recurrentPayment'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function recurrentPaymentAsyncWithHttpInfo(
        $recurrent_payment_request,
        $x_idempotency_key = null,
        string $contentType = self::contentTypes['recurrentPayment'][0]
    ): PromiseInterface
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function recurrentPaymentRequest(
        $recurrent_payment_request,
        $x_idempotency_key = null,
        string $contentType = self::contentTypes['recurrentPayment'][0]
    ): Request
     ...
     *
     * @param  \SberPay\Model\UnBindCardRequest $un_bind_card_request Запрос деактивации связки Плательщика (required)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \SberPay\Model\UnBindCardResponse
     */
    public function unBindCard(
        \SberPay\Model\UnBindCardRequest $un_bind_card_request,
        string $contentType = self::contentTypes['unBindCard'][0]
    ): \SberPay\Model\UnBindCardResponse
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SberPay\Model\UnBindCardResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function unBindCardWithHttpInfo(
        \SberPay\Model\UnBindCardRequest $un_bind_card_request,
        string $contentType = self::contentTypes['unBindCard'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SberPay\Model\UnBindCardResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SberPay\Model\UnBindCardResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SberPay\Model\UnBindCardResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\SberPay\Model\UnBindCardResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function unBindCardAsync(
        \SberPay\Model\UnBindCardRequest $un_bind_card_request,
        string $contentType = self::contentTypes['unBindCard'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function unBindCardAsyncWithHttpInfo(
        $un_bind_card_request,
        string $contentType = self::contentTypes['unBindCard'][0]
    ): PromiseInterface
    {
        $returnType = '\SberPay\Model\UnBindCardResponse';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function unBindCardRequest(
        $un_bind_card_request,
        string $contentType = self::contentTypes['unBindCard'][0]
    ): Request
    {
