...
class ChangePasswordServicesApi
{
     ...
     *
     * @param  \SberPay\Model\GenerateApikeyRequest $generate_apikey_request generate_apikey_request (required)
     ...
     * @return \SberPay\Model\GenerateApikeyResponse
     */
    public function generate(
        \SberPay\Model\GenerateApikeyRequest $generate_apikey_request,
        string $contentType = self::contentTypes['generate'][0]
    ): \SberPay\Model\GenerateApikeyResponse
    {
     ...
     * Генерация ключа Клиента для работы с сервисами платежного шлюза через SDK.
     *
     * @param  \SberPay\Model\GenerateApikeyRequest $generate_apikey_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['generate'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SberPay\Model\GenerateApikeyResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function generateWithHttpInfo(
        \SberPay\Model\GenerateApikeyRequest $generate_apikey_request,
        string $contentType = self::contentTypes['generate'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SberPay\Model\GenerateApikeyResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SberPay\Model\GenerateApikeyResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SberPay\Model\GenerateApikeyResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\SberPay\Model\GenerateApikeyResponse';
     ...
     * @return PromiseInterface
     */
    public function generateAsyncWithHttpInfo(
     ...
     *
     * @param  \SberPay\Model\SetPermanentPasswordRequest $set_permanent_password_request Запрос предназначен для изменение временного пароля, выданного при регистрации Клиента на ПШ на постоянный пароль на стороне Клиента. (required)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \SberPay\Model\SetPermanentPasswordResponse
     */
    public function setPermanentPassword(
        \SberPay\Model\SetPermanentPasswordRequest $set_permanent_password_request,
        string $contentType = self::contentTypes['setPermanentPassword'][0]
    ): \SberPay\Model\SetPermanentPasswordResponse
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SberPay\Model\SetPermanentPasswordResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function setPermanentPasswordWithHttpInfo(
        \SberPay\Model\SetPermanentPasswordRequest $set_permanent_password_request,
        string $contentType = self::contentTypes['setPermanentPassword'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SberPay\Model\SetPermanentPasswordResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SberPay\Model\SetPermanentPasswordResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SberPay\Model\SetPermanentPasswordResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\SberPay\Model\SetPermanentPasswordResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function setPermanentPasswordAsync(
        \SberPay\Model\SetPermanentPasswordRequest $set_permanent_password_request,
        string $contentType = self::contentTypes['setPermanentPassword'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function setPermanentPasswordAsyncWithHttpInfo(
        $set_permanent_password_request,
        string $contentType = self::contentTypes['setPermanentPassword'][0]
    ): PromiseInterface
    {
        $returnType = '\SberPay\Model\SetPermanentPasswordResponse';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function setPermanentPasswordRequest(
        $set_permanent_password_request,
        string $contentType = self::contentTypes['setPermanentPassword'][0]
    ): Request
    {
