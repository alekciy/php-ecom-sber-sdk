...
class BasicServicesApi
{
     ...
     *
     * @param  \SberPay\Model\DeclineRequest $decline_request Запрос отмены заказа до начала платежа (required)
     ...
     * @return \SberPay\Model\DeclineResponse
     */
    public function decline(
        \SberPay\Model\DeclineRequest $decline_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['decline'][0]
    ): \SberPay\Model\DeclineResponse
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SberPay\Model\DeclineResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function declineWithHttpInfo(
        \SberPay\Model\DeclineRequest $decline_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['decline'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SberPay\Model\DeclineResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SberPay\Model\DeclineResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SberPay\Model\DeclineResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\SberPay\Model\DeclineResponse';
     ...
     * @return PromiseInterface
     */
    public function declineAsyncWithHttpInfo(
        $decline_request,
     ...
     *
     * @param  \SberPay\Model\DepositRequest $deposit_request Запрос завершения двухстадийного сценария (required)
     * @param  string|null $x_idempotency_key &lt;span style&#x3D;\&quot;color:red;\&quot;&gt;__Функционал обработки ключа идемпотентности находится в разработке__&lt;/span&gt;  Ключ идемпотентности запроса. Повторный вызов с тем же ключом вернет результат выполнения предыдущего запроса и не приведет к выполнению нового. Срок хранения ключей - 24 часа. (optional)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \SberPay\Model\DepositResponse
     */
    public function deposit(
        \SberPay\Model\DepositRequest $deposit_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['deposit'][0]
    ): \SberPay\Model\DepositResponse
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SberPay\Model\DepositResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function depositWithHttpInfo(
        \SberPay\Model\DepositRequest $deposit_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['deposit'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SberPay\Model\DepositResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SberPay\Model\DepositResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SberPay\Model\DepositResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\SberPay\Model\DepositResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function depositAsyncWithHttpInfo(
        $deposit_request,
        $x_idempotency_key = null,
        string $contentType = self::contentTypes['deposit'][0]
    ): PromiseInterface
     ...
     *
     * @param  \SberPay\Model\GetOrderStatusExtendedRequest $get_order_status_extended_request Запрос получения информации о заказе (required)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \SberPay\Model\GetOrderStatusExtendedResponse
     */
    public function getOrderStatusExtended(
        \SberPay\Model\GetOrderStatusExtendedRequest $get_order_status_extended_request,
        string $contentType = self::contentTypes['getOrderStatusExtended'][0]
    ): \SberPay\Model\GetOrderStatusExtendedResponse
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SberPay\Model\GetOrderStatusExtendedResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderStatusExtendedWithHttpInfo(
        \SberPay\Model\GetOrderStatusExtendedRequest $get_order_status_extended_request,
        string $contentType = self::contentTypes['getOrderStatusExtended'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SberPay\Model\GetOrderStatusExtendedResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SberPay\Model\GetOrderStatusExtendedResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SberPay\Model\GetOrderStatusExtendedResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\SberPay\Model\GetOrderStatusExtendedResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function getOrderStatusExtendedAsync(
        \SberPay\Model\GetOrderStatusExtendedRequest $get_order_status_extended_request,
        string $contentType = self::contentTypes['getOrderStatusExtended'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function getOrderStatusExtendedAsyncWithHttpInfo(
        $get_order_status_extended_request,
        string $contentType = self::contentTypes['getOrderStatusExtended'][0]
    ): PromiseInterface
    {
        $returnType = '\SberPay\Model\GetOrderStatusExtendedResponse';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOrderStatusExtendedRequest(
        $get_order_status_extended_request,
        string $contentType = self::contentTypes['getOrderStatusExtended'][0]
    ): Request
    {
     ...
     *
     * @param  \SberPay\Model\RefundRequest $refund_request Запрос возврата средств Плательщика (required)
     * @param  string|null $x_idempotency_key &lt;span style&#x3D;\&quot;color:red;\&quot;&gt;__Функционал обработки ключа идемпотентности находится в разработке__&lt;/span&gt;  Ключ идемпотентности запроса. Повторный вызов с тем же ключом вернет результат выполнения предыдущего запроса и не приведет к выполнению нового. Срок хранения ключей - 24 часа. (optional)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \SberPay\Model\RefundResponse
     */
    public function refund(
        \SberPay\Model\RefundRequest $refund_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['refund'][0]
    ): \SberPay\Model\RefundResponse
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SberPay\Model\RefundResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SberPay\Model\RefundResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SberPay\Model\RefundResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SberPay\Model\RefundResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\SberPay\Model\RefundResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * Регистрация заказа
     *
     * @param  \SberPay\Model\RegisterRequest $register_request Запрос регистрации заказа по одностадийному сценарию (required)
     * @param  string|null $x_idempotency_key &lt;span style&#x3D;\&quot;color:red;\&quot;&gt;__Функционал обработки ключа идемпотентности находится в разработке__&lt;/span&gt;  Ключ идемпотентности запроса. Повторный вызов с тем же ключом вернет результат выполнения предыдущего запроса и не приведет к выполнению нового. Срок хранения ключей - 24 часа. (optional)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \SberPay\Model\RegisterResponse
     */
    public function register(
        \SberPay\Model\RegisterRequest $register_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['register'][0]
    ): \SberPay\Model\RegisterResponse
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SberPay\Model\RegisterResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function registerWithHttpInfo(
        \SberPay\Model\RegisterRequest $register_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['register'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SberPay\Model\RegisterResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SberPay\Model\RegisterResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SberPay\Model\RegisterResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\SberPay\Model\RegisterResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function registerAsyncWithHttpInfo(
        $register_request,
        $x_idempotency_key = null,
        string $contentType = self::contentTypes['register'][0]
    ): PromiseInterface
     ...
     *
     * @param  \SberPay\Model\RegisterPreAuthRequest $register_pre_auth_request Запрос регистрации заказа по двухстадийному сценарию (required)
     * @param  string|null $x_idempotency_key &lt;span style&#x3D;\&quot;color:red;\&quot;&gt;__Функционал обработки ключа идемпотентности находится в разработке__&lt;/span&gt;  Ключ идемпотентности запроса. Повторный вызов с тем же ключом вернет результат выполнения предыдущего запроса и не приведет к выполнению нового. Срок хранения ключей - 24 часа. (optional)
    ...
    public function registerPreAuth(
        \SberPay\Model\RegisterPreAuthRequest $register_pre_auth_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['registerPreAuth'][0]
    ): \SberPay\Model\RegisterResponse
    {
     ...
     * @return array of \SberPay\Model\RegisterResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function registerPreAuthWithHttpInfo(
        \SberPay\Model\RegisterPreAuthRequest $register_pre_auth_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['registerPreAuth'][0]
    ): array
     ...
     * @return PromiseInterface
     */
    public function registerPreAuthAsync(
        \SberPay\Model\RegisterPreAuthRequest $register_pre_auth_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['registerPreAuth'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function registerPreAuthAsyncWithHttpInfo(
        $register_pre_auth_request,
        $x_idempotency_key = null,
        string $contentType = self::contentTypes['registerPreAuth'][0]
    ): PromiseInterface
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function registerPreAuthRequest(
        $register_pre_auth_request,
        $x_idempotency_key = null,
        string $contentType = self::contentTypes['registerPreAuth'][0]
    ): Request
     ...
     * Отмена заказа
     *
     * @param  \SberPay\Model\ReverseRequest $reverse_request Запрос отмены заказа (required)
     * @param  string|null $x_idempotency_key &lt;span style&#x3D;\&quot;color:red;\&quot;&gt;__Функционал обработки ключа идемпотентности находится в разработке__&lt;/span&gt;  Ключ идемпотентности запроса. Повторный вызов с тем же ключом вернет результат выполнения предыдущего запроса и не приведет к выполнению нового. Срок хранения ключей - 24 часа. (optional)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \SberPay\Model\ReverseResponse
     */
    public function reverse(
        \SberPay\Model\ReverseRequest $reverse_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['reverse'][0]
    ): \SberPay\Model\ReverseResponse
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SberPay\Model\ReverseResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function reverseWithHttpInfo(
        \SberPay\Model\ReverseRequest $reverse_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['reverse'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SberPay\Model\ReverseResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SberPay\Model\ReverseResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SberPay\Model\ReverseResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\SberPay\Model\ReverseResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function reverseAsyncWithHttpInfo(
        $reverse_request,
        $x_idempotency_key = null,
        string $contentType = self::contentTypes['reverse'][0]
    ): PromiseInterface
