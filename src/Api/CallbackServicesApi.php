...
/**
 * CallbackServicesApi Class Doc Comment
 *
 * @package  SberPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CallbackServicesApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation bindingCallback
     *
     * Уведомление о событии со связкой
     *
     * @param  \SberPay\Model\BindingCallbackRequest $binding_callback_request Запрос уведомления о событии со связкой (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['bindingCallback'] to see the possible values for this operation
     *
    ...
    public function bindingCallback(
        \SberPay\Model\BindingCallbackRequest $binding_callback_request,
        string $contentType = self::contentTypes['bindingCallback'][0]
    ): void
    {
        $this->bindingCallbackWithHttpInfo($binding_callback_request, $contentType);
    }

    /**
     * Operation bindingCallbackWithHttpInfo
     *
     * Уведомление о событии со связкой
     *
     * @param  \SberPay\Model\BindingCallbackRequest $binding_callback_request Запрос уведомления о событии со связкой (required)
     ...
     */
    public function bindingCallbackWithHttpInfo(
        \SberPay\Model\BindingCallbackRequest $binding_callback_request,
        string $contentType = self::contentTypes['bindingCallback'][0]
    ): array
    {
        $request = $this->bindingCallbackRequest($binding_callback_request, $contentType);
    ...
    /**
     * Operation bindingCallbackAsync
     *
     * Уведомление о событии со связкой
     *
     * @param  \SberPay\Model\BindingCallbackRequest $binding_callback_request Запрос уведомления о событии со связкой (required)
     ...
     */
    public function bindingCallbackAsync(
        \SberPay\Model\BindingCallbackRequest $binding_callback_request,
        string $contentType = self::contentTypes['bindingCallback'][0]
    ): PromiseInterface
    {
        return $this->bindingCallbackAsyncWithHttpInfo($binding_callback_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation bindingCallbackAsyncWithHttpInfo
     *
     * Уведомление о событии со связкой
     *
     * @param  \SberPay\Model\BindingCallbackRequest $binding_callback_request Запрос уведомления о событии со связкой (required)
     ...
     * @return PromiseInterface
     */
    public function bindingCallbackAsyncWithHttpInfo(
        $binding_callback_request,
        string $contentType = self::contentTypes['bindingCallback'][0]
    ): PromiseInterface
    {
        $returnType = '';
    ...
    /**
     * Create request for operation 'bindingCallback'
     *
     * @param  \SberPay\Model\BindingCallbackRequest $binding_callback_request Запрос уведомления о событии со связкой (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['bindingCallback'] to see the possible values for this operation
     *
     ...
     */
    public function bindingCallbackRequest(
        $binding_callback_request,
        string $contentType = self::contentTypes['bindingCallback'][0]
    ): Request
    {

        // verify the required parameter 'binding_callback_request' is set
        if ($binding_callback_request === null || (is_array($binding_callback_request) && count($binding_callback_request) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $binding_callback_request when calling bindingCallback'
            );
        }


        $resourcePath = '/bindingCallbackUrl';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($binding_callback_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($binding_callback_request));
            } else {
                $httpBody = $binding_callback_request;
            }
     ...
     *
     * @param  \SberPay\Model\CallbackRequest $callback_request Запрос уведомления о проведении платежа (required)
    ...
    public function callback(
        \SberPay\Model\CallbackRequest $callback_request,
        string $contentType = self::contentTypes['callback'][0]
    ): void
    {
        $this->callbackWithHttpInfo($callback_request, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function callbackWithHttpInfo(
        \SberPay\Model\CallbackRequest $callback_request,
        string $contentType = self::contentTypes['callback'][0]
    ): array
    {
        $request = $this->callbackRequest($callback_request, $contentType);
     ...
     * @return PromiseInterface
     */
    public function callbackAsync(
        \SberPay\Model\CallbackRequest $callback_request,
        string $contentType = self::contentTypes['callback'][0]
    ): PromiseInterface
    {
        return $this->callbackAsyncWithHttpInfo($callback_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return PromiseInterface
     */
    public function callbackAsyncWithHttpInfo(
        $callback_request,
        string $contentType = self::contentTypes['callback'][0]
    ): PromiseInterface
    {
    ...
    ): Request
    {
        ...
        if ($callback_request === null || (is_array($callback_request) && count($callback_request) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $callback_request when calling callback'
            );
        }


        $resourcePath = '/callbackUrl';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($callback_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($callback_request));
            } else {
                $httpBody = $callback_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation receiptStatusCallback
     *
     * Уведомление о результате обработки чека
     *
     * @param  \SberPay\Model\GetReceiptStatusResponse $get_receipt_status_response Запрос уведомления о результате обарботки чека (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['receiptStatusCallback'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return void
     */
    public function receiptStatusCallback(
        \SberPay\Model\GetReceiptStatusResponse $get_receipt_status_response,
        string $contentType = self::contentTypes['receiptStatusCallback'][0]
    ): void
    {
        $this->receiptStatusCallbackWithHttpInfo($get_receipt_status_response, $contentType);
    }

    /**
     * Operation receiptStatusCallbackWithHttpInfo
     *
     * Уведомление о результате обработки чека
     *
     * @param  \SberPay\Model\GetReceiptStatusResponse $get_receipt_status_response Запрос уведомления о результате обарботки чека (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function receiptStatusCallbackWithHttpInfo(
        \SberPay\Model\GetReceiptStatusResponse $get_receipt_status_response,
        string $contentType = self::contentTypes['receiptStatusCallback'][0]
    ): array
    {
        $request = $this->receiptStatusCallbackRequest($get_receipt_status_response, $contentType);
    ...
    /**
     * Operation receiptStatusCallbackAsync
     *
     * Уведомление о результате обработки чека
     *
     * @param  \SberPay\Model\GetReceiptStatusResponse $get_receipt_status_response Запрос уведомления о результате обарботки чека (required)
     ...
     * @return PromiseInterface
     */
    public function receiptStatusCallbackAsync(
        \SberPay\Model\GetReceiptStatusResponse $get_receipt_status_response,
        string $contentType = self::contentTypes['receiptStatusCallback'][0]
    ): PromiseInterface
    {
        return $this->receiptStatusCallbackAsyncWithHttpInfo($get_receipt_status_response, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation receiptStatusCallbackAsyncWithHttpInfo
     *
     * Уведомление о результате обработки чека
     *
     * @param  \SberPay\Model\GetReceiptStatusResponse $get_receipt_status_response Запрос уведомления о результате обарботки чека (required)
     ...
     * @return PromiseInterface
     */
    public function receiptStatusCallbackAsyncWithHttpInfo(
        $get_receipt_status_response,
        string $contentType = self::contentTypes['receiptStatusCallback'][0]
    ): PromiseInterface
    {
        $returnType = '';
    ...
    /**
     * Create request for operation 'receiptStatusCallback'
     *
     * @param  \SberPay\Model\GetReceiptStatusResponse $get_receipt_status_response Запрос уведомления о результате обарботки чека (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['receiptStatusCallback'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function receiptStatusCallbackRequest(
        $get_receipt_status_response,
        string $contentType = self::contentTypes['receiptStatusCallback'][0]
    ): Request
    {

        // verify the required parameter 'get_receipt_status_response' is set
        if ($get_receipt_status_response === null || (is_array($get_receipt_status_response) && count($get_receipt_status_response) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $get_receipt_status_response when calling receiptStatusCallback'
            );
        }


        $resourcePath = '/receiptStatusCallbackUrl';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($get_receipt_status_response)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($get_receipt_status_response));
            } else {
                $httpBody = $get_receipt_status_response;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
