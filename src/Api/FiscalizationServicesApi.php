...
class FiscalizationServicesApi
{
     ...
     * Создание чека
     *
     * @param  \SberPay\Model\DoReceiptRequest $do_receipt_request Запрос создания чека (required)
     ...
     * @return \SberPay\Model\DoReceiptResponse
     */
    public function doReceipt(
        \SberPay\Model\DoReceiptRequest $do_receipt_request,
        string $contentType = self::contentTypes['doReceipt'][0]
    ): \SberPay\Model\DoReceiptResponse
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SberPay\Model\DoReceiptResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function doReceiptWithHttpInfo(
        \SberPay\Model\DoReceiptRequest $do_receipt_request,
        string $contentType = self::contentTypes['doReceipt'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SberPay\Model\DoReceiptResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SberPay\Model\DoReceiptResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SberPay\Model\DoReceiptResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\SberPay\Model\DoReceiptResponse';
     ...
     */
    public function doReceiptAsync(
        \SberPay\Model\DoReceiptRequest $do_receipt_request,
        string $contentType = self::contentTypes['doReceipt'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function doReceiptAsyncWithHttpInfo(
        $do_receipt_request,
        string $contentType = self::contentTypes['doReceipt'][0]
    ): PromiseInterface
    {
     ...
     */
    public function doReceiptRequest(
        $do_receipt_request,
        string $contentType = self::contentTypes['doReceipt'][0]
    ): Request
    {
     ...
     *
     * @param  \SberPay\Model\GetReceiptStatusRequest $get_receipt_status_request Запрос статуса обработки чека. При передаче &#x60;orderId&#x60; или &#x60;orderNumber&#x60; отражаются все сформированные чеки по Заказу, при передаче &#x60;receiptId&#x60; - конкретный чек. Дополнительно доступен поиск по статусу чека. Рекомендуем запрашивать статус чека не ранее чем через 6 минут после проведения операции. (required)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \SberPay\Model\GetReceiptStatusResponse
     */
    public function getReceiptStatus(
        \SberPay\Model\GetReceiptStatusRequest $get_receipt_status_request,
        string $contentType = self::contentTypes['getReceiptStatus'][0]
    ): \SberPay\Model\GetReceiptStatusResponse
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SberPay\Model\GetReceiptStatusResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getReceiptStatusWithHttpInfo(
        \SberPay\Model\GetReceiptStatusRequest $get_receipt_status_request,
        string $contentType = self::contentTypes['getReceiptStatus'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SberPay\Model\GetReceiptStatusResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SberPay\Model\GetReceiptStatusResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SberPay\Model\GetReceiptStatusResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\SberPay\Model\GetReceiptStatusResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function getReceiptStatusAsync(
        \SberPay\Model\GetReceiptStatusRequest $get_receipt_status_request,
        string $contentType = self::contentTypes['getReceiptStatus'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function getReceiptStatusAsyncWithHttpInfo(
        $get_receipt_status_request,
        string $contentType = self::contentTypes['getReceiptStatus'][0]
    ): PromiseInterface
    {
        $returnType = '\SberPay\Model\GetReceiptStatusResponse';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getReceiptStatusRequest(
        $get_receipt_status_request,
        string $contentType = self::contentTypes['getReceiptStatus'][0]
    ): Request
    {
     ...
     *
     * @param  \SberPay\Model\RetryReceiptRequest $retry_receipt_request Запрос переотправки чека. (required)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \SberPay\Model\RetryReceiptResponse
     */
    public function retryReceipt(
        \SberPay\Model\RetryReceiptRequest $retry_receipt_request,
        string $contentType = self::contentTypes['retryReceipt'][0]
    ): \SberPay\Model\RetryReceiptResponse
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SberPay\Model\RetryReceiptResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function retryReceiptWithHttpInfo(
        \SberPay\Model\RetryReceiptRequest $retry_receipt_request,
        string $contentType = self::contentTypes['retryReceipt'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SberPay\Model\RetryReceiptResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SberPay\Model\RetryReceiptResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SberPay\Model\RetryReceiptResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\SberPay\Model\RetryReceiptResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function retryReceiptAsync(
        \SberPay\Model\RetryReceiptRequest $retry_receipt_request,
        string $contentType = self::contentTypes['retryReceipt'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function retryReceiptAsyncWithHttpInfo(
        $retry_receipt_request,
        string $contentType = self::contentTypes['retryReceipt'][0]
    ): PromiseInterface
    {
        $returnType = '\SberPay\Model\RetryReceiptResponse';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retryReceiptRequest(
        $retry_receipt_request,
        string $contentType = self::contentTypes['retryReceipt'][0]
    ): Request
    {
