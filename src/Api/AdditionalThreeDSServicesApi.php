...
class AdditionalThreeDSServicesApi
{
     ...
     *
     * @param  \SberPay\Model\Finish3dsMethodRequest $finish3ds_method_request Запрос завершения 3DS Method (required)
     ...
     * @return \SberPay\Model\Finish3dsMethodResponse
     */
    public function finish3dsMethod(
        \SberPay\Model\Finish3dsMethodRequest $finish3ds_method_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['finish3dsMethod'][0]
    ): \SberPay\Model\Finish3dsMethodResponse
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SberPay\Model\Finish3dsMethodResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function finish3dsMethodWithHttpInfo(
        \SberPay\Model\Finish3dsMethodRequest $finish3ds_method_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['finish3dsMethod'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SberPay\Model\Finish3dsMethodResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SberPay\Model\Finish3dsMethodResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SberPay\Model\Finish3dsMethodResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\SberPay\Model\Finish3dsMethodResponse';
     ...
     */
    public function finish3dsMethodAsync(
        \SberPay\Model\Finish3dsMethodRequest $finish3ds_method_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['finish3dsMethod'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function finish3dsMethodAsyncWithHttpInfo(
        $finish3ds_method_request,
     ...
     */
    public function finish3dsMethodRequest(
        $finish3ds_method_request,
        $x_idempotency_key = null,
        string $contentType = self::contentTypes['finish3dsMethod'][0]
    ): Request
     ...
     *
     * @param  \SberPay\Model\Finish3dsPaymentRequest $finish3ds_payment_request Запрос завершения аутентификация 3-D Secure (required)
     * @param  string|null $x_idempotency_key &lt;span style&#x3D;\&quot;color:red;\&quot;&gt;__Функционал обработки ключа идемпотентности находится в разработке__&lt;/span&gt;  Ключ идемпотентности запроса. Повторный вызов с тем же ключом вернет результат выполнения предыдущего запроса и не приведет к выполнению нового. Срок хранения ключей - 24 часа. (optional)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \SberPay\Model\Finish3dsPaymentResponse
     */
    public function finish3dsPayment(
        \SberPay\Model\Finish3dsPaymentRequest $finish3ds_payment_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['finish3dsPayment'][0]
    ): \SberPay\Model\Finish3dsPaymentResponse
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SberPay\Model\Finish3dsPaymentResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function finish3dsPaymentWithHttpInfo(
        \SberPay\Model\Finish3dsPaymentRequest $finish3ds_payment_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['finish3dsPayment'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SberPay\Model\Finish3dsPaymentResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SberPay\Model\Finish3dsPaymentResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SberPay\Model\Finish3dsPaymentResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\SberPay\Model\Finish3dsPaymentResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function finish3dsPaymentAsync(
        \SberPay\Model\Finish3dsPaymentRequest $finish3ds_payment_request,
        ?string $x_idempotency_key = null,
        string $contentType = self::contentTypes['finish3dsPayment'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function finish3dsPaymentAsyncWithHttpInfo(
        $finish3ds_payment_request,
        $x_idempotency_key = null,
        string $contentType = self::contentTypes['finish3dsPayment'][0]
    ): PromiseInterface
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function finish3dsPaymentRequest(
        $finish3ds_payment_request,
        $x_idempotency_key = null,
        string $contentType = self::contentTypes['finish3dsPayment'][0]
    ): Request
