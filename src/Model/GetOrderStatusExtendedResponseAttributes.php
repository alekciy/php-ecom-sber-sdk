<?php
/**
 * GetOrderStatusExtendedResponseAttributes
 *
 * PHP version 8.1
 *
 * @package  SberPay
...
/**
 * GetOrderStatusExtendedResponseAttributes Class Doc Comment
 *
 * @package  SberPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetOrderStatusExtendedResponseAttributes implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getOrderStatusExtendedResponse_attributes';
    ...
    */
    ...
    public function setMdOrder(?string $md_order): static
    {
        ...
        if ((mb_strlen($md_order) > 36)) {
            throw new InvalidArgumentException('invalid length for $md_order when calling GetOrderStatusExtendedResponseAttributes., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($md_order) < 36)) {
            throw new InvalidArgumentException('invalid length for $md_order when calling GetOrderStatusExtendedResponseAttributes., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/^[a-f0-9\\-]+$/", ObjectSerializer::toString($md_order)))) {
            throw new InvalidArgumentException("invalid value for \$md_order when calling GetOrderStatusExtendedResponseAttributes., must conform to the pattern /^[a-f0-9\\-]+$/.");
        }
     ...
     * @return $this
     */
    public function setQrcId(?string $qrc_id): static
    {
        if (is_null($qrc_id)) {
            throw new InvalidArgumentException('non-nullable qrc_id cannot be null');
        }
        if ((mb_strlen($qrc_id) > 32)) {
            throw new InvalidArgumentException('invalid length for $qrc_id when calling GetOrderStatusExtendedResponseAttributes., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($qrc_id) < 32)) {
            throw new InvalidArgumentException('invalid length for $qrc_id when calling GetOrderStatusExtendedResponseAttributes., must be bigger than or equal to 32.');
        }
        if ((!preg_match("/^[A-Za-z0-9]+$/", ObjectSerializer::toString($qrc_id)))) {
            throw new InvalidArgumentException("invalid value for \$qrc_id when calling GetOrderStatusExtendedResponseAttributes., must conform to the pattern /^[A-Za-z0-9]+$/.");
        }
    ...
    public function setSubscriptionId(?string $subscription_id): static
    {
        ...
        if ((mb_strlen($subscription_id) > 32)) {
            throw new InvalidArgumentException('invalid length for $subscription_id when calling GetOrderStatusExtendedResponseAttributes., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($subscription_id) < 32)) {
            throw new InvalidArgumentException('invalid length for $subscription_id when calling GetOrderStatusExtendedResponseAttributes., must be bigger than or equal to 32.');
        }
        if ((!preg_match("/^[a-f0-9]+$/", ObjectSerializer::toString($subscription_id)))) {
            throw new InvalidArgumentException("invalid value for \$subscription_id when calling GetOrderStatusExtendedResponseAttributes., must conform to the pattern /^[a-f0-9]+$/.");
        }
    ...
    public function setMemberId(?string $member_id): static
    {
        ...
        if ((mb_strlen($member_id) > 12)) {
            throw new InvalidArgumentException('invalid length for $member_id when calling GetOrderStatusExtendedResponseAttributes., must be smaller than or equal to 12.');
        }
        if ((mb_strlen($member_id) < 12)) {
            throw new InvalidArgumentException('invalid length for $member_id when calling GetOrderStatusExtendedResponseAttributes., must be bigger than or equal to 12.');
        }
        if ((!preg_match("/^\\d{12}$/", ObjectSerializer::toString($member_id)))) {
            throw new InvalidArgumentException("invalid value for \$member_id when calling GetOrderStatusExtendedResponseAttributes., must conform to the pattern /^\\d{12}$/.");
        }
