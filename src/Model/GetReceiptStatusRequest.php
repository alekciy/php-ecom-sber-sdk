...
/**
 * GetReceiptStatusRequest Class Doc Comment
 *
 * @package  SberPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetReceiptStatusRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getReceiptStatusRequest';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ((mb_strlen($this->container['receipt_id']) > 36)) {
        ...
        if (!preg_match("/^[a-f0-9\\-]+$/", $this->container['receipt_id'])) {
    ...
    public function setUserName(string $user_name): static
    {
        ...
        if ((mb_strlen($user_name) > 30)) {
            throw new InvalidArgumentException('invalid length for $user_name when calling GetReceiptStatusRequest., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($user_name) < 1)) {
            throw new InvalidArgumentException('invalid length for $user_name when calling GetReceiptStatusRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[A-Za-z0-9-_ ]+$/", ObjectSerializer::toString($user_name)))) {
            throw new InvalidArgumentException("invalid value for \$user_name when calling GetReceiptStatusRequest., must conform to the pattern /^[A-Za-z0-9-_ ]+$/.");
        }
    ...
    public function setPassword(string $password): static
    {
        ...
        if ((mb_strlen($password) > 30)) {
            throw new InvalidArgumentException('invalid length for $password when calling GetReceiptStatusRequest., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($password) < 1)) {
            throw new InvalidArgumentException('invalid length for $password when calling GetReceiptStatusRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]+$/", ObjectSerializer::toString($password)))) {
            throw new InvalidArgumentException("invalid value for \$password when calling GetReceiptStatusRequest., must conform to the pattern /^[ -~]+$/.");
        }
     ...
     * @return $this
     */
    public function setReceiptStatus(?int $receipt_status): static
    {
        ...
        if (($receipt_status > 6)) {
            throw new InvalidArgumentException('invalid value for $receipt_status when calling GetReceiptStatusRequest., must be smaller than or equal to 6.');
        }
        if (($receipt_status < 0)) {
            throw new InvalidArgumentException('invalid value for $receipt_status when calling GetReceiptStatusRequest., must be bigger than or equal to 0.');
        }
     ...
     * Sets receipt_id
     *
     * @param string $receipt_id Идентификатор чека, присвоенный кассовым сервисом (uuid)
     *
     * @return $this
     */
    public function setReceiptId(string $receipt_id): static
    {
        if (is_null($receipt_id)) {
            throw new InvalidArgumentException('non-nullable receipt_id cannot be null');
        }
        if ((mb_strlen($receipt_id) > 36)) {
            throw new InvalidArgumentException('invalid length for $receipt_id when calling GetReceiptStatusRequest., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($receipt_id) < 36)) {
            throw new InvalidArgumentException('invalid length for $receipt_id when calling GetReceiptStatusRequest., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/^[a-f0-9\\-]+$/", ObjectSerializer::toString($receipt_id)))) {
            throw new InvalidArgumentException("invalid value for \$receipt_id when calling GetReceiptStatusRequest., must conform to the pattern /^[a-f0-9\\-]+$/.");
        }
    ...
    public function setOrderId(string $order_id): static
    {
        ...
        if ((mb_strlen($order_id) > 36)) {
            throw new InvalidArgumentException('invalid length for $order_id when calling GetReceiptStatusRequest., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($order_id) < 36)) {
            throw new InvalidArgumentException('invalid length for $order_id when calling GetReceiptStatusRequest., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/^[a-f0-9\\-]+$/", ObjectSerializer::toString($order_id)))) {
            throw new InvalidArgumentException("invalid value for \$order_id when calling GetReceiptStatusRequest., must conform to the pattern /^[a-f0-9\\-]+$/.");
        }
    ...
    public function setOrderNumber(string $order_number): static
    {
        ...
        if ((mb_strlen($order_number) > 36)) {
            throw new InvalidArgumentException('invalid length for $order_number when calling GetReceiptStatusRequest., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($order_number) < 1)) {
            throw new InvalidArgumentException('invalid length for $order_number when calling GetReceiptStatusRequest., must be bigger than or equal to 1.');
        }
