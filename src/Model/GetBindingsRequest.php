...
/**
 * GetBindingsRequest Class Doc Comment
 *
 * @package  SberPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetBindingsRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getBindingsRequest';
    ...
    */
    ...
    public function setUserName(string $user_name): static
    {
        ...
        if ((mb_strlen($user_name) > 30)) {
            throw new InvalidArgumentException('invalid length for $user_name when calling GetBindingsRequest., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($user_name) < 1)) {
            throw new InvalidArgumentException('invalid length for $user_name when calling GetBindingsRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[A-Za-z0-9-_ ]+$/", ObjectSerializer::toString($user_name)))) {
            throw new InvalidArgumentException("invalid value for \$user_name when calling GetBindingsRequest., must conform to the pattern /^[A-Za-z0-9-_ ]+$/.");
        }
    ...
    public function setPassword(string $password): static
    {
        ...
        if ((mb_strlen($password) > 30)) {
            throw new InvalidArgumentException('invalid length for $password when calling GetBindingsRequest., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($password) < 1)) {
            throw new InvalidArgumentException('invalid length for $password when calling GetBindingsRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]+$/", ObjectSerializer::toString($password)))) {
            throw new InvalidArgumentException("invalid value for \$password when calling GetBindingsRequest., must conform to the pattern /^[ -~]+$/.");
        }
    ...
    public function setClientId(string $client_id): static
    {
        ...
        if ((mb_strlen($client_id) > 255)) {
            throw new InvalidArgumentException('invalid length for $client_id when calling GetBindingsRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($client_id) < 1)) {
            throw new InvalidArgumentException('invalid length for $client_id when calling GetBindingsRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]+$/", ObjectSerializer::toString($client_id)))) {
            throw new InvalidArgumentException("invalid value for \$client_id when calling GetBindingsRequest., must conform to the pattern /^[ -~]+$/.");
        }
    ...
    public function setLanguage(?string $language): static
    {
        ...
        if ((mb_strlen($language) > 2)) {
            throw new InvalidArgumentException('invalid length for $language when calling GetBindingsRequest., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($language) < 2)) {
            throw new InvalidArgumentException('invalid length for $language when calling GetBindingsRequest., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^[a-z]+$/", ObjectSerializer::toString($language)))) {
            throw new InvalidArgumentException("invalid value for \$language when calling GetBindingsRequest., must conform to the pattern /^[a-z]+$/.");
        }
     ...
     * @return bool|null
     */
    public function getShowExpired(): ?bool
    {
     ...
     * @return $this
     */
    public function setShowExpired(?bool $show_expired): static
    {
     ...
     * @return $this
     */
    public function setShowInactive(?bool $show_inactive): static
    {
