...
/**
 * RetryReceiptResponse Class Doc Comment
 *
 * @package  SberPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class RetryReceiptResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'retryReceiptResponse';
    ...
    protected static array $openAPITypes = [
        'message' => 'string',
        'retry_result' => '\SberPay\Model\RetryReceiptResponseRetryResultInner[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('retry_result', $data ?? [], null);
    }
    ...
    */
    ...
    public function setMessage(?string $message): static
    {
        ...
        if ((mb_strlen($message) > 256)) {
            throw new InvalidArgumentException('invalid length for $message when calling RetryReceiptResponse., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($message) < 0)) {
            throw new InvalidArgumentException('invalid length for $message when calling RetryReceiptResponse., must be bigger than or equal to 0.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($message)))) {
            throw new InvalidArgumentException("invalid value for \$message when calling RetryReceiptResponse., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
     ...
     * Gets retry_result
     *
     * @return \SberPay\Model\RetryReceiptResponseRetryResultInner[]|null
     */
    public function getRetryResult(): ?array
    {
        return $this->container['retry_result'];
    }

    /**
     * Sets retry_result
     *
     * @param \SberPay\Model\RetryReceiptResponseRetryResultInner[]|null $retry_result Массив ответов с результатом переотправки по каждому чеку
     *
     * @return $this
     */
    public function setRetryResult(?array $retry_result): static
    {
        if (is_null($retry_result)) {
            throw new InvalidArgumentException('non-nullable retry_result cannot be null');
        }
        $this->container['retry_result'] = $retry_result;
