...
/**
 * GetReceiptStatusRequestOneOf Class Doc Comment
 *
 * @package  SberPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetReceiptStatusRequestOneOf implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getReceiptStatusRequest_oneOf';
    ...
    */
    ...
    public function setReceiptId(string $receipt_id): static
    {
        ...
        if ((mb_strlen($receipt_id) > 36)) {
            throw new InvalidArgumentException('invalid length for $receipt_id when calling GetReceiptStatusRequestOneOf., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($receipt_id) < 36)) {
            throw new InvalidArgumentException('invalid length for $receipt_id when calling GetReceiptStatusRequestOneOf., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/^[a-f0-9\\-]+$/", ObjectSerializer::toString($receipt_id)))) {
            throw new InvalidArgumentException("invalid value for \$receipt_id when calling GetReceiptStatusRequestOneOf., must conform to the pattern /^[a-f0-9\\-]+$/.");
        }
