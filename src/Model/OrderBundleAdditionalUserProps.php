<?php
/**
 * OrderBundleAdditionalUserProps
 *
 * PHP version 8.1
 *
 * @package  SberPay
...
/**
 * OrderBundleAdditionalUserProps Class Doc Comment
 *
 ...
 */
class OrderBundleAdditionalUserProps implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'orderBundle_additionalUserProps';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name __Тег ФФД 1085.__ Название дополнительного реквизита
     *
     * @return $this
     */
    public function setName(string $name): static
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new InvalidArgumentException('invalid length for $name when calling OrderBundleAdditionalUserProps., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new InvalidArgumentException('invalid length for $name when calling OrderBundleAdditionalUserProps., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($name)))) {
            throw new InvalidArgumentException("invalid value for \$name when calling OrderBundleAdditionalUserProps., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
     ...
     * Sets value
     *
     * @param string $value __Тег ФФД 1086.__ Значение дополнительного реквизита пользователя
     *
     * @return $this
     */
    public function setValue(string $value): static
    {
        ...
        if ((mb_strlen($value) > 256)) {
            throw new InvalidArgumentException('invalid length for $value when calling OrderBundleAdditionalUserProps., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($value) < 1)) {
            throw new InvalidArgumentException('invalid length for $value when calling OrderBundleAdditionalUserProps., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($value)))) {
            throw new InvalidArgumentException("invalid value for \$value when calling OrderBundleAdditionalUserProps., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
