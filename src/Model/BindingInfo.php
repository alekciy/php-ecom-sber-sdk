 ...
 */
class BindingInfo implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'bindingInfo';
    ...
    */
    ...
    public function setClientId(?string $client_id): static
    {
        ...
        if ((mb_strlen($client_id) > 255)) {
            throw new InvalidArgumentException('invalid length for $client_id when calling BindingInfo., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($client_id) < 1)) {
            throw new InvalidArgumentException('invalid length for $client_id when calling BindingInfo., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]+$/", ObjectSerializer::toString($client_id)))) {
            throw new InvalidArgumentException("invalid value for \$client_id when calling BindingInfo., must conform to the pattern /^[ -~]+$/.");
        }
    ...
    public function setBindingId(?string $binding_id): static
    {
        ...
        if ((mb_strlen($binding_id) > 36)) {
            throw new InvalidArgumentException('invalid length for $binding_id when calling BindingInfo., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($binding_id) < 36)) {
            throw new InvalidArgumentException('invalid length for $binding_id when calling BindingInfo., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/^[a-f0-9\\-]+$/", ObjectSerializer::toString($binding_id)))) {
            throw new InvalidArgumentException("invalid value for \$binding_id when calling BindingInfo., must conform to the pattern /^[a-f0-9\\-]+$/.");
        }
