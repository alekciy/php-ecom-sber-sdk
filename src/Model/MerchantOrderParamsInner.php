...
/**
 * MerchantOrderParamsInner Class Doc Comment
 *
 * @package  SberPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MerchantOrderParamsInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'merchantOrderParams_inner';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Имя передаваемого параметра для различных сценариев
     *
     * @return $this
     */
    public function setName(?string $name): static
    {
        ...
        if ((mb_strlen($name) > 20)) {
            throw new InvalidArgumentException('invalid length for $name when calling MerchantOrderParamsInner., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new InvalidArgumentException('invalid length for $name when calling MerchantOrderParamsInner., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[A-Za-z0-9]*$/", ObjectSerializer::toString($name)))) {
            throw new InvalidArgumentException("invalid value for \$name when calling MerchantOrderParamsInner., must conform to the pattern /^[A-Za-z0-9]*$/.");
        }
     ...
     * Sets value
     *
     * @param string|null $value Значение передаваемого параметра для различных сценариев
     *
     * @return $this
     */
    public function setValue(?string $value): static
    {
        ...
        if ((mb_strlen($value) > 1024)) {
            throw new InvalidArgumentException('invalid length for $value when calling MerchantOrderParamsInner., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($value) < 1)) {
            throw new InvalidArgumentException('invalid length for $value when calling MerchantOrderParamsInner., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[A-Za-z0-9]*$/", ObjectSerializer::toString($value)))) {
            throw new InvalidArgumentException("invalid value for \$value when calling MerchantOrderParamsInner., must conform to the pattern /^[A-Za-z0-9]*$/.");
        }
