<?php
/**
 * CardAuthInfoSecureAuthInfoThreeDSInfo
 *
 * PHP version 8.1
 *
 * @package  SberPay
...
/**
 * CardAuthInfoSecureAuthInfoThreeDSInfo Class Doc Comment
 *
 ...
 */
class CardAuthInfoSecureAuthInfoThreeDSInfo implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'cardAuthInfo_secureAuthInfo_threeDSInfo';
    ...
    */
    ...
    public function setCavv(?string $cavv): static
    {
        ...
        if ((mb_strlen($cavv) > 28)) {
            throw new InvalidArgumentException('invalid length for $cavv when calling CardAuthInfoSecureAuthInfoThreeDSInfo., must be smaller than or equal to 28.');
        }
        if ((mb_strlen($cavv) < 28)) {
            throw new InvalidArgumentException('invalid length for $cavv when calling CardAuthInfoSecureAuthInfoThreeDSInfo., must be bigger than or equal to 28.');
        }
        if ((!preg_match("/^[ -~]+$/", ObjectSerializer::toString($cavv)))) {
            throw new InvalidArgumentException("invalid value for \$cavv when calling CardAuthInfoSecureAuthInfoThreeDSInfo., must conform to the pattern /^[ -~]+$/.");
        }
    ...
    public function setXid(?string $xid): static
    {
        ...
        if ((mb_strlen($xid) > 36)) {
            throw new InvalidArgumentException('invalid length for $xid when calling CardAuthInfoSecureAuthInfoThreeDSInfo., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($xid) < 28)) {
            throw new InvalidArgumentException('invalid length for $xid when calling CardAuthInfoSecureAuthInfoThreeDSInfo., must be bigger than or equal to 28.');
        }
        if ((!preg_match("/^[ -~]+$/", ObjectSerializer::toString($xid)))) {
            throw new InvalidArgumentException("invalid value for \$xid when calling CardAuthInfoSecureAuthInfoThreeDSInfo., must conform to the pattern /^[ -~]+$/.");
        }
