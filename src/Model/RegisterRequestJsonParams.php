...
/**
 * RegisterRequestJsonParams Class Doc Comment
 *
 * @description Блок для передачи дополнительных параметров Клиентом.  В случае, если значения параметров предполагают содержание персональных данных физического лица, необходимо получение согласия на обработку персональных данных. Уведомление Платежного шлюза о наличии такого согласия осуществляется передачей параметра pdAgreement со значением true в блоке jsonParams
 * @package  SberPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class RegisterRequestJsonParams implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'registerRequest_jsonParams';
    ...
    */
    ...
    public function setHasValuableItems(?string $has_valuable_items): static
    {
        ...
        if ((mb_strlen($has_valuable_items) > 2)) {
            throw new InvalidArgumentException('invalid length for $has_valuable_items when calling RegisterRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($has_valuable_items) < 2)) {
            throw new InvalidArgumentException('invalid length for $has_valuable_items when calling RegisterRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($has_valuable_items)))) {
            throw new InvalidArgumentException("invalid value for \$has_valuable_items when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setAcctId(?string $acct_id): static
    {
        ...
        if ((mb_strlen($acct_id) > 64)) {
            throw new InvalidArgumentException('invalid length for $acct_id when calling RegisterRequestJsonParams., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($acct_id) < 1)) {
            throw new InvalidArgumentException('invalid length for $acct_id when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($acct_id)))) {
            throw new InvalidArgumentException("invalid value for \$acct_id when calling RegisterRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setChAccDate(?string $ch_acc_date): static
    {
        ...
        if ((mb_strlen($ch_acc_date) > 8)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_date when calling RegisterRequestJsonParams., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($ch_acc_date) < 8)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_date when calling RegisterRequestJsonParams., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ch_acc_date)))) {
            throw new InvalidArgumentException("invalid value for \$ch_acc_date when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setChAccAgeInd(?string $ch_acc_age_ind): static
    {
        ...
        if ((mb_strlen($ch_acc_age_ind) > 2)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_age_ind when calling RegisterRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($ch_acc_age_ind) < 2)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_age_ind when calling RegisterRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ch_acc_age_ind)))) {
            throw new InvalidArgumentException("invalid value for \$ch_acc_age_ind when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setChAccChangeInd(?string $ch_acc_change_ind): static
    {
        ...
        if ((mb_strlen($ch_acc_change_ind) > 2)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_change_ind when calling RegisterRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($ch_acc_change_ind) < 2)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_change_ind when calling RegisterRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ch_acc_change_ind)))) {
            throw new InvalidArgumentException("invalid value for \$ch_acc_change_ind when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setShipAddrCity(?string $ship_addr_city): static
    {
        ...
        if ((mb_strlen($ship_addr_city) > 50)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_city when calling RegisterRequestJsonParams., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($ship_addr_city) < 1)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_city when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($ship_addr_city)))) {
            throw new InvalidArgumentException("invalid value for \$ship_addr_city when calling RegisterRequestJsonParams., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setShipDeliveryPointId(?string $ship_delivery_point_id): static
    {
        ...
        if ((mb_strlen($ship_delivery_point_id) > 50)) {
            throw new InvalidArgumentException('invalid length for $ship_delivery_point_id when calling RegisterRequestJsonParams., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($ship_delivery_point_id) < 1)) {
            throw new InvalidArgumentException('invalid length for $ship_delivery_point_id when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($ship_delivery_point_id)))) {
            throw new InvalidArgumentException("invalid value for \$ship_delivery_point_id when calling RegisterRequestJsonParams., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setMriReorderItemsInd(?string $mri_reorder_items_ind): static
    {
        ...
        if ((mb_strlen($mri_reorder_items_ind) > 2)) {
            throw new InvalidArgumentException('invalid length for $mri_reorder_items_ind when calling RegisterRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($mri_reorder_items_ind) < 2)) {
            throw new InvalidArgumentException('invalid length for $mri_reorder_items_ind when calling RegisterRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($mri_reorder_items_ind)))) {
            throw new InvalidArgumentException("invalid value for \$mri_reorder_items_ind when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setMobilePhone(?string $mobile_phone): static
    {
        ...
        if ((mb_strlen($mobile_phone) > 19)) {
            throw new InvalidArgumentException('invalid length for $mobile_phone when calling RegisterRequestJsonParams., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($mobile_phone) < 1)) {
            throw new InvalidArgumentException('invalid length for $mobile_phone when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[\\d\\-]*$/", ObjectSerializer::toString($mobile_phone)))) {
            throw new InvalidArgumentException("invalid value for \$mobile_phone when calling RegisterRequestJsonParams., must conform to the pattern /^[\\d\\-]*$/.");
        }
    ...
    public function setShipNameIndicator(?string $ship_name_indicator): static
    {
        ...
        if ((mb_strlen($ship_name_indicator) > 2)) {
            throw new InvalidArgumentException('invalid length for $ship_name_indicator when calling RegisterRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($ship_name_indicator) < 2)) {
            throw new InvalidArgumentException('invalid length for $ship_name_indicator when calling RegisterRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ship_name_indicator)))) {
            throw new InvalidArgumentException("invalid value for \$ship_name_indicator when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setSuspiciousAccActivity(?string $suspicious_acc_activity): static
    {
        ...
        if ((mb_strlen($suspicious_acc_activity) > 2)) {
            throw new InvalidArgumentException('invalid length for $suspicious_acc_activity when calling RegisterRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($suspicious_acc_activity) < 2)) {
            throw new InvalidArgumentException('invalid length for $suspicious_acc_activity when calling RegisterRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($suspicious_acc_activity)))) {
            throw new InvalidArgumentException("invalid value for \$suspicious_acc_activity when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setProvisionAttemptsDay(?string $provision_attempts_day): static
    {
        ...
        if ((mb_strlen($provision_attempts_day) > 4)) {
            throw new InvalidArgumentException('invalid length for $provision_attempts_day when calling RegisterRequestJsonParams., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($provision_attempts_day) < 1)) {
            throw new InvalidArgumentException('invalid length for $provision_attempts_day when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($provision_attempts_day)))) {
            throw new InvalidArgumentException("invalid value for \$provision_attempts_day when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setShipAddrLine1(?string $ship_addr_line1): static
    {
        ...
        if ((mb_strlen($ship_addr_line1) > 50)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_line1 when calling RegisterRequestJsonParams., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($ship_addr_line1) < 1)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_line1 when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($ship_addr_line1)))) {
            throw new InvalidArgumentException("invalid value for \$ship_addr_line1 when calling RegisterRequestJsonParams., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setShipAddrLine2(?string $ship_addr_line2): static
    {
        ...
        if ((mb_strlen($ship_addr_line2) > 50)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_line2 when calling RegisterRequestJsonParams., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($ship_addr_line2) < 1)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_line2 when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($ship_addr_line2)))) {
            throw new InvalidArgumentException("invalid value for \$ship_addr_line2 when calling RegisterRequestJsonParams., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setShipAddrLine3(?string $ship_addr_line3): static
    {
        ...
        if ((mb_strlen($ship_addr_line3) > 50)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_line3 when calling RegisterRequestJsonParams., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($ship_addr_line3) < 1)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_line3 when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($ship_addr_line3)))) {
            throw new InvalidArgumentException("invalid value for \$ship_addr_line3 when calling RegisterRequestJsonParams., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setShipAddressUsage(?string $ship_address_usage): static
    {
        ...
        if ((mb_strlen($ship_address_usage) > 8)) {
            throw new InvalidArgumentException('invalid length for $ship_address_usage when calling RegisterRequestJsonParams., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($ship_address_usage) < 8)) {
            throw new InvalidArgumentException('invalid length for $ship_address_usage when calling RegisterRequestJsonParams., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ship_address_usage)))) {
            throw new InvalidArgumentException("invalid value for \$ship_address_usage when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setShipAddressUsageInd(?string $ship_address_usage_ind): static
    {
        ...
        if ((mb_strlen($ship_address_usage_ind) > 2)) {
            throw new InvalidArgumentException('invalid length for $ship_address_usage_ind when calling RegisterRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($ship_address_usage_ind) < 2)) {
            throw new InvalidArgumentException('invalid length for $ship_address_usage_ind when calling RegisterRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ship_address_usage_ind)))) {
            throw new InvalidArgumentException("invalid value for \$ship_address_usage_ind when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setMriDeliveryTimeframe(?string $mri_delivery_timeframe): static
    {
        ...
        if ((mb_strlen($mri_delivery_timeframe) > 2)) {
            throw new InvalidArgumentException('invalid length for $mri_delivery_timeframe when calling RegisterRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($mri_delivery_timeframe) < 1)) {
            throw new InvalidArgumentException('invalid length for $mri_delivery_timeframe when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($mri_delivery_timeframe)))) {
            throw new InvalidArgumentException("invalid value for \$mri_delivery_timeframe when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setMriShipIndicator(?string $mri_ship_indicator): static
    {
        ...
        if ((mb_strlen($mri_ship_indicator) > 2)) {
            throw new InvalidArgumentException('invalid length for $mri_ship_indicator when calling RegisterRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($mri_ship_indicator) < 2)) {
            throw new InvalidArgumentException('invalid length for $mri_ship_indicator when calling RegisterRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($mri_ship_indicator)))) {
            throw new InvalidArgumentException("invalid value for \$mri_ship_indicator when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setChAccPwChange(?string $ch_acc_pw_change): static
    {
        ...
        if ((mb_strlen($ch_acc_pw_change) > 8)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_pw_change when calling RegisterRequestJsonParams., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($ch_acc_pw_change) < 8)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_pw_change when calling RegisterRequestJsonParams., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ch_acc_pw_change)))) {
            throw new InvalidArgumentException("invalid value for \$ch_acc_pw_change when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setChAccPwChangeInd(?string $ch_acc_pw_change_ind): static
    {
        ...
        if ((mb_strlen($ch_acc_pw_change_ind) > 2)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_pw_change_ind when calling RegisterRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($ch_acc_pw_change_ind) < 2)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_pw_change_ind when calling RegisterRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ch_acc_pw_change_ind)))) {
            throw new InvalidArgumentException("invalid value for \$ch_acc_pw_change_ind when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setNbPurchaseAccount(?string $nb_purchase_account): static
    {
        ...
        if ((mb_strlen($nb_purchase_account) > 4)) {
            throw new InvalidArgumentException('invalid length for $nb_purchase_account when calling RegisterRequestJsonParams., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($nb_purchase_account) < 1)) {
            throw new InvalidArgumentException('invalid length for $nb_purchase_account when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($nb_purchase_account)))) {
            throw new InvalidArgumentException("invalid value for \$nb_purchase_account when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setTxnActivityDay(?string $txn_activity_day): static
    {
        ...
        if ((mb_strlen($txn_activity_day) > 3)) {
            throw new InvalidArgumentException('invalid length for $txn_activity_day when calling RegisterRequestJsonParams., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($txn_activity_day) < 1)) {
            throw new InvalidArgumentException('invalid length for $txn_activity_day when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($txn_activity_day)))) {
            throw new InvalidArgumentException("invalid value for \$txn_activity_day when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setTxnActivityYear(?string $txn_activity_year): static
    {
        ...
        if ((mb_strlen($txn_activity_year) > 3)) {
            throw new InvalidArgumentException('invalid length for $txn_activity_year when calling RegisterRequestJsonParams., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($txn_activity_year) < 1)) {
            throw new InvalidArgumentException('invalid length for $txn_activity_year when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($txn_activity_year)))) {
            throw new InvalidArgumentException("invalid value for \$txn_activity_year when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setPaymentAccAge(?string $payment_acc_age): static
    {
        ...
        if ((mb_strlen($payment_acc_age) > 8)) {
            throw new InvalidArgumentException('invalid length for $payment_acc_age when calling RegisterRequestJsonParams., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($payment_acc_age) < 8)) {
            throw new InvalidArgumentException('invalid length for $payment_acc_age when calling RegisterRequestJsonParams., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($payment_acc_age)))) {
            throw new InvalidArgumentException("invalid value for \$payment_acc_age when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setPaymentAccInd(?string $payment_acc_ind): static
    {
        ...
        if ((mb_strlen($payment_acc_ind) > 2)) {
            throw new InvalidArgumentException('invalid length for $payment_acc_ind when calling RegisterRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($payment_acc_ind) < 2)) {
            throw new InvalidArgumentException('invalid length for $payment_acc_ind when calling RegisterRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($payment_acc_ind)))) {
            throw new InvalidArgumentException("invalid value for \$payment_acc_ind when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setChAccChange(?string $ch_acc_change): static
    {
        ...
        if ((mb_strlen($ch_acc_change) > 8)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_change when calling RegisterRequestJsonParams., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($ch_acc_change) < 8)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_change when calling RegisterRequestJsonParams., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ch_acc_change)))) {
            throw new InvalidArgumentException("invalid value for \$ch_acc_change when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
     ...
     * @return bool|null
     */
    public function getApp2app(): ?bool
    {
     ...
     * @return $this
     */
    public function setApp2app(?bool $app2app): static
    {
        if (is_null($app2app)) {
     ...
     * @return bool|null
     */
    public function getWeb2app(): ?bool
    {
     ...
     * @return $this
     */
    public function setWeb2app(?bool $web2app): static
    {
        if (is_null($web2app)) {
     ...
     * @return string|null
     */
    public function getAppDeepLink(): ?string
    {
     ...
     * @return $this
     */
    public function setAppDeepLink(?string $app_deep_link): static
    {
        ...
        if ((mb_strlen($app_deep_link) > 255)) {
            throw new InvalidArgumentException('invalid length for $app_deep_link when calling RegisterRequestJsonParams., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($app_deep_link) < 1)) {
            throw new InvalidArgumentException('invalid length for $app_deep_link when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($app_deep_link)))) {
            throw new InvalidArgumentException("invalid value for \$app_deep_link when calling RegisterRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
     ...
     * @return string|null
     */
    public function getSberpayBackurl(): ?string
    {
     ...
     * @return $this
     */
    public function setSberpayBackurl(?string $sberpay_backurl): static
    {
        ...
        if ((mb_strlen($sberpay_backurl) > 255)) {
            throw new InvalidArgumentException('invalid length for $sberpay_backurl when calling RegisterRequestJsonParams., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($sberpay_backurl) < 1)) {
            throw new InvalidArgumentException('invalid length for $sberpay_backurl when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($sberpay_backurl)))) {
            throw new InvalidArgumentException("invalid value for \$sberpay_backurl when calling RegisterRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
     ...
     * @return $this
     */
    public function setQrType(string $qr_type): static
    {
        if (is_null($qr_type)) {
     ...
     * @return string|null
     */
    public function getSbpScenario(): ?string
    {
     ...
     * @return $this
     */
    public function setSbpScenario(?string $sbp_scenario): static
    {
     ...
     * @return string|null
     */
    public function getSbpSubscriptionPurpose(): ?string
    {
     ...
     * @return $this
     */
    public function setSbpSubscriptionPurpose(?string $sbp_subscription_purpose): static
    {
        ...
        if ((mb_strlen($sbp_subscription_purpose) > 256)) {
            throw new InvalidArgumentException('invalid length for $sbp_subscription_purpose when calling RegisterRequestJsonParams., must be smaller than or equal to 256.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($sbp_subscription_purpose)))) {
            throw new InvalidArgumentException("invalid value for \$sbp_subscription_purpose when calling RegisterRequestJsonParams., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
     ...
     * @return bool|null
     */
    public function getSberpayQrC2b(): ?bool
    {
     ...
     * @return $this
     */
    public function setSberpayQrC2b(?bool $sberpay_qr_c2b): static
    {
     ...
     * @return bool|null
     */
    public function getSberpaySbpCashLink(): ?bool
    {
     ...
     * @return $this
     */
    public function setSberpaySbpCashLink(?bool $sberpay_sbp_cash_link): static
    {
     ...
     * @return string|null
     */
    public function getBackToShopName(): ?string
    {
     ...
     * @return $this
     */
    public function setBackToShopName(?string $back_to_shop_name): static
    {
        ...
        if ((mb_strlen($back_to_shop_name) > 200)) {
            throw new InvalidArgumentException('invalid length for $back_to_shop_name when calling RegisterRequestJsonParams., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($back_to_shop_name) < 1)) {
            throw new InvalidArgumentException('invalid length for $back_to_shop_name when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($back_to_shop_name)))) {
            throw new InvalidArgumentException("invalid value for \$back_to_shop_name when calling RegisterRequestJsonParams., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
     ...
     * @return string|null
     */
    public function getBackToShopUrl(): ?string
    {
     ...
     * @return $this
     */
    public function setBackToShopUrl(?string $back_to_shop_url): static
    {
        ...
        if ((mb_strlen($back_to_shop_url) > 200)) {
            throw new InvalidArgumentException('invalid length for $back_to_shop_url when calling RegisterRequestJsonParams., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($back_to_shop_url) < 1)) {
            throw new InvalidArgumentException('invalid length for $back_to_shop_url when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^https?:\/\/(.*)$/", ObjectSerializer::toString($back_to_shop_url)))) {
            throw new InvalidArgumentException("invalid value for \$back_to_shop_url when calling RegisterRequestJsonParams., must conform to the pattern /^https?:\/\/(.*)$/.");
        }
    ...
    public function setDestWalletNum(?string $dest_wallet_num): static
    {
        ...
        if ((mb_strlen($dest_wallet_num) > 30)) {
            throw new InvalidArgumentException('invalid length for $dest_wallet_num when calling RegisterRequestJsonParams., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($dest_wallet_num) < 1)) {
            throw new InvalidArgumentException('invalid length for $dest_wallet_num when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($dest_wallet_num)))) {
            throw new InvalidArgumentException("invalid value for \$dest_wallet_num when calling RegisterRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setDestPhoneNum(?string $dest_phone_num): static
    {
        ...
        if ((mb_strlen($dest_phone_num) > 30)) {
            throw new InvalidArgumentException('invalid length for $dest_phone_num when calling RegisterRequestJsonParams., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($dest_phone_num) < 1)) {
            throw new InvalidArgumentException('invalid length for $dest_phone_num when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^(\\+?)\\d{7,15}$/", ObjectSerializer::toString($dest_phone_num)))) {
            throw new InvalidArgumentException("invalid value for \$dest_phone_num when calling RegisterRequestJsonParams., must conform to the pattern /^(\\+?)\\d{7,15}$/.");
        }
    ...
    public function setDestCardNum(?string $dest_card_num): static
    {
        ...
        if ((mb_strlen($dest_card_num) > 19)) {
            throw new InvalidArgumentException('invalid length for $dest_card_num when calling RegisterRequestJsonParams., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($dest_card_num) < 13)) {
            throw new InvalidArgumentException('invalid length for $dest_card_num when calling RegisterRequestJsonParams., must be bigger than or equal to 13.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($dest_card_num)))) {
            throw new InvalidArgumentException("invalid value for \$dest_card_num when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setDestAcctNum(?string $dest_acct_num): static
    {
        ...
        if ((mb_strlen($dest_acct_num) > 29)) {
            throw new InvalidArgumentException('invalid length for $dest_acct_num when calling RegisterRequestJsonParams., must be smaller than or equal to 29.');
        }
        if ((mb_strlen($dest_acct_num) < 1)) {
            throw new InvalidArgumentException('invalid length for $dest_acct_num when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($dest_acct_num)))) {
            throw new InvalidArgumentException("invalid value for \$dest_acct_num when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setBillAddrCity(?string $bill_addr_city): static
    {
        ...
        if ((mb_strlen($bill_addr_city) > 50)) {
            throw new InvalidArgumentException('invalid length for $bill_addr_city when calling RegisterRequestJsonParams., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($bill_addr_city) < 1)) {
            throw new InvalidArgumentException('invalid length for $bill_addr_city when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($bill_addr_city)))) {
            throw new InvalidArgumentException("invalid value for \$bill_addr_city when calling RegisterRequestJsonParams., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setBillAddrCountry(?string $bill_addr_country): static
    {
        ...
        if ((mb_strlen($bill_addr_country) > 3)) {
            throw new InvalidArgumentException('invalid length for $bill_addr_country when calling RegisterRequestJsonParams., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($bill_addr_country) < 1)) {
            throw new InvalidArgumentException('invalid length for $bill_addr_country when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($bill_addr_country)))) {
            throw new InvalidArgumentException("invalid value for \$bill_addr_country when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setBillAddrLine1(?string $bill_addr_line1): static
    {
        ...
        if ((mb_strlen($bill_addr_line1) > 50)) {
            throw new InvalidArgumentException('invalid length for $bill_addr_line1 when calling RegisterRequestJsonParams., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($bill_addr_line1) < 1)) {
            throw new InvalidArgumentException('invalid length for $bill_addr_line1 when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($bill_addr_line1)))) {
            throw new InvalidArgumentException("invalid value for \$bill_addr_line1 when calling RegisterRequestJsonParams., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setBillAddrLine2(?string $bill_addr_line2): static
    {
        ...
        if ((mb_strlen($bill_addr_line2) > 50)) {
            throw new InvalidArgumentException('invalid length for $bill_addr_line2 when calling RegisterRequestJsonParams., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($bill_addr_line2) < 1)) {
            throw new InvalidArgumentException('invalid length for $bill_addr_line2 when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($bill_addr_line2)))) {
            throw new InvalidArgumentException("invalid value for \$bill_addr_line2 when calling RegisterRequestJsonParams., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setBillAddrLine3(?string $bill_addr_line3): static
    {
        ...
        if ((mb_strlen($bill_addr_line3) > 50)) {
            throw new InvalidArgumentException('invalid length for $bill_addr_line3 when calling RegisterRequestJsonParams., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($bill_addr_line3) < 1)) {
            throw new InvalidArgumentException('invalid length for $bill_addr_line3 when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($bill_addr_line3)))) {
            throw new InvalidArgumentException("invalid value for \$bill_addr_line3 when calling RegisterRequestJsonParams., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setBillAddrPostCode(?string $bill_addr_post_code): static
    {
        ...
        if ((mb_strlen($bill_addr_post_code) > 16)) {
            throw new InvalidArgumentException('invalid length for $bill_addr_post_code when calling RegisterRequestJsonParams., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($bill_addr_post_code) < 1)) {
            throw new InvalidArgumentException('invalid length for $bill_addr_post_code when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($bill_addr_post_code)))) {
            throw new InvalidArgumentException("invalid value for \$bill_addr_post_code when calling RegisterRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setBillAddrState(?string $bill_addr_state): static
    {
        ...
        if ((mb_strlen($bill_addr_state) > 3)) {
            throw new InvalidArgumentException('invalid length for $bill_addr_state when calling RegisterRequestJsonParams., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($bill_addr_state) < 1)) {
            throw new InvalidArgumentException('invalid length for $bill_addr_state when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($bill_addr_state)))) {
            throw new InvalidArgumentException("invalid value for \$bill_addr_state when calling RegisterRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setShipAddrCountry(?string $ship_addr_country): static
    {
        ...
        if ((mb_strlen($ship_addr_country) > 3)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_country when calling RegisterRequestJsonParams., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($ship_addr_country) < 1)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_country when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ship_addr_country)))) {
            throw new InvalidArgumentException("invalid value for \$ship_addr_country when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setShipAddrPostCode(?string $ship_addr_post_code): static
    {
        ...
        if ((mb_strlen($ship_addr_post_code) > 16)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_post_code when calling RegisterRequestJsonParams., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($ship_addr_post_code) < 1)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_post_code when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($ship_addr_post_code)))) {
            throw new InvalidArgumentException("invalid value for \$ship_addr_post_code when calling RegisterRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setShipAddrState(?string $ship_addr_state): static
    {
        ...
        if ((mb_strlen($ship_addr_state) > 3)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_state when calling RegisterRequestJsonParams., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($ship_addr_state) < 1)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_state when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($ship_addr_state)))) {
            throw new InvalidArgumentException("invalid value for \$ship_addr_state when calling RegisterRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setWorkPhone(?string $work_phone): static
    {
        ...
        if ((mb_strlen($work_phone) > 19)) {
            throw new InvalidArgumentException('invalid length for $work_phone when calling RegisterRequestJsonParams., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($work_phone) < 1)) {
            throw new InvalidArgumentException('invalid length for $work_phone when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[\\d\\-]*$/", ObjectSerializer::toString($work_phone)))) {
            throw new InvalidArgumentException("invalid value for \$work_phone when calling RegisterRequestJsonParams., must conform to the pattern /^[\\d\\-]*$/.");
        }
    ...
    public function setHomePhone(?string $home_phone): static
    {
        ...
        if ((mb_strlen($home_phone) > 19)) {
            throw new InvalidArgumentException('invalid length for $home_phone when calling RegisterRequestJsonParams., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($home_phone) < 1)) {
            throw new InvalidArgumentException('invalid length for $home_phone when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[\\d\\-]*$/", ObjectSerializer::toString($home_phone)))) {
            throw new InvalidArgumentException("invalid value for \$home_phone when calling RegisterRequestJsonParams., must conform to the pattern /^[\\d\\-]*$/.");
        }
    ...
    public function setMriDeliveryEmailAddress(?string $mri_delivery_email_address): static
    {
        ...
        if ((mb_strlen($mri_delivery_email_address) > 254)) {
            throw new InvalidArgumentException('invalid length for $mri_delivery_email_address when calling RegisterRequestJsonParams., must be smaller than or equal to 254.');
        }
        if ((mb_strlen($mri_delivery_email_address) < 1)) {
            throw new InvalidArgumentException('invalid length for $mri_delivery_email_address when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($mri_delivery_email_address)))) {
            throw new InvalidArgumentException("invalid value for \$mri_delivery_email_address when calling RegisterRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setMriGiftCardAmount(?string $mri_gift_card_amount): static
    {
        ...
        if ((mb_strlen($mri_gift_card_amount) > 2)) {
            throw new InvalidArgumentException('invalid length for $mri_gift_card_amount when calling RegisterRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($mri_gift_card_amount) < 1)) {
            throw new InvalidArgumentException('invalid length for $mri_gift_card_amount when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($mri_gift_card_amount)))) {
            throw new InvalidArgumentException("invalid value for \$mri_gift_card_amount when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setMriGiftCardCount(?string $mri_gift_card_count): static
    {
        ...
        if ((mb_strlen($mri_gift_card_count) > 2)) {
            throw new InvalidArgumentException('invalid length for $mri_gift_card_count when calling RegisterRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($mri_gift_card_count) < 1)) {
            throw new InvalidArgumentException('invalid length for $mri_gift_card_count when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($mri_gift_card_count)))) {
            throw new InvalidArgumentException("invalid value for \$mri_gift_card_count when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setMriGiftCardCurr(?string $mri_gift_card_curr): static
    {
        ...
        if ((mb_strlen($mri_gift_card_curr) > 3)) {
            throw new InvalidArgumentException('invalid length for $mri_gift_card_curr when calling RegisterRequestJsonParams., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($mri_gift_card_curr) < 1)) {
            throw new InvalidArgumentException('invalid length for $mri_gift_card_curr when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($mri_gift_card_curr)))) {
            throw new InvalidArgumentException("invalid value for \$mri_gift_card_curr when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setMriPreOrderDate(?string $mri_pre_order_date): static
    {
        ...
        if ((mb_strlen($mri_pre_order_date) > 8)) {
            throw new InvalidArgumentException('invalid length for $mri_pre_order_date when calling RegisterRequestJsonParams., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($mri_pre_order_date) < 8)) {
            throw new InvalidArgumentException('invalid length for $mri_pre_order_date when calling RegisterRequestJsonParams., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($mri_pre_order_date)))) {
            throw new InvalidArgumentException("invalid value for \$mri_pre_order_date when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setMriPreOrderPurchaseInd(?string $mri_pre_order_purchase_ind): static
    {
        ...
        if ((mb_strlen($mri_pre_order_purchase_ind) > 2)) {
            throw new InvalidArgumentException('invalid length for $mri_pre_order_purchase_ind when calling RegisterRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($mri_pre_order_purchase_ind) < 2)) {
            throw new InvalidArgumentException('invalid length for $mri_pre_order_purchase_ind when calling RegisterRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($mri_pre_order_purchase_ind)))) {
            throw new InvalidArgumentException("invalid value for \$mri_pre_order_purchase_ind when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setThreeDsReqPriorAuthData(?string $three_ds_req_prior_auth_data): static
    {
        ...
        if ((mb_strlen($three_ds_req_prior_auth_data) > 2048)) {
            throw new InvalidArgumentException('invalid length for $three_ds_req_prior_auth_data when calling RegisterRequestJsonParams., must be smaller than or equal to 2048.');
        }
        if ((mb_strlen($three_ds_req_prior_auth_data) < 1)) {
            throw new InvalidArgumentException('invalid length for $three_ds_req_prior_auth_data when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($three_ds_req_prior_auth_data)))) {
            throw new InvalidArgumentException("invalid value for \$three_ds_req_prior_auth_data when calling RegisterRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setThreeDsReqPriorAuthMethod(?string $three_ds_req_prior_auth_method): static
    {
        ...
        if ((mb_strlen($three_ds_req_prior_auth_method) > 2)) {
            throw new InvalidArgumentException('invalid length for $three_ds_req_prior_auth_method when calling RegisterRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($three_ds_req_prior_auth_method) < 2)) {
            throw new InvalidArgumentException('invalid length for $three_ds_req_prior_auth_method when calling RegisterRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($three_ds_req_prior_auth_method)))) {
            throw new InvalidArgumentException("invalid value for \$three_ds_req_prior_auth_method when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setThreeDsReqPriorAuthTimestamp(?string $three_ds_req_prior_auth_timestamp): static
    {
        ...
        if ((mb_strlen($three_ds_req_prior_auth_timestamp) > 12)) {
            throw new InvalidArgumentException('invalid length for $three_ds_req_prior_auth_timestamp when calling RegisterRequestJsonParams., must be smaller than or equal to 12.');
        }
        if ((mb_strlen($three_ds_req_prior_auth_timestamp) < 12)) {
            throw new InvalidArgumentException('invalid length for $three_ds_req_prior_auth_timestamp when calling RegisterRequestJsonParams., must be bigger than or equal to 12.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($three_ds_req_prior_auth_timestamp)))) {
            throw new InvalidArgumentException("invalid value for \$three_ds_req_prior_auth_timestamp when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setThreeDsReqPriorRef(?string $three_ds_req_prior_ref): static
    {
        ...
        if ((mb_strlen($three_ds_req_prior_ref) > 36)) {
            throw new InvalidArgumentException('invalid length for $three_ds_req_prior_ref when calling RegisterRequestJsonParams., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($three_ds_req_prior_ref) < 36)) {
            throw new InvalidArgumentException('invalid length for $three_ds_req_prior_ref when calling RegisterRequestJsonParams., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($three_ds_req_prior_ref)))) {
            throw new InvalidArgumentException("invalid value for \$three_ds_req_prior_ref when calling RegisterRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setThreeDsReqAuthData(?string $three_ds_req_auth_data): static
    {
        ...
        if ((mb_strlen($three_ds_req_auth_data) > 20000)) {
            throw new InvalidArgumentException('invalid length for $three_ds_req_auth_data when calling RegisterRequestJsonParams., must be smaller than or equal to 20000.');
        }
        if ((mb_strlen($three_ds_req_auth_data) < 2)) {
            throw new InvalidArgumentException('invalid length for $three_ds_req_auth_data when calling RegisterRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($three_ds_req_auth_data)))) {
            throw new InvalidArgumentException("invalid value for \$three_ds_req_auth_data when calling RegisterRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setThreeDsReqAuthMethod(?string $three_ds_req_auth_method): static
    {
        ...
        if ((mb_strlen($three_ds_req_auth_method) > 2)) {
            throw new InvalidArgumentException('invalid length for $three_ds_req_auth_method when calling RegisterRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($three_ds_req_auth_method) < 2)) {
            throw new InvalidArgumentException('invalid length for $three_ds_req_auth_method when calling RegisterRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($three_ds_req_auth_method)))) {
            throw new InvalidArgumentException("invalid value for \$three_ds_req_auth_method when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setThreeDsReqAuthTimestamp(?string $three_ds_req_auth_timestamp): static
    {
        ...
        if ((mb_strlen($three_ds_req_auth_timestamp) > 12)) {
            throw new InvalidArgumentException('invalid length for $three_ds_req_auth_timestamp when calling RegisterRequestJsonParams., must be smaller than or equal to 12.');
        }
        if ((mb_strlen($three_ds_req_auth_timestamp) < 12)) {
            throw new InvalidArgumentException('invalid length for $three_ds_req_auth_timestamp when calling RegisterRequestJsonParams., must be bigger than or equal to 12.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($three_ds_req_auth_timestamp)))) {
            throw new InvalidArgumentException("invalid value for \$three_ds_req_auth_timestamp when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setAcctType(?string $acct_type): static
    {
        ...
        if ((mb_strlen($acct_type) > 2)) {
            throw new InvalidArgumentException('invalid length for $acct_type when calling RegisterRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($acct_type) < 2)) {
            throw new InvalidArgumentException('invalid length for $acct_type when calling RegisterRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($acct_type)))) {
            throw new InvalidArgumentException("invalid value for \$acct_type when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setTransType(?string $trans_type): static
    {
        ...
        if ((mb_strlen($trans_type) > 2)) {
            throw new InvalidArgumentException('invalid length for $trans_type when calling RegisterRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($trans_type) < 2)) {
            throw new InvalidArgumentException('invalid length for $trans_type when calling RegisterRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($trans_type)))) {
            throw new InvalidArgumentException("invalid value for \$trans_type when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setAddrMatch(?string $addr_match): static
    {
        ...
        if ((mb_strlen($addr_match) > 1)) {
            throw new InvalidArgumentException('invalid length for $addr_match when calling RegisterRequestJsonParams., must be smaller than or equal to 1.');
        }
        if ((mb_strlen($addr_match) < 1)) {
            throw new InvalidArgumentException('invalid length for $addr_match when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[A-Za-z]*$/", ObjectSerializer::toString($addr_match)))) {
            throw new InvalidArgumentException("invalid value for \$addr_match when calling RegisterRequestJsonParams., must conform to the pattern /^[A-Za-z]*$/.");
        }
    ...
    public function setThreeDsRequestorChallengeInd(?string $three_ds_requestor_challenge_ind): static
    {
        ...
        if ((mb_strlen($three_ds_requestor_challenge_ind) > 2)) {
            throw new InvalidArgumentException('invalid length for $three_ds_requestor_challenge_ind when calling RegisterRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($three_ds_requestor_challenge_ind) < 2)) {
            throw new InvalidArgumentException('invalid length for $three_ds_requestor_challenge_ind when calling RegisterRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($three_ds_requestor_challenge_ind)))) {
            throw new InvalidArgumentException("invalid value for \$three_ds_requestor_challenge_ind when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setPurchaseInstalData(?string $purchase_instal_data): static
    {
        ...
        if ((mb_strlen($purchase_instal_data) > 3)) {
            throw new InvalidArgumentException('invalid length for $purchase_instal_data when calling RegisterRequestJsonParams., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($purchase_instal_data) < 1)) {
            throw new InvalidArgumentException('invalid length for $purchase_instal_data when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($purchase_instal_data)))) {
            throw new InvalidArgumentException("invalid value for \$purchase_instal_data when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setRecurringExpiry(?string $recurring_expiry): static
    {
        ...
        if ((mb_strlen($recurring_expiry) > 8)) {
            throw new InvalidArgumentException('invalid length for $recurring_expiry when calling RegisterRequestJsonParams., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($recurring_expiry) < 8)) {
            throw new InvalidArgumentException('invalid length for $recurring_expiry when calling RegisterRequestJsonParams., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($recurring_expiry)))) {
            throw new InvalidArgumentException("invalid value for \$recurring_expiry when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setRecurringFrequency(?string $recurring_frequency): static
    {
        ...
        if ((mb_strlen($recurring_frequency) > 4)) {
            throw new InvalidArgumentException('invalid length for $recurring_frequency when calling RegisterRequestJsonParams., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($recurring_frequency) < 1)) {
            throw new InvalidArgumentException('invalid length for $recurring_frequency when calling RegisterRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($recurring_frequency)))) {
            throw new InvalidArgumentException("invalid value for \$recurring_frequency when calling RegisterRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
