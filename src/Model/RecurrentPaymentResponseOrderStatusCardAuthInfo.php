...
class RecurrentPaymentResponseOrderStatusCardAuthInfo implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'recurrentPaymentResponse_orderStatus_cardAuthInfo';
    ...
    */
    ...
    public function setPan(?string $pan): static
    {
        ...
        if ((mb_strlen($pan) > 20)) {
            throw new InvalidArgumentException('invalid length for $pan when calling RecurrentPaymentResponseOrderStatusCardAuthInfo., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($pan) < 1)) {
            throw new InvalidArgumentException('invalid length for $pan when calling RecurrentPaymentResponseOrderStatusCardAuthInfo., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[0-9*]+$/", ObjectSerializer::toString($pan)))) {
            throw new InvalidArgumentException("invalid value for \$pan when calling RecurrentPaymentResponseOrderStatusCardAuthInfo., must conform to the pattern /^[0-9*]+$/.");
        }
