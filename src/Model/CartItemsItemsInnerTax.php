...
/**
 * CartItemsItemsInnerTax Class Doc Comment
 *
 ...
 */
class CartItemsItemsInnerTax implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'cartItems_items_inner_tax';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (($this->container['tax_type'] > 7)) {
            $invalidProperties[] = "invalid value for 'tax_type', must be smaller than or equal to 7.";
        }

        if (($this->container['tax_type'] < 0)) {
            $invalidProperties[] = "invalid value for 'tax_type', must be bigger than or equal to 0.";
        }
     ...
     * Sets tax_type
     *
     * @param int $tax_type __Тэг ФФД 1199.__ Тип НДС:   * `0` = без НДС;    * `1` = НДС по ставке 0%;    * `2` = НДС чека по ставке 10%;    * `4` = НДС чека по расчётной ставке 10/110;    * `6` = НДС чека по ставке 20%;   * `7` = НДС чека по расчётной ставке 20/120.
     *
     * @return $this
     */
    public function setTaxType(int $tax_type): static
    {
        if (is_null($tax_type)) {
        ...
        if (($tax_type > 7)) {
            throw new InvalidArgumentException('invalid value for $tax_type when calling CartItemsItemsInnerTax., must be smaller than or equal to 7.');
        }
        if (($tax_type < 0)) {
            throw new InvalidArgumentException('invalid value for $tax_type when calling CartItemsItemsInnerTax., must be bigger than or equal to 0.');
        }
