...
/**
 * RegisterPreAuthRequest Class Doc Comment
 *
 * @package  SberPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class RegisterPreAuthRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'registerPreAuthRequest';
    ...
    protected static array $openAPITypes = [
        ...
        'json_params' => '\SberPay\Model\RegisterPreAuthRequestJsonParams',
        ...
        'phone' => 'string',
        'email' => 'string',
        'order_bundle' => '\SberPay\Model\OrderBundle',
    ...
    protected static array $attributeMap = [
        ...
        'autocompletion_date' => 'autocompletionDate'
    ];
    ...
    protected static array $setters = [
        ...
        'autocompletion_date' => 'setAutocompletionDate'
    ];
    ...
    protected static array $getters = [
        ...
        'autocompletion_date' => 'getAutocompletionDate'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('autocompletion_date', $data ?? [], null);
    }
    ...
    */
    ...
    public function setUserName(string $user_name): static
    {
        ...
        if ((mb_strlen($user_name) > 30)) {
            throw new InvalidArgumentException('invalid length for $user_name when calling RegisterPreAuthRequest., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($user_name) < 1)) {
            throw new InvalidArgumentException('invalid length for $user_name when calling RegisterPreAuthRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[A-Za-z0-9-_ ]+$/", ObjectSerializer::toString($user_name)))) {
            throw new InvalidArgumentException("invalid value for \$user_name when calling RegisterPreAuthRequest., must conform to the pattern /^[A-Za-z0-9-_ ]+$/.");
        }
    ...
    public function setPassword(string $password): static
    {
        ...
        if ((mb_strlen($password) > 30)) {
            throw new InvalidArgumentException('invalid length for $password when calling RegisterPreAuthRequest., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($password) < 1)) {
            throw new InvalidArgumentException('invalid length for $password when calling RegisterPreAuthRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]+$/", ObjectSerializer::toString($password)))) {
            throw new InvalidArgumentException("invalid value for \$password when calling RegisterPreAuthRequest., must conform to the pattern /^[ -~]+$/.");
        }
     ...
     * Sets order_number
     *
     * @param string $order_number Уникальный номер (идентификатор) заказа в системе Клиента
     *
     * @return $this
     */
    public function setOrderNumber(string $order_number): static
    {
        ...
        if ((mb_strlen($order_number) > 36)) {
            throw new InvalidArgumentException('invalid length for $order_number when calling RegisterPreAuthRequest., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($order_number) < 1)) {
            throw new InvalidArgumentException('invalid length for $order_number when calling RegisterPreAuthRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setAmount(int $amount): static
    {
        ...
        if (($amount > 999999999999)) {
            throw new InvalidArgumentException('invalid value for $amount when calling RegisterPreAuthRequest., must be smaller than or equal to 999999999999.');
        }
        if (($amount < 0)) {
            throw new InvalidArgumentException('invalid value for $amount when calling RegisterPreAuthRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setCurrency(?string $currency): static
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new InvalidArgumentException('invalid length for $currency when calling RegisterPreAuthRequest., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new InvalidArgumentException('invalid length for $currency when calling RegisterPreAuthRequest., must be bigger than or equal to 3.');
        }
        if ((!preg_match("/^\\d{3}$/", ObjectSerializer::toString($currency)))) {
            throw new InvalidArgumentException("invalid value for \$currency when calling RegisterPreAuthRequest., must conform to the pattern /^\\d{3}$/.");
        }
    ...
    public function setReturnUrl(string $return_url): static
    {
        ...
        if ((mb_strlen($return_url) > 2048)) {
            throw new InvalidArgumentException('invalid length for $return_url when calling RegisterPreAuthRequest., must be smaller than or equal to 2048.');
        }
        if ((mb_strlen($return_url) < 12)) {
            throw new InvalidArgumentException('invalid length for $return_url when calling RegisterPreAuthRequest., must be bigger than or equal to 12.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($return_url)))) {
            throw new InvalidArgumentException("invalid value for \$return_url when calling RegisterPreAuthRequest., must conform to the pattern /^[ -~]*$/.");
        }
     ...
     * @return $this
     */
    public function setFailUrl(?string $fail_url): static
    {
        if (is_null($fail_url)) {
            throw new InvalidArgumentException('non-nullable fail_url cannot be null');
        }
        if ((mb_strlen($fail_url) > 2048)) {
            throw new InvalidArgumentException('invalid length for $fail_url when calling RegisterPreAuthRequest., must be smaller than or equal to 2048.');
        }
        if ((mb_strlen($fail_url) < 12)) {
            throw new InvalidArgumentException('invalid length for $fail_url when calling RegisterPreAuthRequest., must be bigger than or equal to 12.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($fail_url)))) {
            throw new InvalidArgumentException("invalid value for \$fail_url when calling RegisterPreAuthRequest., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setDescription(?string $description): static
    {
        ...
        if ((mb_strlen($description) > 512)) {
            throw new InvalidArgumentException('invalid length for $description when calling RegisterPreAuthRequest., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new InvalidArgumentException('invalid length for $description when calling RegisterPreAuthRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($description)))) {
            throw new InvalidArgumentException("invalid value for \$description when calling RegisterPreAuthRequest., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setLanguage(?string $language): static
    {
        ...
        if ((mb_strlen($language) > 2)) {
            throw new InvalidArgumentException('invalid length for $language when calling RegisterPreAuthRequest., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($language) < 2)) {
            throw new InvalidArgumentException('invalid length for $language when calling RegisterPreAuthRequest., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^[a-z]+$/", ObjectSerializer::toString($language)))) {
            throw new InvalidArgumentException("invalid value for \$language when calling RegisterPreAuthRequest., must conform to the pattern /^[a-z]+$/.");
        }
    ...
    public function setClientId(?string $client_id): static
    {
        ...
        if ((mb_strlen($client_id) > 255)) {
            throw new InvalidArgumentException('invalid length for $client_id when calling RegisterPreAuthRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($client_id) < 1)) {
            throw new InvalidArgumentException('invalid length for $client_id when calling RegisterPreAuthRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]+$/", ObjectSerializer::toString($client_id)))) {
            throw new InvalidArgumentException("invalid value for \$client_id when calling RegisterPreAuthRequest., must conform to the pattern /^[ -~]+$/.");
        }
     ...
     * @return $this
     */
    public function setMerchantLogin(?string $merchant_login): static
    {
        ...
        if ((mb_strlen($merchant_login) > 30)) {
            throw new InvalidArgumentException('invalid length for $merchant_login when calling RegisterPreAuthRequest., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($merchant_login) < 1)) {
            throw new InvalidArgumentException('invalid length for $merchant_login when calling RegisterPreAuthRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[A-Za-z0-9-_ ]+$/", ObjectSerializer::toString($merchant_login)))) {
            throw new InvalidArgumentException("invalid value for \$merchant_login when calling RegisterPreAuthRequest., must conform to the pattern /^[A-Za-z0-9-_ ]+$/.");
        }
     ...
     * Gets json_params
     *
     * @return \SberPay\Model\RegisterPreAuthRequestJsonParams|null
     */
    public function getJsonParams(): ?\SberPay\Model\RegisterPreAuthRequestJsonParams
    {
     ...
     * Sets json_params
     *
     * @param \SberPay\Model\RegisterPreAuthRequestJsonParams|null $json_params json_params
     *
     * @return $this
     */
    public function setJsonParams(?\SberPay\Model\RegisterPreAuthRequestJsonParams $json_params): static
    {
     ...
     * @return $this
     */
    public function setSessionTimeoutSecs(?int $session_timeout_secs): static
    {
        ...
        if (($session_timeout_secs > 999999999)) {
            throw new InvalidArgumentException('invalid value for $session_timeout_secs when calling RegisterPreAuthRequest., must be smaller than or equal to 999999999.');
        }
        if (($session_timeout_secs < 0)) {
            throw new InvalidArgumentException('invalid value for $session_timeout_secs when calling RegisterPreAuthRequest., must be bigger than or equal to 0.');
        }
     ...
     * @return $this
     */
    public function setBindingId(?string $binding_id): static
    {
        if (is_null($binding_id)) {
            throw new InvalidArgumentException('non-nullable binding_id cannot be null');
        }
        if ((mb_strlen($binding_id) > 36)) {
            throw new InvalidArgumentException('invalid length for $binding_id when calling RegisterPreAuthRequest., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($binding_id) < 36)) {
            throw new InvalidArgumentException('invalid length for $binding_id when calling RegisterPreAuthRequest., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/^[a-f0-9\\-]+$/", ObjectSerializer::toString($binding_id)))) {
            throw new InvalidArgumentException("invalid value for \$binding_id when calling RegisterPreAuthRequest., must conform to the pattern /^[a-f0-9\\-]+$/.");
        }
    ...
    public function setFeatures(?string $features): static
    {
        ...
        if ((mb_strlen($features) > 255)) {
            throw new InvalidArgumentException('invalid length for $features when calling RegisterPreAuthRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($features) < 1)) {
            throw new InvalidArgumentException('invalid length for $features when calling RegisterPreAuthRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($features)))) {
            throw new InvalidArgumentException("invalid value for \$features when calling RegisterPreAuthRequest., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setPhone(?string $phone): static
    {
        ...
        if ((mb_strlen($phone) > 16)) {
            throw new InvalidArgumentException('invalid length for $phone when calling RegisterPreAuthRequest., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($phone) < 1)) {
            throw new InvalidArgumentException('invalid length for $phone when calling RegisterPreAuthRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^(\\+?)\\d{7,15}$/", ObjectSerializer::toString($phone)))) {
            throw new InvalidArgumentException("invalid value for \$phone when calling RegisterPreAuthRequest., must conform to the pattern /^(\\+?)\\d{7,15}$/.");
        }
    ...
    public function setEmail(?string $email): static
    {
        ...
        if ((mb_strlen($email) > 128)) {
            throw new InvalidArgumentException('invalid length for $email when calling RegisterPreAuthRequest., must be smaller than or equal to 128.');
        }
        if ((mb_strlen($email) < 3)) {
            throw new InvalidArgumentException('invalid length for $email when calling RegisterPreAuthRequest., must be bigger than or equal to 3.');
        }
        if ((!preg_match("/^[ -~]+$/", ObjectSerializer::toString($email)))) {
            throw new InvalidArgumentException("invalid value for \$email when calling RegisterPreAuthRequest., must conform to the pattern /^[ -~]+$/.");
        }
     ...
     * Gets order_bundle
     *
     * @return \SberPay\Model\OrderBundle|null
     */
    public function getOrderBundle(): ?\SberPay\Model\OrderBundle
    {
     ...
     * Sets order_bundle
     *
     * @param \SberPay\Model\OrderBundle|null $order_bundle order_bundle
     *
     * @return $this
     */
    public function setOrderBundle(?\SberPay\Model\OrderBundle $order_bundle): static
    {
    ...
    /**
     * Gets autocompletion_date
     *
     * @return \DateTime|null
     */
    public function getAutocompletionDate(): ?\DateTime
    {
        return $this->container['autocompletion_date'];
    }

    /**
     * Sets autocompletion_date
     *
     * @param \DateTime|null $autocompletion_date Дата и время автоматического подтверждения заказа в формате yyyy-MM-ddTHH:mm:ss. Если передан параметр, то вызов метода deposit не требуется.
     *
     * @return $this
     */
    public function setAutocompletionDate(?\DateTime $autocompletion_date): static
    {
        if (is_null($autocompletion_date)) {
            throw new InvalidArgumentException('non-nullable autocompletion_date cannot be null');
        }
        $this->container['autocompletion_date'] = $autocompletion_date;
