...
/**
 * RefundRequestJsonParams Class Doc Comment
 *
 ...
 */
class RefundRequestJsonParams implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'refundRequest_jsonParams';
    ...
    */
     ...
     * @return $this
     */
    public function setExternalRefundId(?string $external_refund_id): static
    {
        ...
        if ((mb_strlen($external_refund_id) > 36)) {
            throw new InvalidArgumentException('invalid length for $external_refund_id when calling RefundRequestJsonParams., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($external_refund_id) < 1)) {
            throw new InvalidArgumentException('invalid length for $external_refund_id when calling RefundRequestJsonParams., must be bigger than or equal to 1.');
        }
