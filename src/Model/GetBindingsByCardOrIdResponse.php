...
/**
 * GetBindingsByCardOrIdResponse Class Doc Comment
 *
 * @package  SberPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetBindingsByCardOrIdResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getBindingsByCardOrIdResponse';
    ...
    protected static array $openAPITypes = [
        ...
        'bindings' => '\SberPay\Model\BindingsInner[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['bindings']) && (count($this->container['bindings']) > 100)) {
            $invalidProperties[] = "invalid value for 'bindings', number of items must be less than or equal to 100.";
        }
    ...
    public function setErrorCode(string $error_code): static
    {
        ...
        if ((mb_strlen($error_code) > 3)) {
            throw new InvalidArgumentException('invalid length for $error_code when calling GetBindingsByCardOrIdResponse., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($error_code) < 1)) {
            throw new InvalidArgumentException('invalid length for $error_code when calling GetBindingsByCardOrIdResponse., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d{1,3}$/", ObjectSerializer::toString($error_code)))) {
            throw new InvalidArgumentException("invalid value for \$error_code when calling GetBindingsByCardOrIdResponse., must conform to the pattern /^\\d{1,3}$/.");
        }
    ...
    public function setErrorMessage(?string $error_message): static
    {
        ...
        if ((mb_strlen($error_message) > 512)) {
            throw new InvalidArgumentException('invalid length for $error_message when calling GetBindingsByCardOrIdResponse., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($error_message) < 0)) {
            throw new InvalidArgumentException('invalid length for $error_message when calling GetBindingsByCardOrIdResponse., must be bigger than or equal to 0.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($error_message)))) {
            throw new InvalidArgumentException("invalid value for \$error_message when calling GetBindingsByCardOrIdResponse., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
     ...
     * Gets bindings
     *
     * @return \SberPay\Model\BindingsInner[]|null
     */
     ...
     * Sets bindings
     *
     * @param \SberPay\Model\BindingsInner[]|null $bindings Дополнительная информации о Связках Плательщика
     *
     * @return $this
     */
    public function setBindings(?array $bindings): static
    {
        ...
        if ((count($bindings) > 100)) {
            throw new InvalidArgumentException('invalid value for $bindings when calling GetBindingsByCardOrIdResponse., number of items must be less than or equal to 100.');
        }
