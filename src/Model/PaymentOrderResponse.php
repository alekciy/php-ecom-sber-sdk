...
class PaymentOrderResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'paymentOrderResponse';
    ...
    protected static array $openAPITypes = [
        ...
        'acs_decouple_indicator' => '\SberPay\Model\AcsDecoupleIndicator'
    ];
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['error']) && !preg_match("/^[ -~А-Яа-яЁё№]*$/", $this->container['error'])) {
            $invalidProperties[] = "invalid value for 'error', must be conform to the pattern /^[ -~А-Яа-яЁё№]*$/.";
        }
    ...
    public function setErrorCode(string $error_code): static
    {
        ...
        if ((mb_strlen($error_code) > 3)) {
            throw new InvalidArgumentException('invalid length for $error_code when calling PaymentOrderResponse., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($error_code) < 1)) {
            throw new InvalidArgumentException('invalid length for $error_code when calling PaymentOrderResponse., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d{1,3}$/", ObjectSerializer::toString($error_code)))) {
            throw new InvalidArgumentException("invalid value for \$error_code when calling PaymentOrderResponse., must conform to the pattern /^\\d{1,3}$/.");
        }
     ...
     * Sets error
     *
     * @param string|null $error Описание ошибки на языке, переданном в параметре language в запросе
     *
     * @return $this
     */
    public function setError(?string $error): static
    {
        ...
        if ((mb_strlen($error) > 512)) {
            throw new InvalidArgumentException('invalid length for $error when calling PaymentOrderResponse., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($error) < 0)) {
            throw new InvalidArgumentException('invalid length for $error when calling PaymentOrderResponse., must be bigger than or equal to 0.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($error)))) {
            throw new InvalidArgumentException("invalid value for \$error when calling PaymentOrderResponse., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setInfo(?string $info): static
    {
        ...
        if ((mb_strlen($info) > 512)) {
            throw new InvalidArgumentException('invalid length for $info when calling PaymentOrderResponse., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($info) < 0)) {
            throw new InvalidArgumentException('invalid length for $info when calling PaymentOrderResponse., must be bigger than or equal to 0.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($info)))) {
            throw new InvalidArgumentException("invalid value for \$info when calling PaymentOrderResponse., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setRedirect(?string $redirect): static
    {
        ...
        if ((mb_strlen($redirect) > 2048)) {
            throw new InvalidArgumentException('invalid length for $redirect when calling PaymentOrderResponse., must be smaller than or equal to 2048.');
        }
        if ((mb_strlen($redirect) < 1)) {
            throw new InvalidArgumentException('invalid length for $redirect when calling PaymentOrderResponse., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($redirect)))) {
            throw new InvalidArgumentException("invalid value for \$redirect when calling PaymentOrderResponse., must conform to the pattern /^[ -~]*$/.");
        }
     ...
     * @return $this
     */
    public function setTermUrl(?string $term_url): static
    {
        if (is_null($term_url)) {
            throw new InvalidArgumentException('non-nullable term_url cannot be null');
        }
        if ((mb_strlen($term_url) > 2048)) {
            throw new InvalidArgumentException('invalid length for $term_url when calling PaymentOrderResponse., must be smaller than or equal to 2048.');
        }
        if ((mb_strlen($term_url) < 1)) {
            throw new InvalidArgumentException('invalid length for $term_url when calling PaymentOrderResponse., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^https?:\/\/(.*)$/", ObjectSerializer::toString($term_url)))) {
            throw new InvalidArgumentException("invalid value for \$term_url when calling PaymentOrderResponse., must conform to the pattern /^https?:\/\/(.*)$/.");
        }
    ...
    public function setAcsUrl(?string $acs_url): static
    {
        ...
        if ((mb_strlen($acs_url) > 2048)) {
            throw new InvalidArgumentException('invalid length for $acs_url when calling PaymentOrderResponse., must be smaller than or equal to 2048.');
        }
        if ((mb_strlen($acs_url) < 1)) {
            throw new InvalidArgumentException('invalid length for $acs_url when calling PaymentOrderResponse., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($acs_url)))) {
            throw new InvalidArgumentException("invalid value for \$acs_url when calling PaymentOrderResponse., must conform to the pattern /^[ -~]*$/.");
        }
     ...
     * @return $this
     */
    public function setPaReq(?string $pa_req): static
    {
        if (is_null($pa_req)) {
            throw new InvalidArgumentException('non-nullable pa_req cannot be null');
        }
        if ((mb_strlen($pa_req) > 2048)) {
            throw new InvalidArgumentException('invalid length for $pa_req when calling PaymentOrderResponse., must be smaller than or equal to 2048.');
        }
        if ((mb_strlen($pa_req) < 1)) {
            throw new InvalidArgumentException('invalid length for $pa_req when calling PaymentOrderResponse., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($pa_req)))) {
            throw new InvalidArgumentException("invalid value for \$pa_req when calling PaymentOrderResponse., must conform to the pattern /^[ -~]*$/.");
        }
     ...
     * @return $this
     */
    public function setCReq(?string $c_req): static
    {
        if (is_null($c_req)) {
            throw new InvalidArgumentException('non-nullable c_req cannot be null');
        }
        if ((mb_strlen($c_req) > 4096)) {
            throw new InvalidArgumentException('invalid length for $c_req when calling PaymentOrderResponse., must be smaller than or equal to 4096.');
        }
        if ((mb_strlen($c_req) < 1)) {
            throw new InvalidArgumentException('invalid length for $c_req when calling PaymentOrderResponse., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($c_req)))) {
            throw new InvalidArgumentException("invalid value for \$c_req when calling PaymentOrderResponse., must conform to the pattern /^[ -~]*$/.");
        }
     ...
     * @return $this
     */
    public function setThreeDsMethodUrl(?string $three_ds_method_url): static
    {
        ...
        if ((mb_strlen($three_ds_method_url) > 2048)) {
            throw new InvalidArgumentException('invalid length for $three_ds_method_url when calling PaymentOrderResponse., must be smaller than or equal to 2048.');
        }
        if ((mb_strlen($three_ds_method_url) < 1)) {
            throw new InvalidArgumentException('invalid length for $three_ds_method_url when calling PaymentOrderResponse., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($three_ds_method_url)))) {
            throw new InvalidArgumentException("invalid value for \$three_ds_method_url when calling PaymentOrderResponse., must conform to the pattern /^[ -~]*$/.");
        }
     ...
     * @return $this
     */
    public function setThreeDsMethodNotificationUrl(?string $three_ds_method_notification_url): static
    {
        ...
        if ((mb_strlen($three_ds_method_notification_url) > 2048)) {
            throw new InvalidArgumentException('invalid length for $three_ds_method_notification_url when calling PaymentOrderResponse., must be smaller than or equal to 2048.');
        }
        if ((mb_strlen($three_ds_method_notification_url) < 1)) {
            throw new InvalidArgumentException('invalid length for $three_ds_method_notification_url when calling PaymentOrderResponse., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^https?:\/\/(.*)$/", ObjectSerializer::toString($three_ds_method_notification_url)))) {
            throw new InvalidArgumentException("invalid value for \$three_ds_method_notification_url when calling PaymentOrderResponse., must conform to the pattern /^https?:\/\/(.*)$/.");
        }
     ...
     * @return $this
     */
    public function setThreeDsServerTransId(?string $three_ds_server_trans_id): static
    {
        ...
        if ((mb_strlen($three_ds_server_trans_id) > 36)) {
            throw new InvalidArgumentException('invalid length for $three_ds_server_trans_id when calling PaymentOrderResponse., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($three_ds_server_trans_id) < 1)) {
            throw new InvalidArgumentException('invalid length for $three_ds_server_trans_id when calling PaymentOrderResponse., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($three_ds_server_trans_id)))) {
            throw new InvalidArgumentException("invalid value for \$three_ds_server_trans_id when calling PaymentOrderResponse., must conform to the pattern /^[ -~]*$/.");
        }
     ...
     * @return $this
     */
    public function setThreeDsMethodData(?string $three_ds_method_data): static
    {
        ...
        if ((mb_strlen($three_ds_method_data) > 4096)) {
            throw new InvalidArgumentException('invalid length for $three_ds_method_data when calling PaymentOrderResponse., must be smaller than or equal to 4096.');
        }
        if ((mb_strlen($three_ds_method_data) < 1)) {
            throw new InvalidArgumentException('invalid length for $three_ds_method_data when calling PaymentOrderResponse., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($three_ds_method_data)))) {
            throw new InvalidArgumentException("invalid value for \$three_ds_method_data when calling PaymentOrderResponse., must conform to the pattern /^[ -~]*$/.");
        }
     ...
     * @return $this
     */
    public function setFormUrl(?string $form_url): static
    {
        if (is_null($form_url)) {
            throw new InvalidArgumentException('non-nullable form_url cannot be null');
        }
        if ((mb_strlen($form_url) > 2048)) {
            throw new InvalidArgumentException('invalid length for $form_url when calling PaymentOrderResponse., must be smaller than or equal to 2048.');
        }
        if ((mb_strlen($form_url) < 1)) {
            throw new InvalidArgumentException('invalid length for $form_url when calling PaymentOrderResponse., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($form_url)))) {
            throw new InvalidArgumentException("invalid value for \$form_url when calling PaymentOrderResponse., must conform to the pattern /^[ -~]*$/.");
        }
     ...
     * @return $this
     */
    public function setAcsRenderingType(?string $acs_rendering_type): static
    {
        ...
        if ((mb_strlen($acs_rendering_type) > 256)) {
            throw new InvalidArgumentException('invalid length for $acs_rendering_type when calling PaymentOrderResponse., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($acs_rendering_type) < 1)) {
            throw new InvalidArgumentException('invalid length for $acs_rendering_type when calling PaymentOrderResponse., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($acs_rendering_type)))) {
            throw new InvalidArgumentException("invalid value for \$acs_rendering_type when calling PaymentOrderResponse., must conform to the pattern /^[ -~]*$/.");
        }
     ...
     * @return $this
     */
    public function setAcsSignedContent(?string $acs_signed_content): static
    {
        ...
        if ((mb_strlen($acs_signed_content) > 64000)) {
            throw new InvalidArgumentException('invalid length for $acs_signed_content when calling PaymentOrderResponse., must be smaller than or equal to 64000.');
        }
        if ((mb_strlen($acs_signed_content) < 1)) {
            throw new InvalidArgumentException('invalid length for $acs_signed_content when calling PaymentOrderResponse., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($acs_signed_content)))) {
            throw new InvalidArgumentException("invalid value for \$acs_signed_content when calling PaymentOrderResponse., must conform to the pattern /^[ -~]*$/.");
        }
     ...
     *
     * @return \SberPay\Model\AcsDecoupleIndicator|null
     */
    public function getAcsDecoupleIndicator(): ?\SberPay\Model\AcsDecoupleIndicator
    {
     ...
     *
     * @param \SberPay\Model\AcsDecoupleIndicator|null $acs_decouple_indicator acs_decouple_indicator
     *
     * @return $this
     */
    public function setAcsDecoupleIndicator(?\SberPay\Model\AcsDecoupleIndicator $acs_decouple_indicator): static
    {
