<?php
/**
 * CartItemsItemsInnerAgentInterest
 *
 * PHP version 8.1
 *
 * @package  SberPay
...
/**
 * CartItemsItemsInnerAgentInterest Class Doc Comment
 *
 ...
 */
class CartItemsItemsInnerAgentInterest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'cartItems_items_inner_agentInterest';
    ...
    protected static array $setters = [
        ...
        'interest_value' => 'setInterestValue'
    ];
    ...
    protected static array $getters = [
        ...
        'interest_value' => 'getInterestValue'
    ];
    ...
    {
        $this->setIfExists('interest_type', $data ?? [], null);
        $this->setIfExists('interest_value', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ((mb_strlen($this->container['interest_type']) > 20)) {
            $invalidProperties[] = "invalid value for 'interest_type', the character length must be smaller than or equal to 20.";
        }

        if ((mb_strlen($this->container['interest_type']) < 1)) {
            $invalidProperties[] = "invalid value for 'interest_type', the character length must be bigger than or equal to 1.";
        }

        if (!preg_match("/^[ -~А-Яа-яЁё№]*$/", $this->container['interest_type'])) {
            $invalidProperties[] = "invalid value for 'interest_type', must be conform to the pattern /^[ -~А-Яа-яЁё№]*$/.";
        }

        if ($this->container['interest_value'] === null) {
            $invalidProperties[] = "'interest_value' can't be null";
        }
        if ((mb_strlen($this->container['interest_value']) > 20)) {
            $invalidProperties[] = "invalid value for 'interest_value', the character length must be smaller than or equal to 20.";
        }

        if ((mb_strlen($this->container['interest_value']) < 1)) {
            $invalidProperties[] = "invalid value for 'interest_value', the character length must be bigger than or equal to 1.";
        }

        if (!preg_match("/^\\d+$/", $this->container['interest_value'])) {
            $invalidProperties[] = "invalid value for 'interest_value', must be conform to the pattern /^\\d+$/.";
        }
     ...
     * Sets interest_type
     *
     * @param string $interest_type Тип агентской комиссии за продажу товара
     *
     * @return $this
     */
    public function setInterestType(string $interest_type): static
    {
        if (is_null($interest_type)) {
            throw new InvalidArgumentException('non-nullable interest_type cannot be null');
        }
        if ((mb_strlen($interest_type) > 20)) {
            throw new InvalidArgumentException('invalid length for $interest_type when calling CartItemsItemsInnerAgentInterest., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($interest_type) < 1)) {
            throw new InvalidArgumentException('invalid length for $interest_type when calling CartItemsItemsInnerAgentInterest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($interest_type)))) {
            throw new InvalidArgumentException("invalid value for \$interest_type when calling CartItemsItemsInnerAgentInterest., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    {
        return $this->container['interest_value'];
    }

    /**
     * Sets interest_value
     *
     * @param string $interest_value Значение агентской комиссии за продажу товара
     *
     * @return $this
     */
    public function setInterestValue(string $interest_value): static
    {
        if (is_null($interest_value)) {
            throw new InvalidArgumentException('non-nullable interest_value cannot be null');
        }
        if ((mb_strlen($interest_value) > 20)) {
            throw new InvalidArgumentException('invalid length for $interest_value when calling CartItemsItemsInnerAgentInterest., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($interest_value) < 1)) {
            throw new InvalidArgumentException('invalid length for $interest_value when calling CartItemsItemsInnerAgentInterest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($interest_value)))) {
            throw new InvalidArgumentException("invalid value for \$interest_value when calling CartItemsItemsInnerAgentInterest., must conform to the pattern /^\\d+$/.");
        }

        $this->container['interest_value'] = $interest_value;
