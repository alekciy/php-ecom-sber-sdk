...
/**
 * ReverseRequest Class Doc Comment
 *
 * @package  SberPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ReverseRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'reverseRequest';
    ...
    */
    ...
    public function setUserName(string $user_name): static
    {
        ...
        if ((mb_strlen($user_name) > 30)) {
            throw new InvalidArgumentException('invalid length for $user_name when calling ReverseRequest., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($user_name) < 1)) {
            throw new InvalidArgumentException('invalid length for $user_name when calling ReverseRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[A-Za-z0-9-_ ]+$/", ObjectSerializer::toString($user_name)))) {
            throw new InvalidArgumentException("invalid value for \$user_name when calling ReverseRequest., must conform to the pattern /^[A-Za-z0-9-_ ]+$/.");
        }
    ...
    public function setPassword(string $password): static
    {
        ...
        if ((mb_strlen($password) > 30)) {
            throw new InvalidArgumentException('invalid length for $password when calling ReverseRequest., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($password) < 1)) {
            throw new InvalidArgumentException('invalid length for $password when calling ReverseRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]+$/", ObjectSerializer::toString($password)))) {
            throw new InvalidArgumentException("invalid value for \$password when calling ReverseRequest., must conform to the pattern /^[ -~]+$/.");
        }
    ...
    public function setOrderId(string $order_id): static
    {
        ...
        if ((mb_strlen($order_id) > 36)) {
            throw new InvalidArgumentException('invalid length for $order_id when calling ReverseRequest., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($order_id) < 36)) {
            throw new InvalidArgumentException('invalid length for $order_id when calling ReverseRequest., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/^[a-f0-9\\-]+$/", ObjectSerializer::toString($order_id)))) {
            throw new InvalidArgumentException("invalid value for \$order_id when calling ReverseRequest., must conform to the pattern /^[a-f0-9\\-]+$/.");
        }
    ...
    public function setAmount(?int $amount): static
    {
        ...
        if (($amount > 999999999999)) {
            throw new InvalidArgumentException('invalid value for $amount when calling ReverseRequest., must be smaller than or equal to 999999999999.');
        }
        if (($amount < 0)) {
            throw new InvalidArgumentException('invalid value for $amount when calling ReverseRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setLanguage(?string $language): static
    {
        ...
        if ((mb_strlen($language) > 2)) {
            throw new InvalidArgumentException('invalid length for $language when calling ReverseRequest., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($language) < 2)) {
            throw new InvalidArgumentException('invalid length for $language when calling ReverseRequest., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^[a-z]+$/", ObjectSerializer::toString($language)))) {
            throw new InvalidArgumentException("invalid value for \$language when calling ReverseRequest., must conform to the pattern /^[a-z]+$/.");
        }
