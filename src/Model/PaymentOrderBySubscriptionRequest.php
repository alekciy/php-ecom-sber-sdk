...
/**
 * PaymentOrderBySubscriptionRequest Class Doc Comment
 *
 * @package  SberPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PaymentOrderBySubscriptionRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'paymentOrderBySubscriptionRequest';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ((mb_strlen($this->container['subscription_id']) > 32)) {
        ...
        if (!preg_match("/^[a-f0-9]+$/", $this->container['subscription_id'])) {
        ...
        if ((mb_strlen($this->container['member_id']) > 12)) {
        ...
        if (!preg_match("/^\\d{12}$/", $this->container['member_id'])) {
    ...
    public function setUserName(string $user_name): static
    {
        ...
        if ((mb_strlen($user_name) > 30)) {
            throw new InvalidArgumentException('invalid length for $user_name when calling PaymentOrderBySubscriptionRequest., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($user_name) < 1)) {
            throw new InvalidArgumentException('invalid length for $user_name when calling PaymentOrderBySubscriptionRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[A-Za-z0-9-_ ]+$/", ObjectSerializer::toString($user_name)))) {
            throw new InvalidArgumentException("invalid value for \$user_name when calling PaymentOrderBySubscriptionRequest., must conform to the pattern /^[A-Za-z0-9-_ ]+$/.");
        }
    ...
    public function setPassword(string $password): static
    {
        ...
        if ((mb_strlen($password) > 30)) {
            throw new InvalidArgumentException('invalid length for $password when calling PaymentOrderBySubscriptionRequest., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($password) < 1)) {
            throw new InvalidArgumentException('invalid length for $password when calling PaymentOrderBySubscriptionRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]+$/", ObjectSerializer::toString($password)))) {
            throw new InvalidArgumentException("invalid value for \$password when calling PaymentOrderBySubscriptionRequest., must conform to the pattern /^[ -~]+$/.");
        }
    ...
    public function setOrderId(string $order_id): static
    {
        ...
        if ((mb_strlen($order_id) > 36)) {
            throw new InvalidArgumentException('invalid length for $order_id when calling PaymentOrderBySubscriptionRequest., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($order_id) < 36)) {
            throw new InvalidArgumentException('invalid length for $order_id when calling PaymentOrderBySubscriptionRequest., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/^[a-f0-9\\-]+$/", ObjectSerializer::toString($order_id)))) {
            throw new InvalidArgumentException("invalid value for \$order_id when calling PaymentOrderBySubscriptionRequest., must conform to the pattern /^[a-f0-9\\-]+$/.");
        }
     ...
     *
     * @param string $subscription_id Идентификатор сохраненной подписки.
     *
     * @return $this
     */
    public function setSubscriptionId(string $subscription_id): static
    {
        ...
        if ((mb_strlen($subscription_id) > 32)) {
            throw new InvalidArgumentException('invalid length for $subscription_id when calling PaymentOrderBySubscriptionRequest., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($subscription_id) < 32)) {
            throw new InvalidArgumentException('invalid length for $subscription_id when calling PaymentOrderBySubscriptionRequest., must be bigger than or equal to 32.');
        }
        if ((!preg_match("/^[a-f0-9]+$/", ObjectSerializer::toString($subscription_id)))) {
            throw new InvalidArgumentException("invalid value for \$subscription_id when calling PaymentOrderBySubscriptionRequest., must conform to the pattern /^[a-f0-9]+$/.");
        }
     ...
     * Sets member_id
     *
     * @param string $member_id Идентификатор банка отправителя
     *
     * @return $this
     */
    public function setMemberId(string $member_id): static
    {
        ...
        if ((mb_strlen($member_id) > 12)) {
            throw new InvalidArgumentException('invalid length for $member_id when calling PaymentOrderBySubscriptionRequest., must be smaller than or equal to 12.');
        }
        if ((mb_strlen($member_id) < 12)) {
            throw new InvalidArgumentException('invalid length for $member_id when calling PaymentOrderBySubscriptionRequest., must be bigger than or equal to 12.');
        }
        if ((!preg_match("/^\\d{12}$/", ObjectSerializer::toString($member_id)))) {
            throw new InvalidArgumentException("invalid value for \$member_id when calling PaymentOrderBySubscriptionRequest., must conform to the pattern /^\\d{12}$/.");
        }
