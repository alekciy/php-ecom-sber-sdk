...
/**
 * RecurrentPaymentResponseError Class Doc Comment
 *
 ...
 */
class RecurrentPaymentResponseError implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'recurrentPaymentResponse_error';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!preg_match("/^\\d{1,3}$/", $this->container['code'])) {
            $invalidProperties[] = "invalid value for 'code', must be conform to the pattern /^\\d{1,3}$/.";
        }
    ...
    public function setCode(string $code): static
    {
        ...
        if ((mb_strlen($code) > 3)) {
            throw new InvalidArgumentException('invalid length for $code when calling RecurrentPaymentResponseError., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($code) < 1)) {
            throw new InvalidArgumentException('invalid length for $code when calling RecurrentPaymentResponseError., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d{1,3}$/", ObjectSerializer::toString($code)))) {
            throw new InvalidArgumentException("invalid value for \$code when calling RecurrentPaymentResponseError., must conform to the pattern /^\\d{1,3}$/.");
        }
     ...
     * Sets description
     *
     * @param string|null $description Описание ошибки на языке, переданном в параметре language в запросе
     *
     * @return $this
     */
    public function setDescription(?string $description): static
    {
        ...
        if ((mb_strlen($description) > 512)) {
            throw new InvalidArgumentException('invalid length for $description when calling RecurrentPaymentResponseError., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($description) < 0)) {
            throw new InvalidArgumentException('invalid length for $description when calling RecurrentPaymentResponseError., must be bigger than or equal to 0.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($description)))) {
            throw new InvalidArgumentException("invalid value for \$description when calling RecurrentPaymentResponseError., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
     ...
     * Sets message
     *
     * @param string|null $message Сообщение для отображения Плательщику
     *
     * @return $this
     */
    public function setMessage(?string $message): static
    {
        ...
        if ((mb_strlen($message) > 512)) {
            throw new InvalidArgumentException('invalid length for $message when calling RecurrentPaymentResponseError., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($message) < 0)) {
            throw new InvalidArgumentException('invalid length for $message when calling RecurrentPaymentResponseError., must be bigger than or equal to 0.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($message)))) {
            throw new InvalidArgumentException("invalid value for \$message when calling RecurrentPaymentResponseError., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
