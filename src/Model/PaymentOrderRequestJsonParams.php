...
/**
 * PaymentOrderRequestJsonParams Class Doc Comment
 *
 ...
 */
class PaymentOrderRequestJsonParams implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'paymentOrderRequest_jsonParams';
    ...
    */
    ...
    public function setHasValuableItems(?string $has_valuable_items): static
    {
        ...
        if ((mb_strlen($has_valuable_items) > 2)) {
            throw new InvalidArgumentException('invalid length for $has_valuable_items when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($has_valuable_items) < 2)) {
            throw new InvalidArgumentException('invalid length for $has_valuable_items when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($has_valuable_items)))) {
            throw new InvalidArgumentException("invalid value for \$has_valuable_items when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setAcctId(?string $acct_id): static
    {
        ...
        if ((mb_strlen($acct_id) > 64)) {
            throw new InvalidArgumentException('invalid length for $acct_id when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($acct_id) < 1)) {
            throw new InvalidArgumentException('invalid length for $acct_id when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($acct_id)))) {
            throw new InvalidArgumentException("invalid value for \$acct_id when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setChAccDate(?string $ch_acc_date): static
    {
        ...
        if ((mb_strlen($ch_acc_date) > 8)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_date when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($ch_acc_date) < 8)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_date when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ch_acc_date)))) {
            throw new InvalidArgumentException("invalid value for \$ch_acc_date when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setChAccAgeInd(?string $ch_acc_age_ind): static
    {
        ...
        if ((mb_strlen($ch_acc_age_ind) > 2)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_age_ind when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($ch_acc_age_ind) < 2)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_age_ind when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ch_acc_age_ind)))) {
            throw new InvalidArgumentException("invalid value for \$ch_acc_age_ind when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setChAccChangeInd(?string $ch_acc_change_ind): static
    {
        ...
        if ((mb_strlen($ch_acc_change_ind) > 2)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_change_ind when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($ch_acc_change_ind) < 2)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_change_ind when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ch_acc_change_ind)))) {
            throw new InvalidArgumentException("invalid value for \$ch_acc_change_ind when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setShipAddrCity(?string $ship_addr_city): static
    {
        ...
        if ((mb_strlen($ship_addr_city) > 50)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_city when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($ship_addr_city) < 1)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_city when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($ship_addr_city)))) {
            throw new InvalidArgumentException("invalid value for \$ship_addr_city when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setShipDeliveryPointId(?string $ship_delivery_point_id): static
    {
        ...
        if ((mb_strlen($ship_delivery_point_id) > 50)) {
            throw new InvalidArgumentException('invalid length for $ship_delivery_point_id when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($ship_delivery_point_id) < 1)) {
            throw new InvalidArgumentException('invalid length for $ship_delivery_point_id when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($ship_delivery_point_id)))) {
            throw new InvalidArgumentException("invalid value for \$ship_delivery_point_id when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setMriReorderItemsInd(?string $mri_reorder_items_ind): static
    {
        ...
        if ((mb_strlen($mri_reorder_items_ind) > 2)) {
            throw new InvalidArgumentException('invalid length for $mri_reorder_items_ind when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($mri_reorder_items_ind) < 2)) {
            throw new InvalidArgumentException('invalid length for $mri_reorder_items_ind when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($mri_reorder_items_ind)))) {
            throw new InvalidArgumentException("invalid value for \$mri_reorder_items_ind when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setMobilePhone(?string $mobile_phone): static
    {
        ...
        if ((mb_strlen($mobile_phone) > 19)) {
            throw new InvalidArgumentException('invalid length for $mobile_phone when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($mobile_phone) < 1)) {
            throw new InvalidArgumentException('invalid length for $mobile_phone when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[\\d\\-]*$/", ObjectSerializer::toString($mobile_phone)))) {
            throw new InvalidArgumentException("invalid value for \$mobile_phone when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[\\d\\-]*$/.");
        }
    ...
    public function setShipNameIndicator(?string $ship_name_indicator): static
    {
        ...
        if ((mb_strlen($ship_name_indicator) > 2)) {
            throw new InvalidArgumentException('invalid length for $ship_name_indicator when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($ship_name_indicator) < 2)) {
            throw new InvalidArgumentException('invalid length for $ship_name_indicator when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ship_name_indicator)))) {
            throw new InvalidArgumentException("invalid value for \$ship_name_indicator when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setSuspiciousAccActivity(?string $suspicious_acc_activity): static
    {
        ...
        if ((mb_strlen($suspicious_acc_activity) > 2)) {
            throw new InvalidArgumentException('invalid length for $suspicious_acc_activity when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($suspicious_acc_activity) < 2)) {
            throw new InvalidArgumentException('invalid length for $suspicious_acc_activity when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($suspicious_acc_activity)))) {
            throw new InvalidArgumentException("invalid value for \$suspicious_acc_activity when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setProvisionAttemptsDay(?string $provision_attempts_day): static
    {
        ...
        if ((mb_strlen($provision_attempts_day) > 4)) {
            throw new InvalidArgumentException('invalid length for $provision_attempts_day when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($provision_attempts_day) < 1)) {
            throw new InvalidArgumentException('invalid length for $provision_attempts_day when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($provision_attempts_day)))) {
            throw new InvalidArgumentException("invalid value for \$provision_attempts_day when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setShipAddrLine1(?string $ship_addr_line1): static
    {
        ...
        if ((mb_strlen($ship_addr_line1) > 50)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_line1 when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($ship_addr_line1) < 1)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_line1 when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($ship_addr_line1)))) {
            throw new InvalidArgumentException("invalid value for \$ship_addr_line1 when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setShipAddrLine2(?string $ship_addr_line2): static
    {
        ...
        if ((mb_strlen($ship_addr_line2) > 50)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_line2 when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($ship_addr_line2) < 1)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_line2 when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($ship_addr_line2)))) {
            throw new InvalidArgumentException("invalid value for \$ship_addr_line2 when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setShipAddrLine3(?string $ship_addr_line3): static
    {
        ...
        if ((mb_strlen($ship_addr_line3) > 50)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_line3 when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($ship_addr_line3) < 1)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_line3 when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($ship_addr_line3)))) {
            throw new InvalidArgumentException("invalid value for \$ship_addr_line3 when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setShipAddressUsage(?string $ship_address_usage): static
    {
        ...
        if ((mb_strlen($ship_address_usage) > 8)) {
            throw new InvalidArgumentException('invalid length for $ship_address_usage when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($ship_address_usage) < 8)) {
            throw new InvalidArgumentException('invalid length for $ship_address_usage when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ship_address_usage)))) {
            throw new InvalidArgumentException("invalid value for \$ship_address_usage when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setShipAddressUsageInd(?string $ship_address_usage_ind): static
    {
        ...
        if ((mb_strlen($ship_address_usage_ind) > 2)) {
            throw new InvalidArgumentException('invalid length for $ship_address_usage_ind when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($ship_address_usage_ind) < 2)) {
            throw new InvalidArgumentException('invalid length for $ship_address_usage_ind when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ship_address_usage_ind)))) {
            throw new InvalidArgumentException("invalid value for \$ship_address_usage_ind when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setMriDeliveryTimeframe(?string $mri_delivery_timeframe): static
    {
        ...
        if ((mb_strlen($mri_delivery_timeframe) > 2)) {
            throw new InvalidArgumentException('invalid length for $mri_delivery_timeframe when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($mri_delivery_timeframe) < 1)) {
            throw new InvalidArgumentException('invalid length for $mri_delivery_timeframe when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($mri_delivery_timeframe)))) {
            throw new InvalidArgumentException("invalid value for \$mri_delivery_timeframe when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setMriShipIndicator(?string $mri_ship_indicator): static
    {
        ...
        if ((mb_strlen($mri_ship_indicator) > 2)) {
            throw new InvalidArgumentException('invalid length for $mri_ship_indicator when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($mri_ship_indicator) < 2)) {
            throw new InvalidArgumentException('invalid length for $mri_ship_indicator when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($mri_ship_indicator)))) {
            throw new InvalidArgumentException("invalid value for \$mri_ship_indicator when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setChAccPwChange(?string $ch_acc_pw_change): static
    {
        ...
        if ((mb_strlen($ch_acc_pw_change) > 8)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_pw_change when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($ch_acc_pw_change) < 8)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_pw_change when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ch_acc_pw_change)))) {
            throw new InvalidArgumentException("invalid value for \$ch_acc_pw_change when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setChAccPwChangeInd(?string $ch_acc_pw_change_ind): static
    {
        ...
        if ((mb_strlen($ch_acc_pw_change_ind) > 2)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_pw_change_ind when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($ch_acc_pw_change_ind) < 2)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_pw_change_ind when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ch_acc_pw_change_ind)))) {
            throw new InvalidArgumentException("invalid value for \$ch_acc_pw_change_ind when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setNbPurchaseAccount(?string $nb_purchase_account): static
    {
        ...
        if ((mb_strlen($nb_purchase_account) > 4)) {
            throw new InvalidArgumentException('invalid length for $nb_purchase_account when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($nb_purchase_account) < 1)) {
            throw new InvalidArgumentException('invalid length for $nb_purchase_account when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($nb_purchase_account)))) {
            throw new InvalidArgumentException("invalid value for \$nb_purchase_account when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setTxnActivityDay(?string $txn_activity_day): static
    {
        ...
        if ((mb_strlen($txn_activity_day) > 3)) {
            throw new InvalidArgumentException('invalid length for $txn_activity_day when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($txn_activity_day) < 1)) {
            throw new InvalidArgumentException('invalid length for $txn_activity_day when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($txn_activity_day)))) {
            throw new InvalidArgumentException("invalid value for \$txn_activity_day when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setTxnActivityYear(?string $txn_activity_year): static
    {
        ...
        if ((mb_strlen($txn_activity_year) > 3)) {
            throw new InvalidArgumentException('invalid length for $txn_activity_year when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($txn_activity_year) < 1)) {
            throw new InvalidArgumentException('invalid length for $txn_activity_year when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($txn_activity_year)))) {
            throw new InvalidArgumentException("invalid value for \$txn_activity_year when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setPaymentAccAge(?string $payment_acc_age): static
    {
        ...
        if ((mb_strlen($payment_acc_age) > 8)) {
            throw new InvalidArgumentException('invalid length for $payment_acc_age when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($payment_acc_age) < 8)) {
            throw new InvalidArgumentException('invalid length for $payment_acc_age when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($payment_acc_age)))) {
            throw new InvalidArgumentException("invalid value for \$payment_acc_age when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setPaymentAccInd(?string $payment_acc_ind): static
    {
        ...
        if ((mb_strlen($payment_acc_ind) > 2)) {
            throw new InvalidArgumentException('invalid length for $payment_acc_ind when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($payment_acc_ind) < 2)) {
            throw new InvalidArgumentException('invalid length for $payment_acc_ind when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($payment_acc_ind)))) {
            throw new InvalidArgumentException("invalid value for \$payment_acc_ind when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setChAccChange(?string $ch_acc_change): static
    {
        ...
        if ((mb_strlen($ch_acc_change) > 8)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_change when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($ch_acc_change) < 8)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_change when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ch_acc_change)))) {
            throw new InvalidArgumentException("invalid value for \$ch_acc_change when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
     ...
     * @return string|null
     */
    public function getDataEntryMode(): ?string
    {
     ...
     * @return $this
     */
    public function setDataEntryMode(?string $data_entry_mode): static
    {
        ...
        if ((mb_strlen($data_entry_mode) > 20)) {
            throw new InvalidArgumentException('invalid length for $data_entry_mode when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($data_entry_mode) < 1)) {
            throw new InvalidArgumentException('invalid length for $data_entry_mode when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]+$/", ObjectSerializer::toString($data_entry_mode)))) {
            throw new InvalidArgumentException("invalid value for \$data_entry_mode when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~]+$/.");
        }
     ...
     * @return $this
     */
    public function setInitialOrderId(?string $initial_order_id): static
    {
        ...
        if ((mb_strlen($initial_order_id) > 36)) {
            throw new InvalidArgumentException('invalid length for $initial_order_id when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($initial_order_id) < 36)) {
            throw new InvalidArgumentException('invalid length for $initial_order_id when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/^[a-f0-9\\-]+$/", ObjectSerializer::toString($initial_order_id)))) {
            throw new InvalidArgumentException("invalid value for \$initial_order_id when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[a-f0-9\\-]+$/.");
        }
    ...
    public function setDestWalletNum(?string $dest_wallet_num): static
    {
        ...
        if ((mb_strlen($dest_wallet_num) > 30)) {
            throw new InvalidArgumentException('invalid length for $dest_wallet_num when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($dest_wallet_num) < 1)) {
            throw new InvalidArgumentException('invalid length for $dest_wallet_num when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($dest_wallet_num)))) {
            throw new InvalidArgumentException("invalid value for \$dest_wallet_num when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setDestPhoneNum(?string $dest_phone_num): static
    {
        ...
        if ((mb_strlen($dest_phone_num) > 30)) {
            throw new InvalidArgumentException('invalid length for $dest_phone_num when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($dest_phone_num) < 1)) {
            throw new InvalidArgumentException('invalid length for $dest_phone_num when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^(\\+?)\\d{7,15}$/", ObjectSerializer::toString($dest_phone_num)))) {
            throw new InvalidArgumentException("invalid value for \$dest_phone_num when calling PaymentOrderRequestJsonParams., must conform to the pattern /^(\\+?)\\d{7,15}$/.");
        }
    ...
    public function setDestCardNum(?string $dest_card_num): static
    {
        ...
        if ((mb_strlen($dest_card_num) > 19)) {
            throw new InvalidArgumentException('invalid length for $dest_card_num when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($dest_card_num) < 13)) {
            throw new InvalidArgumentException('invalid length for $dest_card_num when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 13.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($dest_card_num)))) {
            throw new InvalidArgumentException("invalid value for \$dest_card_num when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setDestAcctNum(?string $dest_acct_num): static
    {
        ...
        if ((mb_strlen($dest_acct_num) > 29)) {
            throw new InvalidArgumentException('invalid length for $dest_acct_num when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 29.');
        }
        if ((mb_strlen($dest_acct_num) < 1)) {
            throw new InvalidArgumentException('invalid length for $dest_acct_num when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($dest_acct_num)))) {
            throw new InvalidArgumentException("invalid value for \$dest_acct_num when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setThreeDsRequestorDecMaxTime(?string $three_ds_requestor_dec_max_time): static
    {
        ...
        if ((mb_strlen($three_ds_requestor_dec_max_time) > 5)) {
            throw new InvalidArgumentException('invalid length for $three_ds_requestor_dec_max_time when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($three_ds_requestor_dec_max_time) < 1)) {
            throw new InvalidArgumentException('invalid length for $three_ds_requestor_dec_max_time when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($three_ds_requestor_dec_max_time)))) {
            throw new InvalidArgumentException("invalid value for \$three_ds_requestor_dec_max_time when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setChallengeWindowSize(?string $challenge_window_size): static
    {
        ...
        if ((mb_strlen($challenge_window_size) > 2)) {
            throw new InvalidArgumentException('invalid length for $challenge_window_size when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($challenge_window_size) < 2)) {
            throw new InvalidArgumentException('invalid length for $challenge_window_size when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($challenge_window_size)))) {
            throw new InvalidArgumentException("invalid value for \$challenge_window_size when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setBrowserAcceptHeader(string $browser_accept_header): static
    {
        ...
        if ((mb_strlen($browser_accept_header) > 2048)) {
            throw new InvalidArgumentException('invalid length for $browser_accept_header when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 2048.');
        }
        if ((mb_strlen($browser_accept_header) < 1)) {
            throw new InvalidArgumentException('invalid length for $browser_accept_header when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($browser_accept_header)))) {
            throw new InvalidArgumentException("invalid value for \$browser_accept_header when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setBrowserIp(string $browser_ip): static
    {
        ...
        if ((mb_strlen($browser_ip) > 45)) {
            throw new InvalidArgumentException('invalid length for $browser_ip when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 45.');
        }
        if ((mb_strlen($browser_ip) < 1)) {
            throw new InvalidArgumentException('invalid length for $browser_ip when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($browser_ip)))) {
            throw new InvalidArgumentException("invalid value for \$browser_ip when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setBrowserLanguage(?string $browser_language): static
    {
        ...
        if ((mb_strlen($browser_language) > 8)) {
            throw new InvalidArgumentException('invalid length for $browser_language when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($browser_language) < 1)) {
            throw new InvalidArgumentException('invalid length for $browser_language when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($browser_language)))) {
            throw new InvalidArgumentException("invalid value for \$browser_language when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setBrowserScreenHeight(?string $browser_screen_height): static
    {
        ...
        if ((mb_strlen($browser_screen_height) > 6)) {
            throw new InvalidArgumentException('invalid length for $browser_screen_height when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($browser_screen_height) < 1)) {
            throw new InvalidArgumentException('invalid length for $browser_screen_height when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($browser_screen_height)))) {
            throw new InvalidArgumentException("invalid value for \$browser_screen_height when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setBrowserScreenWidth(?string $browser_screen_width): static
    {
        ...
        if ((mb_strlen($browser_screen_width) > 6)) {
            throw new InvalidArgumentException('invalid length for $browser_screen_width when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($browser_screen_width) < 1)) {
            throw new InvalidArgumentException('invalid length for $browser_screen_width when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($browser_screen_width)))) {
            throw new InvalidArgumentException("invalid value for \$browser_screen_width when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setBrowserTz(?string $browser_tz): static
    {
        ...
        if ((mb_strlen($browser_tz) > 5)) {
            throw new InvalidArgumentException('invalid length for $browser_tz when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($browser_tz) < 1)) {
            throw new InvalidArgumentException('invalid length for $browser_tz when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($browser_tz)))) {
            throw new InvalidArgumentException("invalid value for \$browser_tz when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setBrowserUserAgent(string $browser_user_agent): static
    {
        ...
        if ((mb_strlen($browser_user_agent) > 2048)) {
            throw new InvalidArgumentException('invalid length for $browser_user_agent when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 2048.');
        }
        if ((mb_strlen($browser_user_agent) < 1)) {
            throw new InvalidArgumentException('invalid length for $browser_user_agent when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($browser_user_agent)))) {
            throw new InvalidArgumentException("invalid value for \$browser_user_agent when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setBillAddrCity(?string $bill_addr_city): static
    {
        ...
        if ((mb_strlen($bill_addr_city) > 50)) {
            throw new InvalidArgumentException('invalid length for $bill_addr_city when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($bill_addr_city) < 1)) {
            throw new InvalidArgumentException('invalid length for $bill_addr_city when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($bill_addr_city)))) {
            throw new InvalidArgumentException("invalid value for \$bill_addr_city when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setBillAddrCountry(?string $bill_addr_country): static
    {
        ...
        if ((mb_strlen($bill_addr_country) > 3)) {
            throw new InvalidArgumentException('invalid length for $bill_addr_country when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($bill_addr_country) < 1)) {
            throw new InvalidArgumentException('invalid length for $bill_addr_country when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($bill_addr_country)))) {
            throw new InvalidArgumentException("invalid value for \$bill_addr_country when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setBillAddrLine1(?string $bill_addr_line1): static
    {
        ...
        if ((mb_strlen($bill_addr_line1) > 50)) {
            throw new InvalidArgumentException('invalid length for $bill_addr_line1 when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($bill_addr_line1) < 1)) {
            throw new InvalidArgumentException('invalid length for $bill_addr_line1 when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($bill_addr_line1)))) {
            throw new InvalidArgumentException("invalid value for \$bill_addr_line1 when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setBillAddrLine2(?string $bill_addr_line2): static
    {
        ...
        if ((mb_strlen($bill_addr_line2) > 50)) {
            throw new InvalidArgumentException('invalid length for $bill_addr_line2 when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($bill_addr_line2) < 1)) {
            throw new InvalidArgumentException('invalid length for $bill_addr_line2 when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($bill_addr_line2)))) {
            throw new InvalidArgumentException("invalid value for \$bill_addr_line2 when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setBillAddrLine3(?string $bill_addr_line3): static
    {
        ...
        if ((mb_strlen($bill_addr_line3) > 50)) {
            throw new InvalidArgumentException('invalid length for $bill_addr_line3 when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($bill_addr_line3) < 1)) {
            throw new InvalidArgumentException('invalid length for $bill_addr_line3 when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($bill_addr_line3)))) {
            throw new InvalidArgumentException("invalid value for \$bill_addr_line3 when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setBillAddrPostCode(?string $bill_addr_post_code): static
    {
        ...
        if ((mb_strlen($bill_addr_post_code) > 16)) {
            throw new InvalidArgumentException('invalid length for $bill_addr_post_code when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($bill_addr_post_code) < 1)) {
            throw new InvalidArgumentException('invalid length for $bill_addr_post_code when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($bill_addr_post_code)))) {
            throw new InvalidArgumentException("invalid value for \$bill_addr_post_code when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setBillAddrState(?string $bill_addr_state): static
    {
        ...
        if ((mb_strlen($bill_addr_state) > 3)) {
            throw new InvalidArgumentException('invalid length for $bill_addr_state when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($bill_addr_state) < 1)) {
            throw new InvalidArgumentException('invalid length for $bill_addr_state when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($bill_addr_state)))) {
            throw new InvalidArgumentException("invalid value for \$bill_addr_state when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setShipAddrCountry(?string $ship_addr_country): static
    {
        ...
        if ((mb_strlen($ship_addr_country) > 3)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_country when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($ship_addr_country) < 1)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_country when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ship_addr_country)))) {
            throw new InvalidArgumentException("invalid value for \$ship_addr_country when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setShipAddrPostCode(?string $ship_addr_post_code): static
    {
        ...
        if ((mb_strlen($ship_addr_post_code) > 16)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_post_code when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($ship_addr_post_code) < 1)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_post_code when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($ship_addr_post_code)))) {
            throw new InvalidArgumentException("invalid value for \$ship_addr_post_code when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setShipAddrState(?string $ship_addr_state): static
    {
        ...
        if ((mb_strlen($ship_addr_state) > 3)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_state when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($ship_addr_state) < 1)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_state when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($ship_addr_state)))) {
            throw new InvalidArgumentException("invalid value for \$ship_addr_state when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setWorkPhone(?string $work_phone): static
    {
        ...
        if ((mb_strlen($work_phone) > 19)) {
            throw new InvalidArgumentException('invalid length for $work_phone when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($work_phone) < 1)) {
            throw new InvalidArgumentException('invalid length for $work_phone when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[\\d\\-]*$/", ObjectSerializer::toString($work_phone)))) {
            throw new InvalidArgumentException("invalid value for \$work_phone when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[\\d\\-]*$/.");
        }
    ...
    public function setHomePhone(?string $home_phone): static
    {
        ...
        if ((mb_strlen($home_phone) > 19)) {
            throw new InvalidArgumentException('invalid length for $home_phone when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($home_phone) < 1)) {
            throw new InvalidArgumentException('invalid length for $home_phone when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[\\d\\-]*$/", ObjectSerializer::toString($home_phone)))) {
            throw new InvalidArgumentException("invalid value for \$home_phone when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[\\d\\-]*$/.");
        }
    ...
    public function setMriDeliveryEmailAddress(?string $mri_delivery_email_address): static
    {
        ...
        if ((mb_strlen($mri_delivery_email_address) > 254)) {
            throw new InvalidArgumentException('invalid length for $mri_delivery_email_address when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 254.');
        }
        if ((mb_strlen($mri_delivery_email_address) < 1)) {
            throw new InvalidArgumentException('invalid length for $mri_delivery_email_address when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($mri_delivery_email_address)))) {
            throw new InvalidArgumentException("invalid value for \$mri_delivery_email_address when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setMriGiftCardAmount(?string $mri_gift_card_amount): static
    {
        ...
        if ((mb_strlen($mri_gift_card_amount) > 2)) {
            throw new InvalidArgumentException('invalid length for $mri_gift_card_amount when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($mri_gift_card_amount) < 1)) {
            throw new InvalidArgumentException('invalid length for $mri_gift_card_amount when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($mri_gift_card_amount)))) {
            throw new InvalidArgumentException("invalid value for \$mri_gift_card_amount when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setMriGiftCardCount(?string $mri_gift_card_count): static
    {
        ...
        if ((mb_strlen($mri_gift_card_count) > 2)) {
            throw new InvalidArgumentException('invalid length for $mri_gift_card_count when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($mri_gift_card_count) < 1)) {
            throw new InvalidArgumentException('invalid length for $mri_gift_card_count when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($mri_gift_card_count)))) {
            throw new InvalidArgumentException("invalid value for \$mri_gift_card_count when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setMriGiftCardCurr(?string $mri_gift_card_curr): static
    {
        ...
        if ((mb_strlen($mri_gift_card_curr) > 3)) {
            throw new InvalidArgumentException('invalid length for $mri_gift_card_curr when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($mri_gift_card_curr) < 1)) {
            throw new InvalidArgumentException('invalid length for $mri_gift_card_curr when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($mri_gift_card_curr)))) {
            throw new InvalidArgumentException("invalid value for \$mri_gift_card_curr when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setMriPreOrderDate(?string $mri_pre_order_date): static
    {
        ...
        if ((mb_strlen($mri_pre_order_date) > 8)) {
            throw new InvalidArgumentException('invalid length for $mri_pre_order_date when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($mri_pre_order_date) < 8)) {
            throw new InvalidArgumentException('invalid length for $mri_pre_order_date when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($mri_pre_order_date)))) {
            throw new InvalidArgumentException("invalid value for \$mri_pre_order_date when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setMriPreOrderPurchaseInd(?string $mri_pre_order_purchase_ind): static
    {
        ...
        if ((mb_strlen($mri_pre_order_purchase_ind) > 2)) {
            throw new InvalidArgumentException('invalid length for $mri_pre_order_purchase_ind when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($mri_pre_order_purchase_ind) < 2)) {
            throw new InvalidArgumentException('invalid length for $mri_pre_order_purchase_ind when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($mri_pre_order_purchase_ind)))) {
            throw new InvalidArgumentException("invalid value for \$mri_pre_order_purchase_ind when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setThreeDsReqPriorAuthData(?string $three_ds_req_prior_auth_data): static
    {
        ...
        if ((mb_strlen($three_ds_req_prior_auth_data) > 2048)) {
            throw new InvalidArgumentException('invalid length for $three_ds_req_prior_auth_data when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 2048.');
        }
        if ((mb_strlen($three_ds_req_prior_auth_data) < 1)) {
            throw new InvalidArgumentException('invalid length for $three_ds_req_prior_auth_data when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($three_ds_req_prior_auth_data)))) {
            throw new InvalidArgumentException("invalid value for \$three_ds_req_prior_auth_data when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setThreeDsReqPriorAuthMethod(?string $three_ds_req_prior_auth_method): static
    {
        ...
        if ((mb_strlen($three_ds_req_prior_auth_method) > 2)) {
            throw new InvalidArgumentException('invalid length for $three_ds_req_prior_auth_method when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($three_ds_req_prior_auth_method) < 2)) {
            throw new InvalidArgumentException('invalid length for $three_ds_req_prior_auth_method when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($three_ds_req_prior_auth_method)))) {
            throw new InvalidArgumentException("invalid value for \$three_ds_req_prior_auth_method when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setThreeDsReqPriorAuthTimestamp(?string $three_ds_req_prior_auth_timestamp): static
    {
        ...
        if ((mb_strlen($three_ds_req_prior_auth_timestamp) > 12)) {
            throw new InvalidArgumentException('invalid length for $three_ds_req_prior_auth_timestamp when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 12.');
        }
        if ((mb_strlen($three_ds_req_prior_auth_timestamp) < 12)) {
            throw new InvalidArgumentException('invalid length for $three_ds_req_prior_auth_timestamp when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 12.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($three_ds_req_prior_auth_timestamp)))) {
            throw new InvalidArgumentException("invalid value for \$three_ds_req_prior_auth_timestamp when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setThreeDsReqPriorRef(?string $three_ds_req_prior_ref): static
    {
        ...
        if ((mb_strlen($three_ds_req_prior_ref) > 36)) {
            throw new InvalidArgumentException('invalid length for $three_ds_req_prior_ref when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($three_ds_req_prior_ref) < 36)) {
            throw new InvalidArgumentException('invalid length for $three_ds_req_prior_ref when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($three_ds_req_prior_ref)))) {
            throw new InvalidArgumentException("invalid value for \$three_ds_req_prior_ref when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setThreeDsReqAuthData(?string $three_ds_req_auth_data): static
    {
        ...
        if ((mb_strlen($three_ds_req_auth_data) > 20000)) {
            throw new InvalidArgumentException('invalid length for $three_ds_req_auth_data when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 20000.');
        }
        if ((mb_strlen($three_ds_req_auth_data) < 2)) {
            throw new InvalidArgumentException('invalid length for $three_ds_req_auth_data when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($three_ds_req_auth_data)))) {
            throw new InvalidArgumentException("invalid value for \$three_ds_req_auth_data when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setThreeDsReqAuthMethod(?string $three_ds_req_auth_method): static
    {
        ...
        if ((mb_strlen($three_ds_req_auth_method) > 2)) {
            throw new InvalidArgumentException('invalid length for $three_ds_req_auth_method when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($three_ds_req_auth_method) < 2)) {
            throw new InvalidArgumentException('invalid length for $three_ds_req_auth_method when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($three_ds_req_auth_method)))) {
            throw new InvalidArgumentException("invalid value for \$three_ds_req_auth_method when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setThreeDsReqAuthTimestamp(?string $three_ds_req_auth_timestamp): static
    {
        ...
        if ((mb_strlen($three_ds_req_auth_timestamp) > 12)) {
            throw new InvalidArgumentException('invalid length for $three_ds_req_auth_timestamp when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 12.');
        }
        if ((mb_strlen($three_ds_req_auth_timestamp) < 12)) {
            throw new InvalidArgumentException('invalid length for $three_ds_req_auth_timestamp when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 12.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($three_ds_req_auth_timestamp)))) {
            throw new InvalidArgumentException("invalid value for \$three_ds_req_auth_timestamp when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setAcctType(?string $acct_type): static
    {
        ...
        if ((mb_strlen($acct_type) > 2)) {
            throw new InvalidArgumentException('invalid length for $acct_type when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($acct_type) < 2)) {
            throw new InvalidArgumentException('invalid length for $acct_type when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($acct_type)))) {
            throw new InvalidArgumentException("invalid value for \$acct_type when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setTransType(?string $trans_type): static
    {
        ...
        if ((mb_strlen($trans_type) > 2)) {
            throw new InvalidArgumentException('invalid length for $trans_type when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($trans_type) < 2)) {
            throw new InvalidArgumentException('invalid length for $trans_type when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($trans_type)))) {
            throw new InvalidArgumentException("invalid value for \$trans_type when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setAddrMatch(?string $addr_match): static
    {
        ...
        if ((mb_strlen($addr_match) > 1)) {
            throw new InvalidArgumentException('invalid length for $addr_match when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 1.');
        }
        if ((mb_strlen($addr_match) < 1)) {
            throw new InvalidArgumentException('invalid length for $addr_match when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[A-Za-z]*$/", ObjectSerializer::toString($addr_match)))) {
            throw new InvalidArgumentException("invalid value for \$addr_match when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[A-Za-z]*$/.");
        }
    ...
    public function setThreeDsRequestorChallengeInd(?string $three_ds_requestor_challenge_ind): static
    {
        ...
        if ((mb_strlen($three_ds_requestor_challenge_ind) > 2)) {
            throw new InvalidArgumentException('invalid length for $three_ds_requestor_challenge_ind when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($three_ds_requestor_challenge_ind) < 2)) {
            throw new InvalidArgumentException('invalid length for $three_ds_requestor_challenge_ind when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($three_ds_requestor_challenge_ind)))) {
            throw new InvalidArgumentException("invalid value for \$three_ds_requestor_challenge_ind when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setPurchaseInstalData(?string $purchase_instal_data): static
    {
        ...
        if ((mb_strlen($purchase_instal_data) > 3)) {
            throw new InvalidArgumentException('invalid length for $purchase_instal_data when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($purchase_instal_data) < 1)) {
            throw new InvalidArgumentException('invalid length for $purchase_instal_data when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($purchase_instal_data)))) {
            throw new InvalidArgumentException("invalid value for \$purchase_instal_data when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setRecurringExpiry(?string $recurring_expiry): static
    {
        ...
        if ((mb_strlen($recurring_expiry) > 8)) {
            throw new InvalidArgumentException('invalid length for $recurring_expiry when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($recurring_expiry) < 8)) {
            throw new InvalidArgumentException('invalid length for $recurring_expiry when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($recurring_expiry)))) {
            throw new InvalidArgumentException("invalid value for \$recurring_expiry when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setRecurringFrequency(?string $recurring_frequency): static
    {
        ...
        if ((mb_strlen($recurring_frequency) > 4)) {
            throw new InvalidArgumentException('invalid length for $recurring_frequency when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($recurring_frequency) < 1)) {
            throw new InvalidArgumentException('invalid length for $recurring_frequency when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($recurring_frequency)))) {
            throw new InvalidArgumentException("invalid value for \$recurring_frequency when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setDeviceCategory(string $device_category): static
    {
        ...
        if ((mb_strlen($device_category) > 1)) {
            throw new InvalidArgumentException('invalid length for $device_category when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 1.');
        }
        if ((mb_strlen($device_category) < 1)) {
            throw new InvalidArgumentException('invalid length for $device_category when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($device_category)))) {
            throw new InvalidArgumentException("invalid value for \$device_category when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setSdkAppId(string $sdk_app_id): static
    {
        ...
        if ((mb_strlen($sdk_app_id) > 36)) {
            throw new InvalidArgumentException('invalid length for $sdk_app_id when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($sdk_app_id) < 1)) {
            throw new InvalidArgumentException('invalid length for $sdk_app_id when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($sdk_app_id)))) {
            throw new InvalidArgumentException("invalid value for \$sdk_app_id when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setSdkReferenceNumber(string $sdk_reference_number): static
    {
        ...
        if ((mb_strlen($sdk_reference_number) > 32)) {
            throw new InvalidArgumentException('invalid length for $sdk_reference_number when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($sdk_reference_number) < 1)) {
            throw new InvalidArgumentException('invalid length for $sdk_reference_number when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($sdk_reference_number)))) {
            throw new InvalidArgumentException("invalid value for \$sdk_reference_number when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setSdkTransId(string $sdk_trans_id): static
    {
        ...
        if ((mb_strlen($sdk_trans_id) > 36)) {
            throw new InvalidArgumentException('invalid length for $sdk_trans_id when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($sdk_trans_id) < 1)) {
            throw new InvalidArgumentException('invalid length for $sdk_trans_id when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($sdk_trans_id)))) {
            throw new InvalidArgumentException("invalid value for \$sdk_trans_id when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setSdkMaxTimeout(?string $sdk_max_timeout): static
    {
        ...
        if ((mb_strlen($sdk_max_timeout) > 2)) {
            throw new InvalidArgumentException('invalid length for $sdk_max_timeout when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($sdk_max_timeout) < 1)) {
            throw new InvalidArgumentException('invalid length for $sdk_max_timeout when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($sdk_max_timeout)))) {
            throw new InvalidArgumentException("invalid value for \$sdk_max_timeout when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setSdkEncData(string $sdk_enc_data): static
    {
        ...
        if ((mb_strlen($sdk_enc_data) > 64000)) {
            throw new InvalidArgumentException('invalid length for $sdk_enc_data when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 64000.');
        }
        if ((mb_strlen($sdk_enc_data) < 1)) {
            throw new InvalidArgumentException('invalid length for $sdk_enc_data when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($sdk_enc_data)))) {
            throw new InvalidArgumentException("invalid value for \$sdk_enc_data when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setSdkEphemPubKey(string $sdk_ephem_pub_key): static
    {
        ...
        if ((mb_strlen($sdk_ephem_pub_key) > 256)) {
            throw new InvalidArgumentException('invalid length for $sdk_ephem_pub_key when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($sdk_ephem_pub_key) < 1)) {
            throw new InvalidArgumentException('invalid length for $sdk_ephem_pub_key when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($sdk_ephem_pub_key)))) {
            throw new InvalidArgumentException("invalid value for \$sdk_ephem_pub_key when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setDeviceRenderOptions(?string $device_render_options): static
    {
        ...
        if ((mb_strlen($device_render_options) > 256)) {
            throw new InvalidArgumentException('invalid length for $device_render_options when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($device_render_options) < 1)) {
            throw new InvalidArgumentException('invalid length for $device_render_options when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($device_render_options)))) {
            throw new InvalidArgumentException("invalid value for \$device_render_options when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setEci(string $eci): static
    {
        ...
        if ((mb_strlen($eci) > 2)) {
            throw new InvalidArgumentException('invalid length for $eci when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($eci) < 1)) {
            throw new InvalidArgumentException('invalid length for $eci when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($eci)))) {
            throw new InvalidArgumentException("invalid value for \$eci when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setXid(?string $xid): static
    {
        ...
        if ((mb_strlen($xid) > 36)) {
            throw new InvalidArgumentException('invalid length for $xid when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($xid) < 28)) {
            throw new InvalidArgumentException('invalid length for $xid when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 28.');
        }
        if ((!preg_match("/^[ -~]+$/", ObjectSerializer::toString($xid)))) {
            throw new InvalidArgumentException("invalid value for \$xid when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~]+$/.");
        }
    ...
    public function setCavv(?string $cavv): static
    {
        ...
        if ((mb_strlen($cavv) > 28)) {
            throw new InvalidArgumentException('invalid length for $cavv when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 28.');
        }
        if ((mb_strlen($cavv) < 28)) {
            throw new InvalidArgumentException('invalid length for $cavv when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 28.');
        }
        if ((!preg_match("/^[ -~]+$/", ObjectSerializer::toString($cavv)))) {
            throw new InvalidArgumentException("invalid value for \$cavv when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[ -~]+$/.");
        }
     ...
     * @return string|null
     */
    public function getIdTerm(): ?string
    {
     ...
     * @return $this
     */
    public function setIdTerm(?string $id_term): static
    {
        if (is_null($id_term)) {
            throw new InvalidArgumentException('non-nullable id_term cannot be null');
        }
        if ((mb_strlen($id_term) > 8)) {
            throw new InvalidArgumentException('invalid length for $id_term when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($id_term) < 1)) {
            throw new InvalidArgumentException('invalid length for $id_term when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($id_term)))) {
            throw new InvalidArgumentException("invalid value for \$id_term when calling PaymentOrderRequestJsonParams., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setPaymentSystem(?string $payment_system): static
    {
        ...
        if ((mb_strlen($payment_system) > 10)) {
            throw new InvalidArgumentException('invalid length for $payment_system when calling PaymentOrderRequestJsonParams., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($payment_system) < 1)) {
            throw new InvalidArgumentException('invalid length for $payment_system when calling PaymentOrderRequestJsonParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[A-Za-z]*$/", ObjectSerializer::toString($payment_system)))) {
            throw new InvalidArgumentException("invalid value for \$payment_system when calling PaymentOrderRequestJsonParams., must conform to the pattern /^[A-Za-z]*$/.");
        }
