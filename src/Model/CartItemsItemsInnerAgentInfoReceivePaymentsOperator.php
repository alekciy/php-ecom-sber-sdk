<?php
/**
 * CartItemsItemsInnerAgentInfoReceivePaymentsOperator
 *
 * PHP version 8.1
 *
 * @package  SberPay
...
/**
 * CartItemsItemsInnerAgentInfoReceivePaymentsOperator Class Doc Comment
 *
 ...
 */
class CartItemsItemsInnerAgentInfoReceivePaymentsOperator implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'cartItems_items_inner_agentInfo_receivePaymentsOperator';
    ...
    */
     ...
     * Sets phones
     *
     * @param string[]|null $phones __Тег ФФД 1074.__ Номер телефона платежного (суб)агента. Указывается в формате +{код страны}{номер телефона}. Пример заполнения: \"phones\": [\"+74957444401\",\"+79998887766\"]
     *
     * @return $this
     */
    public function setPhones(?array $phones): static
    {
        ...
        if ((count($phones) > 5)) {
            throw new InvalidArgumentException('invalid value for $phones when calling CartItemsItemsInnerAgentInfoReceivePaymentsOperator., number of items must be less than or equal to 5.');
        }
