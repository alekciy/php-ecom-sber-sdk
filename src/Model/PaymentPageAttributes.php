...
/**
 * PaymentPageAttributes Class Doc Comment
 *
 ...
 */
class PaymentPageAttributes implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'paymentPageAttributes';
    ...
    */
    ...
    public function setBackToShopName(?string $back_to_shop_name): static
    {
        ...
        if ((mb_strlen($back_to_shop_name) > 200)) {
            throw new InvalidArgumentException('invalid length for $back_to_shop_name when calling PaymentPageAttributes., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($back_to_shop_name) < 1)) {
            throw new InvalidArgumentException('invalid length for $back_to_shop_name when calling PaymentPageAttributes., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($back_to_shop_name)))) {
            throw new InvalidArgumentException("invalid value for \$back_to_shop_name when calling PaymentPageAttributes., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setBackToShopUrl(?string $back_to_shop_url): static
    {
        ...
        if ((mb_strlen($back_to_shop_url) > 200)) {
            throw new InvalidArgumentException('invalid length for $back_to_shop_url when calling PaymentPageAttributes., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($back_to_shop_url) < 1)) {
            throw new InvalidArgumentException('invalid length for $back_to_shop_url when calling PaymentPageAttributes., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^https?:\/\/(.*)$/", ObjectSerializer::toString($back_to_shop_url)))) {
            throw new InvalidArgumentException("invalid value for \$back_to_shop_url when calling PaymentPageAttributes., must conform to the pattern /^https?:\/\/(.*)$/.");
        }
