...
/**
 * CartItemsItemsInnerAgentInfo Class Doc Comment
 *
 ...
 */
class CartItemsItemsInnerAgentInfo implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'cartItems_items_inner_agentInfo';
    ...
    protected static array $openAPITypes = [
        'type' => 'string',
        'paying_agent' => '\SberPay\Model\CartItemsItemsInnerAgentInfoPayingAgent',
        'receive_payments_operator' => '\SberPay\Model\CartItemsItemsInnerAgentInfoReceivePaymentsOperator',
        'money_transfer_operator' => '\SberPay\Model\CartItemsItemsInnerAgentInfoMoneyTransferOperator'
    ];
    ...
    protected static array $openAPIFormats = [
        'type' => null,
        'paying_agent' => null,
        'receive_payments_operator' => null,
        'money_transfer_operator' => null
    ];
    ...
    protected static array $openAPINullables = [
        'type' => false,
        'paying_agent' => false,
        'receive_payments_operator' => false,
        'money_transfer_operator' => false
    ];
    ...
    protected static array $attributeMap = [
        ...
        'receive_payments_operator' => 'receivePaymentsOperator',
    ...
    protected static array $setters = [
        'type' => 'setType',
        'paying_agent' => 'setPayingAgent',
        'receive_payments_operator' => 'setReceivePaymentsOperator',
        'money_transfer_operator' => 'setMoneyTransferOperator'
    ];
    ...
    protected static array $getters = [
        'type' => 'getType',
        'paying_agent' => 'getPayingAgent',
        'receive_payments_operator' => 'getReceivePaymentsOperator',
        'money_transfer_operator' => 'getMoneyTransferOperator'
    ];
    ...
    public const TYPE_BANK_PAYING_AGENT = 'bank_paying_agent';
    public const TYPE_BANK_PAYING_SUBAGENT = 'bank_paying_subagent';
    public const TYPE_PAYING_AGENT = 'paying_agent';
    public const TYPE_PAYING_SUBAGENT = 'paying_subagent';
    public const TYPE_ATTORNEY = 'attorney';
    public const TYPE_COMMISSION_AGENT = 'commission_agent';
    ...
    {
        return [
            self::TYPE_BANK_PAYING_AGENT,
            self::TYPE_BANK_PAYING_SUBAGENT,
            self::TYPE_PAYING_AGENT,
            self::TYPE_PAYING_SUBAGENT,
            self::TYPE_ATTORNEY,
            self::TYPE_COMMISSION_AGENT,
            self::TYPE_ANOTHER,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('paying_agent', $data ?? [], null);
        $this->setIfExists('receive_payments_operator', $data ?? [], null);
        $this->setIfExists('money_transfer_operator', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets type
     *
     * @param string $type __Тег ФФД 1222.__ Тип агента. Может принимать следующие значения:   * `bank_paying_agent` - Банковский платежный агент;   * `bank_paying_subagent` - Банковский платежный субагент;   * `paying_agent` - Платежный агент;   * `paying_subagent` - Платежный субагент;   * `attorney` - Поверенный;   * `commission_agent` - Комиссионер;   * `another` - Прочие типы агентов.
     *
     * @return $this
     */
     ...
     * Gets paying_agent
     *
     * @return \SberPay\Model\CartItemsItemsInnerAgentInfoPayingAgent|null
     */
    public function getPayingAgent(): ?\SberPay\Model\CartItemsItemsInnerAgentInfoPayingAgent
    {
        return $this->container['paying_agent'];
    }

    /**
     * Sets paying_agent
     *
     * @param \SberPay\Model\CartItemsItemsInnerAgentInfoPayingAgent|null $paying_agent paying_agent
     *
     * @return $this
     */
    public function setPayingAgent(?\SberPay\Model\CartItemsItemsInnerAgentInfoPayingAgent $paying_agent): static
    {
        if (is_null($paying_agent)) {
            throw new InvalidArgumentException('non-nullable paying_agent cannot be null');
        }
        $this->container['paying_agent'] = $paying_agent;

        return $this;
    }

    /**
     * Gets receive_payments_operator
     *
     * @return \SberPay\Model\CartItemsItemsInnerAgentInfoReceivePaymentsOperator|null
     */
    public function getReceivePaymentsOperator(): ?\SberPay\Model\CartItemsItemsInnerAgentInfoReceivePaymentsOperator
    {
        return $this->container['receive_payments_operator'];
    }

    /**
     * Sets receive_payments_operator
     *
     * @param \SberPay\Model\CartItemsItemsInnerAgentInfoReceivePaymentsOperator|null $receive_payments_operator receive_payments_operator
     *
     * @return $this
     */
    public function setReceivePaymentsOperator(?\SberPay\Model\CartItemsItemsInnerAgentInfoReceivePaymentsOperator $receive_payments_operator): static
    {
        if (is_null($receive_payments_operator)) {
            throw new InvalidArgumentException('non-nullable receive_payments_operator cannot be null');
        }
        $this->container['receive_payments_operator'] = $receive_payments_operator;

        return $this;
    }

    /**
     * Gets money_transfer_operator
     *
     * @return \SberPay\Model\CartItemsItemsInnerAgentInfoMoneyTransferOperator|null
     */
    public function getMoneyTransferOperator(): ?\SberPay\Model\CartItemsItemsInnerAgentInfoMoneyTransferOperator
    {
        return $this->container['money_transfer_operator'];
    }

    /**
     * Sets money_transfer_operator
     *
     * @param \SberPay\Model\CartItemsItemsInnerAgentInfoMoneyTransferOperator|null $money_transfer_operator money_transfer_operator
     *
     * @return $this
     */
    public function setMoneyTransferOperator(?\SberPay\Model\CartItemsItemsInnerAgentInfoMoneyTransferOperator $money_transfer_operator): static
    {
        if (is_null($money_transfer_operator)) {
            throw new InvalidArgumentException('non-nullable money_transfer_operator cannot be null');
        }
        $this->container['money_transfer_operator'] = $money_transfer_operator;
