...
/**
 * RecurrentPaymentResponseData Class Doc Comment
 *
 ...
 */
class RecurrentPaymentResponseData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'recurrentPaymentResponse_data';
    ...
    */
    ...
    public function setOrderId(string $order_id): static
    {
        ...
        if ((mb_strlen($order_id) > 36)) {
            throw new InvalidArgumentException('invalid length for $order_id when calling RecurrentPaymentResponseData., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($order_id) < 36)) {
            throw new InvalidArgumentException('invalid length for $order_id when calling RecurrentPaymentResponseData., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/^[a-f0-9\\-]+$/", ObjectSerializer::toString($order_id)))) {
            throw new InvalidArgumentException("invalid value for \$order_id when calling RecurrentPaymentResponseData., must conform to the pattern /^[a-f0-9\\-]+$/.");
        }
    ...
    public function setOrderNumber(?string $order_number): static
    {
        ...
        if ((mb_strlen($order_number) > 36)) {
            throw new InvalidArgumentException('invalid length for $order_number when calling RecurrentPaymentResponseData., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($order_number) < 1)) {
            throw new InvalidArgumentException('invalid length for $order_number when calling RecurrentPaymentResponseData., must be bigger than or equal to 1.');
        }
