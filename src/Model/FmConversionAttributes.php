...
/**
 * FmConversionAttributes Class Doc Comment
 *
 ...
 */
class FmConversionAttributes implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'fmConversionAttributes';
    ...
    */
    ...
    public function setHasValuableItems(?string $has_valuable_items): static
    {
        ...
        if ((mb_strlen($has_valuable_items) > 2)) {
            throw new InvalidArgumentException('invalid length for $has_valuable_items when calling FmConversionAttributes., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($has_valuable_items) < 2)) {
            throw new InvalidArgumentException('invalid length for $has_valuable_items when calling FmConversionAttributes., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($has_valuable_items)))) {
            throw new InvalidArgumentException("invalid value for \$has_valuable_items when calling FmConversionAttributes., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setAcctId(?string $acct_id): static
    {
        ...
        if ((mb_strlen($acct_id) > 64)) {
            throw new InvalidArgumentException('invalid length for $acct_id when calling FmConversionAttributes., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($acct_id) < 1)) {
            throw new InvalidArgumentException('invalid length for $acct_id when calling FmConversionAttributes., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($acct_id)))) {
            throw new InvalidArgumentException("invalid value for \$acct_id when calling FmConversionAttributes., must conform to the pattern /^[ -~]*$/.");
        }
    ...
    public function setChAccDate(?string $ch_acc_date): static
    {
        ...
        if ((mb_strlen($ch_acc_date) > 8)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_date when calling FmConversionAttributes., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($ch_acc_date) < 8)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_date when calling FmConversionAttributes., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ch_acc_date)))) {
            throw new InvalidArgumentException("invalid value for \$ch_acc_date when calling FmConversionAttributes., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setChAccAgeInd(?string $ch_acc_age_ind): static
    {
        ...
        if ((mb_strlen($ch_acc_age_ind) > 2)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_age_ind when calling FmConversionAttributes., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($ch_acc_age_ind) < 2)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_age_ind when calling FmConversionAttributes., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ch_acc_age_ind)))) {
            throw new InvalidArgumentException("invalid value for \$ch_acc_age_ind when calling FmConversionAttributes., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setChAccChangeInd(?string $ch_acc_change_ind): static
    {
        ...
        if ((mb_strlen($ch_acc_change_ind) > 2)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_change_ind when calling FmConversionAttributes., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($ch_acc_change_ind) < 2)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_change_ind when calling FmConversionAttributes., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ch_acc_change_ind)))) {
            throw new InvalidArgumentException("invalid value for \$ch_acc_change_ind when calling FmConversionAttributes., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setShipAddrCity(?string $ship_addr_city): static
    {
        ...
        if ((mb_strlen($ship_addr_city) > 50)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_city when calling FmConversionAttributes., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($ship_addr_city) < 1)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_city when calling FmConversionAttributes., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($ship_addr_city)))) {
            throw new InvalidArgumentException("invalid value for \$ship_addr_city when calling FmConversionAttributes., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setShipDeliveryPointId(?string $ship_delivery_point_id): static
    {
        ...
        if ((mb_strlen($ship_delivery_point_id) > 50)) {
            throw new InvalidArgumentException('invalid length for $ship_delivery_point_id when calling FmConversionAttributes., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($ship_delivery_point_id) < 1)) {
            throw new InvalidArgumentException('invalid length for $ship_delivery_point_id when calling FmConversionAttributes., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($ship_delivery_point_id)))) {
            throw new InvalidArgumentException("invalid value for \$ship_delivery_point_id when calling FmConversionAttributes., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setMriReorderItemsInd(?string $mri_reorder_items_ind): static
    {
        ...
        if ((mb_strlen($mri_reorder_items_ind) > 2)) {
            throw new InvalidArgumentException('invalid length for $mri_reorder_items_ind when calling FmConversionAttributes., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($mri_reorder_items_ind) < 2)) {
            throw new InvalidArgumentException('invalid length for $mri_reorder_items_ind when calling FmConversionAttributes., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($mri_reorder_items_ind)))) {
            throw new InvalidArgumentException("invalid value for \$mri_reorder_items_ind when calling FmConversionAttributes., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setMobilePhone(?string $mobile_phone): static
    {
        ...
        if ((mb_strlen($mobile_phone) > 19)) {
            throw new InvalidArgumentException('invalid length for $mobile_phone when calling FmConversionAttributes., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($mobile_phone) < 1)) {
            throw new InvalidArgumentException('invalid length for $mobile_phone when calling FmConversionAttributes., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[\\d\\-]*$/", ObjectSerializer::toString($mobile_phone)))) {
            throw new InvalidArgumentException("invalid value for \$mobile_phone when calling FmConversionAttributes., must conform to the pattern /^[\\d\\-]*$/.");
        }
    ...
    public function setShipNameIndicator(?string $ship_name_indicator): static
    {
        ...
        if ((mb_strlen($ship_name_indicator) > 2)) {
            throw new InvalidArgumentException('invalid length for $ship_name_indicator when calling FmConversionAttributes., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($ship_name_indicator) < 2)) {
            throw new InvalidArgumentException('invalid length for $ship_name_indicator when calling FmConversionAttributes., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ship_name_indicator)))) {
            throw new InvalidArgumentException("invalid value for \$ship_name_indicator when calling FmConversionAttributes., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setSuspiciousAccActivity(?string $suspicious_acc_activity): static
    {
        ...
        if ((mb_strlen($suspicious_acc_activity) > 2)) {
            throw new InvalidArgumentException('invalid length for $suspicious_acc_activity when calling FmConversionAttributes., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($suspicious_acc_activity) < 2)) {
            throw new InvalidArgumentException('invalid length for $suspicious_acc_activity when calling FmConversionAttributes., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($suspicious_acc_activity)))) {
            throw new InvalidArgumentException("invalid value for \$suspicious_acc_activity when calling FmConversionAttributes., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setProvisionAttemptsDay(?string $provision_attempts_day): static
    {
        ...
        if ((mb_strlen($provision_attempts_day) > 4)) {
            throw new InvalidArgumentException('invalid length for $provision_attempts_day when calling FmConversionAttributes., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($provision_attempts_day) < 1)) {
            throw new InvalidArgumentException('invalid length for $provision_attempts_day when calling FmConversionAttributes., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($provision_attempts_day)))) {
            throw new InvalidArgumentException("invalid value for \$provision_attempts_day when calling FmConversionAttributes., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setShipAddrLine1(?string $ship_addr_line1): static
    {
        ...
        if ((mb_strlen($ship_addr_line1) > 50)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_line1 when calling FmConversionAttributes., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($ship_addr_line1) < 1)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_line1 when calling FmConversionAttributes., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($ship_addr_line1)))) {
            throw new InvalidArgumentException("invalid value for \$ship_addr_line1 when calling FmConversionAttributes., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setShipAddrLine2(?string $ship_addr_line2): static
    {
        ...
        if ((mb_strlen($ship_addr_line2) > 50)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_line2 when calling FmConversionAttributes., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($ship_addr_line2) < 1)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_line2 when calling FmConversionAttributes., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($ship_addr_line2)))) {
            throw new InvalidArgumentException("invalid value for \$ship_addr_line2 when calling FmConversionAttributes., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setShipAddrLine3(?string $ship_addr_line3): static
    {
        ...
        if ((mb_strlen($ship_addr_line3) > 50)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_line3 when calling FmConversionAttributes., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($ship_addr_line3) < 1)) {
            throw new InvalidArgumentException('invalid length for $ship_addr_line3 when calling FmConversionAttributes., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($ship_addr_line3)))) {
            throw new InvalidArgumentException("invalid value for \$ship_addr_line3 when calling FmConversionAttributes., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setShipAddressUsage(?string $ship_address_usage): static
    {
        ...
        if ((mb_strlen($ship_address_usage) > 8)) {
            throw new InvalidArgumentException('invalid length for $ship_address_usage when calling FmConversionAttributes., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($ship_address_usage) < 8)) {
            throw new InvalidArgumentException('invalid length for $ship_address_usage when calling FmConversionAttributes., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ship_address_usage)))) {
            throw new InvalidArgumentException("invalid value for \$ship_address_usage when calling FmConversionAttributes., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setShipAddressUsageInd(?string $ship_address_usage_ind): static
    {
        ...
        if ((mb_strlen($ship_address_usage_ind) > 2)) {
            throw new InvalidArgumentException('invalid length for $ship_address_usage_ind when calling FmConversionAttributes., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($ship_address_usage_ind) < 2)) {
            throw new InvalidArgumentException('invalid length for $ship_address_usage_ind when calling FmConversionAttributes., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ship_address_usage_ind)))) {
            throw new InvalidArgumentException("invalid value for \$ship_address_usage_ind when calling FmConversionAttributes., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setMriDeliveryTimeframe(?string $mri_delivery_timeframe): static
    {
        ...
        if ((mb_strlen($mri_delivery_timeframe) > 2)) {
            throw new InvalidArgumentException('invalid length for $mri_delivery_timeframe when calling FmConversionAttributes., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($mri_delivery_timeframe) < 1)) {
            throw new InvalidArgumentException('invalid length for $mri_delivery_timeframe when calling FmConversionAttributes., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($mri_delivery_timeframe)))) {
            throw new InvalidArgumentException("invalid value for \$mri_delivery_timeframe when calling FmConversionAttributes., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setMriShipIndicator(?string $mri_ship_indicator): static
    {
        ...
        if ((mb_strlen($mri_ship_indicator) > 2)) {
            throw new InvalidArgumentException('invalid length for $mri_ship_indicator when calling FmConversionAttributes., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($mri_ship_indicator) < 2)) {
            throw new InvalidArgumentException('invalid length for $mri_ship_indicator when calling FmConversionAttributes., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($mri_ship_indicator)))) {
            throw new InvalidArgumentException("invalid value for \$mri_ship_indicator when calling FmConversionAttributes., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setChAccPwChange(?string $ch_acc_pw_change): static
    {
        ...
        if ((mb_strlen($ch_acc_pw_change) > 8)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_pw_change when calling FmConversionAttributes., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($ch_acc_pw_change) < 8)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_pw_change when calling FmConversionAttributes., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ch_acc_pw_change)))) {
            throw new InvalidArgumentException("invalid value for \$ch_acc_pw_change when calling FmConversionAttributes., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setChAccPwChangeInd(?string $ch_acc_pw_change_ind): static
    {
        ...
        if ((mb_strlen($ch_acc_pw_change_ind) > 2)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_pw_change_ind when calling FmConversionAttributes., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($ch_acc_pw_change_ind) < 2)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_pw_change_ind when calling FmConversionAttributes., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ch_acc_pw_change_ind)))) {
            throw new InvalidArgumentException("invalid value for \$ch_acc_pw_change_ind when calling FmConversionAttributes., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setNbPurchaseAccount(?string $nb_purchase_account): static
    {
        ...
        if ((mb_strlen($nb_purchase_account) > 4)) {
            throw new InvalidArgumentException('invalid length for $nb_purchase_account when calling FmConversionAttributes., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($nb_purchase_account) < 1)) {
            throw new InvalidArgumentException('invalid length for $nb_purchase_account when calling FmConversionAttributes., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($nb_purchase_account)))) {
            throw new InvalidArgumentException("invalid value for \$nb_purchase_account when calling FmConversionAttributes., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setTxnActivityDay(?string $txn_activity_day): static
    {
        ...
        if ((mb_strlen($txn_activity_day) > 3)) {
            throw new InvalidArgumentException('invalid length for $txn_activity_day when calling FmConversionAttributes., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($txn_activity_day) < 1)) {
            throw new InvalidArgumentException('invalid length for $txn_activity_day when calling FmConversionAttributes., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($txn_activity_day)))) {
            throw new InvalidArgumentException("invalid value for \$txn_activity_day when calling FmConversionAttributes., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setTxnActivityYear(?string $txn_activity_year): static
    {
        ...
        if ((mb_strlen($txn_activity_year) > 3)) {
            throw new InvalidArgumentException('invalid length for $txn_activity_year when calling FmConversionAttributes., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($txn_activity_year) < 1)) {
            throw new InvalidArgumentException('invalid length for $txn_activity_year when calling FmConversionAttributes., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($txn_activity_year)))) {
            throw new InvalidArgumentException("invalid value for \$txn_activity_year when calling FmConversionAttributes., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setPaymentAccAge(?string $payment_acc_age): static
    {
        ...
        if ((mb_strlen($payment_acc_age) > 8)) {
            throw new InvalidArgumentException('invalid length for $payment_acc_age when calling FmConversionAttributes., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($payment_acc_age) < 8)) {
            throw new InvalidArgumentException('invalid length for $payment_acc_age when calling FmConversionAttributes., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($payment_acc_age)))) {
            throw new InvalidArgumentException("invalid value for \$payment_acc_age when calling FmConversionAttributes., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setPaymentAccInd(?string $payment_acc_ind): static
    {
        ...
        if ((mb_strlen($payment_acc_ind) > 2)) {
            throw new InvalidArgumentException('invalid length for $payment_acc_ind when calling FmConversionAttributes., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($payment_acc_ind) < 2)) {
            throw new InvalidArgumentException('invalid length for $payment_acc_ind when calling FmConversionAttributes., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($payment_acc_ind)))) {
            throw new InvalidArgumentException("invalid value for \$payment_acc_ind when calling FmConversionAttributes., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setChAccChange(?string $ch_acc_change): static
    {
        ...
        if ((mb_strlen($ch_acc_change) > 8)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_change when calling FmConversionAttributes., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($ch_acc_change) < 8)) {
            throw new InvalidArgumentException('invalid length for $ch_acc_change when calling FmConversionAttributes., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($ch_acc_change)))) {
            throw new InvalidArgumentException("invalid value for \$ch_acc_change when calling FmConversionAttributes., must conform to the pattern /^\\d+$/.");
        }
