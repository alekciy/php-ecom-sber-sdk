...
/**
 * AttributesInner Class Doc Comment
 *
 * @package  SberPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AttributesInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'attributes_inner';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['name']) && !preg_match("/^[A-Za-z]*$/", $this->container['name'])) {
            $invalidProperties[] = "invalid value for 'name', must be conform to the pattern /^[A-Za-z]*$/.";
        }
        ...
        if (!is_null($this->container['value']) && !preg_match("/^[ -~]*$/", $this->container['value'])) {
            $invalidProperties[] = "invalid value for 'value', must be conform to the pattern /^[ -~]*$/.";
        }
     ...
     * Sets name
     *
     * @param string|null $name Имя передаваемого параметра для различных свойств заказа
     *
     * @return $this
     */
    public function setName(?string $name): static
    {
        ...
        if ((mb_strlen($name) > 20)) {
            throw new InvalidArgumentException('invalid length for $name when calling AttributesInner., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new InvalidArgumentException('invalid length for $name when calling AttributesInner., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[A-Za-z]*$/", ObjectSerializer::toString($name)))) {
            throw new InvalidArgumentException("invalid value for \$name when calling AttributesInner., must conform to the pattern /^[A-Za-z]*$/.");
        }
     ...
     * Sets value
     *
     * @param string|null $value Значение передаваемого параметра для различных свойств заказа
     *
     * @return $this
     */
    public function setValue(?string $value): static
    {
        ...
        if ((mb_strlen($value) > 1024)) {
            throw new InvalidArgumentException('invalid length for $value when calling AttributesInner., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($value) < 1)) {
            throw new InvalidArgumentException('invalid length for $value when calling AttributesInner., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($value)))) {
            throw new InvalidArgumentException("invalid value for \$value when calling AttributesInner., must conform to the pattern /^[ -~]*$/.");
        }
