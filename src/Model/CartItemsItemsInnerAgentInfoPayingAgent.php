<?php
/**
 * CartItemsItemsInnerAgentInfoPayingAgent
 *
 * PHP version 8.1
 *
 * @package  SberPay
...
/**
 * CartItemsItemsInnerAgentInfoPayingAgent Class Doc Comment
 *
 ...
 */
class CartItemsItemsInnerAgentInfoPayingAgent implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'cartItems_items_inner_agentInfo_payingAgent';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['operation']) && (mb_strlen($this->container['operation']) > 24)) {
            $invalidProperties[] = "invalid value for 'operation', the character length must be smaller than or equal to 24.";
        }

        if (!is_null($this->container['operation']) && !preg_match("/^[ -~А-Яа-яЁё№]*$/", $this->container['operation'])) {
            $invalidProperties[] = "invalid value for 'operation', must be conform to the pattern /^[ -~А-Яа-яЁё№]*$/.";
        }
     ...
     * Sets operation
     *
     * @param string|null $operation __Тег ФФД 1044.__ Наименование операции банковского платежного (суб)агента.
     *
     * @return $this
     */
    public function setOperation(?string $operation): static
    {
        ...
        if ((mb_strlen($operation) > 24)) {
            throw new InvalidArgumentException('invalid length for $operation when calling CartItemsItemsInnerAgentInfoPayingAgent., must be smaller than or equal to 24.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($operation)))) {
            throw new InvalidArgumentException("invalid value for \$operation when calling CartItemsItemsInnerAgentInfoPayingAgent., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
     ...
     * Sets phones
     *
     * @param string[]|null $phones __Тег ФФД 1073.__ Номер телефона банковского платежного (суб)агента или платежного (суб)агента. Указывается в формате +{код страны}{номер телефона}. Пример заполнения: \"phones\": [\"+74957444401\",\"+79998887766\"]
     *
     * @return $this
     */
    public function setPhones(?array $phones): static
    {
        ...
        if ((count($phones) > 5)) {
            throw new InvalidArgumentException('invalid value for $phones when calling CartItemsItemsInnerAgentInfoPayingAgent., number of items must be less than or equal to 5.');
        }
