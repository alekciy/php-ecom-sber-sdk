...
/**
 * Finish3dsMethodRequest Class Doc Comment
 *
 * @package  SberPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class Finish3dsMethodRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'finish3dsMethodRequest';
    ...
    protected static array $openAPITypes = [
        ...
        'three_ds_comp_ind' => '\SberPay\Model\ThreeDSCompInd'
    ];
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['three_ds_server_trans_id'] === null) {
            $invalidProperties[] = "'three_ds_server_trans_id' can't be null";
        }
        if ((mb_strlen($this->container['three_ds_server_trans_id']) > 36)) {
            $invalidProperties[] = "invalid value for 'three_ds_server_trans_id', the character length must be smaller than or equal to 36.";
        }

        if ((mb_strlen($this->container['three_ds_server_trans_id']) < 1)) {
            $invalidProperties[] = "invalid value for 'three_ds_server_trans_id', the character length must be bigger than or equal to 1.";
        }

        if (!preg_match("/^[ -~]*$/", $this->container['three_ds_server_trans_id'])) {
    ...
    public function setUserName(string $user_name): static
    {
        ...
        if ((mb_strlen($user_name) > 30)) {
            throw new InvalidArgumentException('invalid length for $user_name when calling Finish3dsMethodRequest., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($user_name) < 1)) {
            throw new InvalidArgumentException('invalid length for $user_name when calling Finish3dsMethodRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[A-Za-z0-9-_ ]+$/", ObjectSerializer::toString($user_name)))) {
            throw new InvalidArgumentException("invalid value for \$user_name when calling Finish3dsMethodRequest., must conform to the pattern /^[A-Za-z0-9-_ ]+$/.");
        }
    ...
    public function setPassword(string $password): static
    {
        ...
        if ((mb_strlen($password) > 30)) {
            throw new InvalidArgumentException('invalid length for $password when calling Finish3dsMethodRequest., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($password) < 1)) {
            throw new InvalidArgumentException('invalid length for $password when calling Finish3dsMethodRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]+$/", ObjectSerializer::toString($password)))) {
            throw new InvalidArgumentException("invalid value for \$password when calling Finish3dsMethodRequest., must conform to the pattern /^[ -~]+$/.");
        }
     ...
     * @return $this
     */
    public function setMdOrder(string $md_order): static
    {
        if (is_null($md_order)) {
            throw new InvalidArgumentException('non-nullable md_order cannot be null');
        }
        if ((mb_strlen($md_order) > 36)) {
            throw new InvalidArgumentException('invalid length for $md_order when calling Finish3dsMethodRequest., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($md_order) < 36)) {
            throw new InvalidArgumentException('invalid length for $md_order when calling Finish3dsMethodRequest., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/^[a-f0-9\\-]+$/", ObjectSerializer::toString($md_order)))) {
            throw new InvalidArgumentException("invalid value for \$md_order when calling Finish3dsMethodRequest., must conform to the pattern /^[a-f0-9\\-]+$/.");
        }
     ...
     *
     * @param string $three_ds_server_trans_id Идентификатор 3DS Server Transaction ID
     *
     * @return $this
     */
    public function setThreeDsServerTransId(string $three_ds_server_trans_id): static
    {
        ...
        if ((mb_strlen($three_ds_server_trans_id) > 36)) {
            throw new InvalidArgumentException('invalid length for $three_ds_server_trans_id when calling Finish3dsMethodRequest., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($three_ds_server_trans_id) < 1)) {
            throw new InvalidArgumentException('invalid length for $three_ds_server_trans_id when calling Finish3dsMethodRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($three_ds_server_trans_id)))) {
            throw new InvalidArgumentException("invalid value for \$three_ds_server_trans_id when calling Finish3dsMethodRequest., must conform to the pattern /^[ -~]*$/.");
        }
     ...
     *
     * @return \SberPay\Model\ThreeDSCompInd
     */
    public function getThreeDsCompInd(): \SberPay\Model\ThreeDSCompInd
    {
     ...
     *
     * @param \SberPay\Model\ThreeDSCompInd $three_ds_comp_ind three_ds_comp_ind
     *
     * @return $this
     */
    public function setThreeDsCompInd(\SberPay\Model\ThreeDSCompInd $three_ds_comp_ind): static
    {
