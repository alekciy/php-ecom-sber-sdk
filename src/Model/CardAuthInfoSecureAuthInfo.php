...
/**
 * CardAuthInfoSecureAuthInfo Class Doc Comment
 *
 ...
 */
class CardAuthInfoSecureAuthInfo implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'cardAuthInfo_secureAuthInfo';
    ...
    protected static array $openAPITypes = [
        'eci' => 'int',
        'three_ds_info' => '\SberPay\Model\CardAuthInfoSecureAuthInfoThreeDSInfo'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('three_ds_info', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['eci']) && ($this->container['eci'] > 9999)) {
            $invalidProperties[] = "invalid value for 'eci', must be smaller than or equal to 9999.";
        }

        if (!is_null($this->container['eci']) && ($this->container['eci'] < 0)) {
            $invalidProperties[] = "invalid value for 'eci', must be bigger than or equal to 0.";
        }
     ...
     * Sets eci
     *
     * @param int|null $eci Индикатор проведения 3-D Secure
     *
     * @return $this
     */
    public function setEci(?int $eci): static
    {
        if (is_null($eci)) {
        ...
        if (($eci > 9999)) {
            throw new InvalidArgumentException('invalid value for $eci when calling CardAuthInfoSecureAuthInfo., must be smaller than or equal to 9999.');
        }
        if (($eci < 0)) {
            throw new InvalidArgumentException('invalid value for $eci when calling CardAuthInfoSecureAuthInfo., must be bigger than or equal to 0.');
        }
     ...
     * Gets three_ds_info
     *
     * @return \SberPay\Model\CardAuthInfoSecureAuthInfoThreeDSInfo|null
     */
    public function getThreeDsInfo(): ?\SberPay\Model\CardAuthInfoSecureAuthInfoThreeDSInfo
    {
        return $this->container['three_ds_info'];
    }

    /**
     * Sets three_ds_info
     *
     * @param \SberPay\Model\CardAuthInfoSecureAuthInfoThreeDSInfo|null $three_ds_info three_ds_info
     *
     * @return $this
     */
    public function setThreeDsInfo(?\SberPay\Model\CardAuthInfoSecureAuthInfoThreeDSInfo $three_ds_info): static
    {
        if (is_null($three_ds_info)) {
            throw new InvalidArgumentException('non-nullable three_ds_info cannot be null');
        }
        $this->container['three_ds_info'] = $three_ds_info;
