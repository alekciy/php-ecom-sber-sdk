...
/**
 * DeclineResponse Class Doc Comment
 *
 * @package  SberPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class DeclineResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'declineResponse';
    ...
    */
    ...
    public function setErrorCode(string $error_code): static
    {
        ...
        if ((mb_strlen($error_code) > 3)) {
            throw new InvalidArgumentException('invalid length for $error_code when calling DeclineResponse., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($error_code) < 1)) {
            throw new InvalidArgumentException('invalid length for $error_code when calling DeclineResponse., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d{1,3}$/", ObjectSerializer::toString($error_code)))) {
            throw new InvalidArgumentException("invalid value for \$error_code when calling DeclineResponse., must conform to the pattern /^\\d{1,3}$/.");
        }
    ...
    public function setErrorMessage(?string $error_message): static
    {
        ...
        if ((mb_strlen($error_message) > 512)) {
            throw new InvalidArgumentException('invalid length for $error_message when calling DeclineResponse., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($error_message) < 0)) {
            throw new InvalidArgumentException('invalid length for $error_message when calling DeclineResponse., must be bigger than or equal to 0.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($error_message)))) {
            throw new InvalidArgumentException("invalid value for \$error_message when calling DeclineResponse., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setInfo(?string $info): static
    {
        ...
        if ((mb_strlen($info) > 512)) {
            throw new InvalidArgumentException('invalid length for $info when calling DeclineResponse., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($info) < 0)) {
            throw new InvalidArgumentException('invalid length for $info when calling DeclineResponse., must be bigger than or equal to 0.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($info)))) {
            throw new InvalidArgumentException("invalid value for \$info when calling DeclineResponse., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
