<?php
/**
 * GetOrderStatusExtendedRequestOneOf1
 *
 * PHP version 8.1
 *
 * @package  SberPay
...
/**
 * GetOrderStatusExtendedRequestOneOf1 Class Doc Comment
 *
 * @package  SberPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetOrderStatusExtendedRequestOneOf1 implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getOrderStatusExtendedRequest_oneOf_1';
    ...
    */
    ...
    public function setOrderNumber(string $order_number): static
    {
        ...
        if ((mb_strlen($order_number) > 36)) {
            throw new InvalidArgumentException('invalid length for $order_number when calling GetOrderStatusExtendedRequestOneOf1., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($order_number) < 1)) {
            throw new InvalidArgumentException('invalid length for $order_number when calling GetOrderStatusExtendedRequestOneOf1., must be bigger than or equal to 1.');
        }
