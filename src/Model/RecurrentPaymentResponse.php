...
/**
 * RecurrentPaymentResponse Class Doc Comment
 *
 * @package  SberPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class RecurrentPaymentResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'recurrentPaymentResponse';
    ...
    protected static array $openAPITypes = [
        'success' => 'bool',
        'error' => '\SberPay\Model\RecurrentPaymentResponseError',
        'data' => '\SberPay\Model\RecurrentPaymentResponseData',
        'order_status' => '\SberPay\Model\RecurrentPaymentResponseOrderStatus'
    ];
    ...
    */
     ...
     * Sets success
     *
     * @param bool $success Признак, определяющий результат выполнения запроса. Возможны следующие значения:   * `true` = истина;   * `false` = ложь.
     *
     * @return $this
     */
     ...
     * Gets error
     *
     * @return \SberPay\Model\RecurrentPaymentResponseError|null
     */
    public function getError(): ?\SberPay\Model\RecurrentPaymentResponseError
    {
     ...
     * Sets error
     *
     * @param \SberPay\Model\RecurrentPaymentResponseError|null $error error
     *
     * @return $this
     */
    public function setError(?\SberPay\Model\RecurrentPaymentResponseError $error): static
    {
        if (is_null($error)) {
     ...
     * Gets data
     *
     * @return \SberPay\Model\RecurrentPaymentResponseData|null
     */
    public function getData(): ?\SberPay\Model\RecurrentPaymentResponseData
    {
     ...
     * Sets data
     *
     * @param \SberPay\Model\RecurrentPaymentResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\SberPay\Model\RecurrentPaymentResponseData $data): static
    {
        if (is_null($data)) {
     ...
     * Gets order_status
     *
     * @return \SberPay\Model\RecurrentPaymentResponseOrderStatus|null
     */
    public function getOrderStatus(): ?\SberPay\Model\RecurrentPaymentResponseOrderStatus
    {
     ...
     * Sets order_status
     *
     * @param \SberPay\Model\RecurrentPaymentResponseOrderStatus|null $order_status order_status
     *
     * @return $this
     */
    public function setOrderStatus(?\SberPay\Model\RecurrentPaymentResponseOrderStatus $order_status): static
    {
