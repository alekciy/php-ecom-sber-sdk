...
/**
 * GetReceiptStatusResponse Class Doc Comment
 *
 * @package  SberPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetReceiptStatusResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getReceiptStatusResponse';
    ...
    protected static array $openAPITypes = [
        ...
        'order_id' => 'string',
        'order_number' => 'string',
        'receipts' => '\SberPay\Model\ReceiptsInner[]'
    ];
    ...
    */
    ...
    public function setMessage(?string $message): static
    {
        ...
        if ((mb_strlen($message) > 256)) {
            throw new InvalidArgumentException('invalid length for $message when calling GetReceiptStatusResponse., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($message) < 0)) {
            throw new InvalidArgumentException('invalid length for $message when calling GetReceiptStatusResponse., must be bigger than or equal to 0.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($message)))) {
            throw new InvalidArgumentException("invalid value for \$message when calling GetReceiptStatusResponse., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setOrderId(?string $order_id): static
    {
        ...
        if ((mb_strlen($order_id) > 36)) {
            throw new InvalidArgumentException('invalid length for $order_id when calling GetReceiptStatusResponse., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($order_id) < 36)) {
            throw new InvalidArgumentException('invalid length for $order_id when calling GetReceiptStatusResponse., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/^[a-f0-9\\-]+$/", ObjectSerializer::toString($order_id)))) {
            throw new InvalidArgumentException("invalid value for \$order_id when calling GetReceiptStatusResponse., must conform to the pattern /^[a-f0-9\\-]+$/.");
        }
    ...
    public function setOrderNumber(?string $order_number): static
    {
        ...
        if ((mb_strlen($order_number) > 36)) {
            throw new InvalidArgumentException('invalid length for $order_number when calling GetReceiptStatusResponse., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($order_number) < 1)) {
            throw new InvalidArgumentException('invalid length for $order_number when calling GetReceiptStatusResponse., must be bigger than or equal to 1.');
        }
     ...
     * Gets receipts
     *
     * @return \SberPay\Model\ReceiptsInner[]|null
     */
     ...
     * Sets receipts
     *
     * @param \SberPay\Model\ReceiptsInner[]|null $receipts Массив объектов, содержащий информацию по чекам в рамках заказа.
     *
     * @return $this
     */
    public function setReceipts(?array $receipts): static
    {
        if (is_null($receipts)) {
