<?php
/**
 * GetOrderStatusExtendedRequestOneOf
 *
 * PHP version 8.1
 *
 * @package  SberPay
...
/**
 * GetOrderStatusExtendedRequestOneOf Class Doc Comment
 *
 * @package  SberPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetOrderStatusExtendedRequestOneOf implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getOrderStatusExtendedRequest_oneOf';
    ...
    */
    ...
    public function setOrderId(string $order_id): static
    {
        ...
        if ((mb_strlen($order_id) > 36)) {
            throw new InvalidArgumentException('invalid length for $order_id when calling GetOrderStatusExtendedRequestOneOf., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($order_id) < 36)) {
            throw new InvalidArgumentException('invalid length for $order_id when calling GetOrderStatusExtendedRequestOneOf., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/^[a-f0-9\\-]+$/", ObjectSerializer::toString($order_id)))) {
            throw new InvalidArgumentException("invalid value for \$order_id when calling GetOrderStatusExtendedRequestOneOf., must conform to the pattern /^[a-f0-9\\-]+$/.");
        }
