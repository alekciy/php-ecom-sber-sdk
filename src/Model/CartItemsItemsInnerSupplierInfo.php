<?php
/**
 * CartItemsItemsInnerSupplierInfo
 *
 * PHP version 8.1
 *
 * @package  SberPay
...
/**
 * CartItemsItemsInnerSupplierInfo Class Doc Comment
 *
 * @description Блок, содержащий атрибуты поставщика на товарную позицию. При использовании удостоверьтесь, что Ваша касса поддерживает передачу агентских признаков. Обязателен к передаче, если передан agentInfo.
 * @package  SberPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class CartItemsItemsInnerSupplierInfo implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'cartItems_items_inner_supplierInfo';
    ...
    */
     ...
     * Sets phones
     *
     * @param string[]|null $phones __Тег ФФД 1171.__ Телефоны поставщика. Указывается в формате +{код страны}{номер телефона}. Пример заполнения: \"phones\": [\"+74957444401\",\"+79998887766\"]
     *
     * @return $this
     */
    public function setPhones(?array $phones): static
    {
        ...
        if ((count($phones) > 5)) {
            throw new InvalidArgumentException('invalid value for $phones when calling CartItemsItemsInnerSupplierInfo., number of items must be less than or equal to 5.');
        }
     ...
     * Sets name
     *
     * @param string|null $name __Тег ФФД 1225.__ Наименование поставщика
     *
     * @return $this
     */
    public function setName(?string $name): static
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new InvalidArgumentException('invalid length for $name when calling CartItemsItemsInnerSupplierInfo., must be smaller than or equal to 64.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($name)))) {
            throw new InvalidArgumentException("invalid value for \$name when calling CartItemsItemsInnerSupplierInfo., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
     ...
     * Sets inn
     *
     * @param string|null $inn __Тег ФФД 1226.__ ИНН поставщика. Если имеет размер менее 12 цифр - дополняется пробелами справа.
     *
     * @return $this
     */
    public function setInn(?string $inn): static
    {
        ...
        if ((mb_strlen($inn) > 12)) {
            throw new InvalidArgumentException('invalid length for $inn when calling CartItemsItemsInnerSupplierInfo., must be smaller than or equal to 12.');
        }
        if ((mb_strlen($inn) < 12)) {
            throw new InvalidArgumentException('invalid length for $inn when calling CartItemsItemsInnerSupplierInfo., must be bigger than or equal to 12.');
        }
        if ((!preg_match("/^[0-9]/", ObjectSerializer::toString($inn)))) {
            throw new InvalidArgumentException("invalid value for \$inn when calling CartItemsItemsInnerSupplierInfo., must conform to the pattern /^[0-9]/.");
        }
