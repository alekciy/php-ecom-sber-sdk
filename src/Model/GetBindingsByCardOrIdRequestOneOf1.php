<?php
/**
 * GetBindingsByCardOrIdRequestOneOf1
 *
 * PHP version 8.1
 *
 * @package  SberPay
...
/**
 * GetBindingsByCardOrIdRequestOneOf1 Class Doc Comment
 *
 * @package  SberPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetBindingsByCardOrIdRequestOneOf1 implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getBindingsByCardOrIdRequest_oneOf_1';
    ...
    */
    ...
    public function setBindingId(string $binding_id): static
    {
        ...
        if ((mb_strlen($binding_id) > 36)) {
            throw new InvalidArgumentException('invalid length for $binding_id when calling GetBindingsByCardOrIdRequestOneOf1., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($binding_id) < 36)) {
            throw new InvalidArgumentException('invalid length for $binding_id when calling GetBindingsByCardOrIdRequestOneOf1., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/^[a-f0-9\\-]+$/", ObjectSerializer::toString($binding_id)))) {
            throw new InvalidArgumentException("invalid value for \$binding_id when calling GetBindingsByCardOrIdRequestOneOf1., must conform to the pattern /^[a-f0-9\\-]+$/.");
        }
