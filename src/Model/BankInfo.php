...
class BankInfo implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'bankInfo';
    ...
    protected static array $setters = [
        ...
        'bank_country_name' => 'setBankCountryName'
    ];
    ...
    protected static array $getters = [
        ...
        'bank_country_name' => 'getBankCountryName'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('bank_country_code', $data ?? [], null);
        $this->setIfExists('bank_country_name', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['bank_name']) && !preg_match("/^[ -~]*$/", $this->container['bank_name'])) {
            $invalidProperties[] = "invalid value for 'bank_name', must be conform to the pattern /^[ -~]*$/.";
        }

        if (!is_null($this->container['bank_country_code']) && (mb_strlen($this->container['bank_country_code']) > 4)) {
            $invalidProperties[] = "invalid value for 'bank_country_code', the character length must be smaller than or equal to 4.";
        }

        if (!is_null($this->container['bank_country_code']) && (mb_strlen($this->container['bank_country_code']) < 1)) {
            $invalidProperties[] = "invalid value for 'bank_country_code', the character length must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['bank_country_code']) && !preg_match("/^\\w+$/", $this->container['bank_country_code'])) {
            $invalidProperties[] = "invalid value for 'bank_country_code', must be conform to the pattern /^\\w+$/.";
        }

        if (!is_null($this->container['bank_country_name']) && (mb_strlen($this->container['bank_country_name']) > 160)) {
            $invalidProperties[] = "invalid value for 'bank_country_name', the character length must be smaller than or equal to 160.";
        }

        if (!is_null($this->container['bank_country_name']) && (mb_strlen($this->container['bank_country_name']) < 1)) {
            $invalidProperties[] = "invalid value for 'bank_country_name', the character length must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['bank_country_name']) && !preg_match("/^[А-Яа-яЁё\\w\\s]+$/", $this->container['bank_country_name'])) {
            $invalidProperties[] = "invalid value for 'bank_country_name', must be conform to the pattern /^[А-Яа-яЁё\\w\\s]+$/.";
        }
     ...
     * Sets bank_name
     *
     * @param string|null $bank_name Наименование Банка-эмитента Карты Плательщика
     *
     * @return $this
     */
    public function setBankName(?string $bank_name): static
    {
        ...
        if ((mb_strlen($bank_name) > 50)) {
            throw new InvalidArgumentException('invalid length for $bank_name when calling BankInfo., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($bank_name) < 1)) {
            throw new InvalidArgumentException('invalid length for $bank_name when calling BankInfo., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($bank_name)))) {
            throw new InvalidArgumentException("invalid value for \$bank_name when calling BankInfo., must conform to the pattern /^[ -~]*$/.");
        }
     ...
     *
     * @param string|null $bank_country_code Код страны Банка-эмитента
     *
     * @return $this
     */
    public function setBankCountryCode(?string $bank_country_code): static
    {
        if (is_null($bank_country_code)) {
            throw new InvalidArgumentException('non-nullable bank_country_code cannot be null');
        }
        if ((mb_strlen($bank_country_code) > 4)) {
            throw new InvalidArgumentException('invalid length for $bank_country_code when calling BankInfo., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($bank_country_code) < 1)) {
            throw new InvalidArgumentException('invalid length for $bank_country_code when calling BankInfo., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\w+$/", ObjectSerializer::toString($bank_country_code)))) {
            throw new InvalidArgumentException("invalid value for \$bank_country_code when calling BankInfo., must conform to the pattern /^\\w+$/.");
        }
    ...
    /**
     * Gets bank_country_name
     *
     * @return string|null
     */
    public function getBankCountryName(): ?string
    {
        return $this->container['bank_country_name'];
    }

    /**
     * Sets bank_country_name
     *
     * @param string|null $bank_country_name Наименование страны банка-эмитента на языке, переданном в параметре language в запросе или если не указан, будет использован язык по умолчанию, указанный в настройках Клиента
     *
     * @return $this
     */
    public function setBankCountryName(?string $bank_country_name): static
    {
        if (is_null($bank_country_name)) {
            throw new InvalidArgumentException('non-nullable bank_country_name cannot be null');
        }
        if ((mb_strlen($bank_country_name) > 160)) {
            throw new InvalidArgumentException('invalid length for $bank_country_name when calling BankInfo., must be smaller than or equal to 160.');
        }
        if ((mb_strlen($bank_country_name) < 1)) {
            throw new InvalidArgumentException('invalid length for $bank_country_name when calling BankInfo., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[А-Яа-яЁё\\w\\s]+$/", ObjectSerializer::toString($bank_country_name)))) {
            throw new InvalidArgumentException("invalid value for \$bank_country_name when calling BankInfo., must conform to the pattern /^[А-Яа-яЁё\\w\\s]+$/.");
        }

        $this->container['bank_country_name'] = $bank_country_name;
