...
/**
 * GenerateApikeyResponse Class Doc Comment
 *
 * @package  SberPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GenerateApikeyResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'generateApikeyResponse';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['id']) && !preg_match("/^[a-f0-9\\-]+$/", $this->container['id'])) {
            $invalidProperties[] = "invalid value for 'id', must be conform to the pattern /^[a-f0-9\\-]+$/.";
        }

        if (!is_null($this->container['api_key']) && (mb_strlen($this->container['api_key']) > 512)) {
            $invalidProperties[] = "invalid value for 'api_key', the character length must be smaller than or equal to 512.";
        }

        if (!is_null($this->container['api_key']) && (mb_strlen($this->container['api_key']) < 512)) {
            $invalidProperties[] = "invalid value for 'api_key', the character length must be bigger than or equal to 512.";
        }

        if (!is_null($this->container['api_key']) && !preg_match("/^[ -~]*$/", $this->container['api_key'])) {
            $invalidProperties[] = "invalid value for 'api_key', must be conform to the pattern /^[ -~]*$/.";
        }
     ...
     * Sets id
     *
     * @param string|null $id Идентификатор клиента, зарегистрированный в ПШ
     *
     * @return $this
     */
    public function setId(?string $id): static
    {
        ...
        if ((mb_strlen($id) > 36)) {
            throw new InvalidArgumentException('invalid length for $id when calling GenerateApikeyResponse., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($id) < 36)) {
            throw new InvalidArgumentException('invalid length for $id when calling GenerateApikeyResponse., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/^[a-f0-9\\-]+$/", ObjectSerializer::toString($id)))) {
            throw new InvalidArgumentException("invalid value for \$id when calling GenerateApikeyResponse., must conform to the pattern /^[a-f0-9\\-]+$/.");
        }
     ...
     * Sets api_key
     *
     * @param string|null $api_key Ключ клиента для работы с сервисами платежного шлюза через SDK
     *
     * @return $this
     */
    public function setApiKey(?string $api_key): static
    {
        ...
        if ((mb_strlen($api_key) > 512)) {
            throw new InvalidArgumentException('invalid length for $api_key when calling GenerateApikeyResponse., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($api_key) < 512)) {
            throw new InvalidArgumentException('invalid length for $api_key when calling GenerateApikeyResponse., must be bigger than or equal to 512.');
        }
        if ((!preg_match("/^[ -~]*$/", ObjectSerializer::toString($api_key)))) {
            throw new InvalidArgumentException("invalid value for \$api_key when calling GenerateApikeyResponse., must conform to the pattern /^[ -~]*$/.");
        }
