...
class OrderBundle implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'orderBundle';
    ...
    protected static array $openAPITypes = [
        ...
        'installments' => '\SberPay\Model\OrderBundleInstallments',
        'ffd_version' => 'string',
        'receipt_type' => 'string',
        'ism_optional' => 'bool',
        'company' => '\SberPay\Model\OrderBundleCompany',
        'customer_details' => '\SberPay\Model\CustomerDetails',
        'cart_items' => '\SberPay\Model\CartItems',
        'payments' => '\SberPay\Model\OrderBundlePaymentsInner[]',
        'total' => 'float',
        'additional_user_props' => '\SberPay\Model\OrderBundleAdditionalUserProps',
        'additional_check_props' => 'string',
        'operating_check_props' => '\SberPay\Model\OrderBundleOperatingCheckProps',
        'sectoral_check_props' => '\SberPay\Model\OrderBundleSectoralCheckPropsInner[]'
    ];
    ...
    */
     ...
     * @return $this
     */
    public function setOrderCreationDate(?string $order_creation_date): static
    {
     ...
     * Gets installments
     *
     * @return \SberPay\Model\OrderBundleInstallments|null
     */
    public function getInstallments(): ?\SberPay\Model\OrderBundleInstallments
    {
     ...
     * Sets installments
     *
     * @param \SberPay\Model\OrderBundleInstallments|null $installments installments
     *
     * @return $this
     */
    public function setInstallments(?\SberPay\Model\OrderBundleInstallments $installments): static
    {
     ...
     * @return $this
     */
    public function setFfdVersion(?string $ffd_version): static
    {
     ...
     * @return $this
     */
    public function setReceiptType(?string $receipt_type): static
    {
     ...
     * @return bool|null
     */
    public function getIsmOptional(): ?bool
    {
     ...
     * @return $this
     */
    public function setIsmOptional(?bool $ism_optional): static
    {
     ...
     * Gets company
     *
     * @return \SberPay\Model\OrderBundleCompany|null
     */
    public function getCompany(): ?\SberPay\Model\OrderBundleCompany
    {
     ...
     * Sets company
     *
     * @param \SberPay\Model\OrderBundleCompany|null $company company
     *
     * @return $this
     */
    public function setCompany(?\SberPay\Model\OrderBundleCompany $company): static
    {
        if (is_null($company)) {
     ...
     *
     * @return \SberPay\Model\CustomerDetails|null
     */
    public function getCustomerDetails(): ?\SberPay\Model\CustomerDetails
    {
     ...
     *
     * @param \SberPay\Model\CustomerDetails|null $customer_details customer_details
     *
     * @return $this
     */
    public function setCustomerDetails(?\SberPay\Model\CustomerDetails $customer_details): static
    {
     ...
     * Gets cart_items
     *
     * @return \SberPay\Model\CartItems
     */
    public function getCartItems(): \SberPay\Model\CartItems
    {
     ...
     * Sets cart_items
     *
     * @param \SberPay\Model\CartItems $cart_items cart_items
     *
     * @return $this
     */
    public function setCartItems(\SberPay\Model\CartItems $cart_items): static
    {
     ...
     * Gets payments
     *
     * @return \SberPay\Model\OrderBundlePaymentsInner[]|null
     */
     ...
     * Sets payments
     *
     * @param \SberPay\Model\OrderBundlePaymentsInner[]|null $payments Виды оплаты. Обязателен при использовании фискализации.
     *
     * @return $this
     */
     ...
     *
     * @return \SberPay\Model\OrderBundleAdditionalUserProps|null
     */
    public function getAdditionalUserProps(): ?\SberPay\Model\OrderBundleAdditionalUserProps
    {
     ...
     *
     * @param \SberPay\Model\OrderBundleAdditionalUserProps|null $additional_user_props additional_user_props
     *
     * @return $this
     */
    public function setAdditionalUserProps(?\SberPay\Model\OrderBundleAdditionalUserProps $additional_user_props): static
    {
     ...
     *
     * @return \SberPay\Model\OrderBundleOperatingCheckProps|null
     */
    public function getOperatingCheckProps(): ?\SberPay\Model\OrderBundleOperatingCheckProps
    {
     ...
     *
     * @param \SberPay\Model\OrderBundleOperatingCheckProps|null $operating_check_props operating_check_props
     *
     * @return $this
     */
    public function setOperatingCheckProps(?\SberPay\Model\OrderBundleOperatingCheckProps $operating_check_props): static
    {
     ...
     *
     * @return \SberPay\Model\OrderBundleSectoralCheckPropsInner[]|null
     */
     ...
     *
     * @param \SberPay\Model\OrderBundleSectoralCheckPropsInner[]|null $sectoral_check_props __Тег ФФД 1261.__ Отраслевой реквизит чека. Передается, если в чеке есть маркированные товары и включение указанного реквизита предусмотрено нормативными актами для этой товарной группы. Только для ФФД 1.2.
     *
     * @return $this
     */
