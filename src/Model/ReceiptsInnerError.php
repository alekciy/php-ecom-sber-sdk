...
class ReceiptsInnerError implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'receipts_inner_error';
    ...
    */
     ...
     * @return float|null
     */
    public function getRecommendation(): ?float
    {
     ...
     * @return $this
     */
    public function setRecommendation(?float $recommendation): static
    {
