...
/**
 * ExternalRefundId Class Doc Comment
 *
 * @package  SberPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ExternalRefundId implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'externalRefundId';
    ...
    */
    ...
    public function setExternalRefundId(?string $external_refund_id): static
    {
        ...
        if ((mb_strlen($external_refund_id) > 36)) {
            throw new InvalidArgumentException('invalid length for $external_refund_id when calling ExternalRefundId., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($external_refund_id) < 1)) {
            throw new InvalidArgumentException('invalid length for $external_refund_id when calling ExternalRefundId., must be bigger than or equal to 1.');
        }
