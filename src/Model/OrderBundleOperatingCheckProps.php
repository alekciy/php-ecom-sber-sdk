<?php
/**
 * OrderBundleOperatingCheckProps
 *
 * PHP version 8.1
 *
 * @package  SberPay
...
/**
 * OrderBundleOperatingCheckProps Class Doc Comment
 *
 ...
 */
class OrderBundleOperatingCheckProps implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'orderBundle_operatingCheckProps';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ((mb_strlen($this->container['timestamp']) < 20)) {
            $invalidProperties[] = "invalid value for 'timestamp', the character length must be bigger than or equal to 20.";
        }
     ...
     * Sets name
     *
     * @param string $name __Тег ФФД 1271.__ Идентификатор операции. Принимает значение \"0\" до определения значения ФНС России
     *
     * @return $this
     */
    public function setName(string $name): static
    {
        ...
        if ((mb_strlen($name) > 40)) {
            throw new InvalidArgumentException('invalid length for $name when calling OrderBundleOperatingCheckProps., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($name) < 0)) {
            throw new InvalidArgumentException('invalid length for $name when calling OrderBundleOperatingCheckProps., must be bigger than or equal to 0.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($name)))) {
            throw new InvalidArgumentException("invalid value for \$name when calling OrderBundleOperatingCheckProps., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
     ...
     * Sets value
     *
     * @param string $value __Тег ФФД 1272.__ Данные операции
     *
     * @return $this
     */
    public function setValue(string $value): static
    {
        ...
        if ((mb_strlen($value) > 64)) {
            throw new InvalidArgumentException('invalid length for $value when calling OrderBundleOperatingCheckProps., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($value) < 1)) {
            throw new InvalidArgumentException('invalid length for $value when calling OrderBundleOperatingCheckProps., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($value)))) {
            throw new InvalidArgumentException("invalid value for \$value when calling OrderBundleOperatingCheckProps., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
     ...
     * Sets timestamp
     *
     * @param string $timestamp __Тег ФФД 1273.__ Время и дата операции в формате \"dd.mm.yyyy HH:MM:SS\"
     *
     * @return $this
     */
    public function setTimestamp(string $timestamp): static
    {
        ...
        if ((mb_strlen($timestamp) > 20)) {
            throw new InvalidArgumentException('invalid length for $timestamp when calling OrderBundleOperatingCheckProps., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($timestamp) < 20)) {
            throw new InvalidArgumentException('invalid length for $timestamp when calling OrderBundleOperatingCheckProps., must be bigger than or equal to 20.');
        }
