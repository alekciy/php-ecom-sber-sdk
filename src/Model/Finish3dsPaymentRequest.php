...
class Finish3dsPaymentRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'finish3dsPaymentRequest';
    ...
    */
     ...
     * @return $this
     */
    public function setPaRes(?string $pa_res): static
    {
        if (is_null($pa_res)) {
     ...
     * @return $this
     */
    public function setCRes(?string $c_res): static
    {
        if (is_null($c_res)) {
