<?php
/**
 * GetBindingsByCardOrIdRequestOneOf
 *
 * PHP version 8.1
 *
 * @package  SberPay
...
/**
 * GetBindingsByCardOrIdRequestOneOf Class Doc Comment
 *
 * @package  SberPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetBindingsByCardOrIdRequestOneOf implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getBindingsByCardOrIdRequest_oneOf';
    ...
    */
    ...
    public function setPan(string $pan): static
    {
        ...
        if ((mb_strlen($pan) > 19)) {
            throw new InvalidArgumentException('invalid length for $pan when calling GetBindingsByCardOrIdRequestOneOf., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($pan) < 13)) {
            throw new InvalidArgumentException('invalid length for $pan when calling GetBindingsByCardOrIdRequestOneOf., must be bigger than or equal to 13.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($pan)))) {
            throw new InvalidArgumentException("invalid value for \$pan when calling GetBindingsByCardOrIdRequestOneOf., must conform to the pattern /^\\d+$/.");
        }
